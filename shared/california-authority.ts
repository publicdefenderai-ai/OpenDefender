...
function exactAlternative(
  seed: Omit<RecordSeed, "legacyIds"> & { legacyId: string },
): CaliforniaCanonicalRecord {
  const { legacyId, ...recordSeed } = seed;
  return record({ ...recordSeed, legacyIds: [legacyId] });
}
...
export const CALIFORNIA_CANONICAL_RECORDS: CaliforniaCanonicalRecord[] = [
  ...
  exactAlternative({
    legacyId: "ca-criminally-negligent-homicide",
    canonicalId: "ca-vehicular-manslaughter-192-c1",
    officialTitle: "Vehicular Manslaughter With Gross Negligence",
    code: "192(c)(1)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 192(c)(1)",
    classification: "offense",
    elements: ["The defendant drove a vehicle", "The defendant committed an unlawful act or a lawful act performed in an unlawful manner while driving", "The act caused the death of another person", "The defendant acted with gross negligence"],
    mentalState: "Gross negligence.",
    grading: "Wobbler.",
    penalty: "Punishable by county jail up to 1 year or state prison for 2, 4, or 6 years under Penal Code § 193(c)(1).",
    juryInstruction: { ref: "CALCRIM 592", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-criminally-negligent-homicide",
    canonicalId: "ca-vehicular-manslaughter-192-c2",
    officialTitle: "Vehicular Manslaughter Without Gross Negligence",
    code: "192(c)(2)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 192(c)(2)",
    classification: "offense",
    elements: ["The defendant drove a vehicle", "The defendant committed an unlawful act or a lawful act performed in an unlawful manner while driving", "The act caused the death of another person", "The defendant did not act with gross negligence"],
    mentalState: "The charged act occurred without gross negligence.",
    grading: "Misdemeanor.",
    penalty: "Punishable by county jail up to 1 year under Penal Code § 193(c)(2).",
    juryInstruction: { ref: "CALCRIM 592", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-criminally-negligent-homicide",
    canonicalId: "ca-vehicular-manslaughter-192-c3",
    officialTitle: "Vehicular Manslaughter for Financial Gain",
    code: "192(c)(3)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 192(c)(3)",
    classification: "offense",
    elements: ["The defendant drove a vehicle", "The defendant knowingly caused a vehicle collision", "The defendant acted in connection with a violation of Penal Code § 550(a)(3) for financial gain", "The collision proximately caused the death of another person"],
    mentalState: "Knowing collision caused for financial gain.",
    grading: "Felony.",
    penalty: "Punishable by 4, 6, or 10 years in state prison under Penal Code § 193(c)(3).",
    juryInstruction: { ref: "CALCRIM 592", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-vehicular-homicide",
    canonicalId: "ca-gross-vehicular-manslaughter-191-5-a",
    officialTitle: "Gross Vehicular Manslaughter While Intoxicated",
    code: "191.5(a)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 191.5(a)",
    classification: "offense",
    elements: ["The defendant unlawfully killed another person while driving a vehicle", "The defendant violated Vehicle Code § 23140, § 23152, or § 23153", "The defendant committed an unlawful act or a lawful act performed in an unlawful manner while driving", "The defendant acted with gross negligence"],
    mentalState: "Gross negligence and the statutory intoxicated-driving violation.",
    grading: "Felony.",
    penalty: "Punishable by 4, 6, or 10 years in state prison under Penal Code § 191.5(a), subject to statutory enhancements.",
    juryInstruction: { ref: "CALCRIM 590", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-vehicular-homicide",
    canonicalId: "ca-vehicular-manslaughter-191-5-b",
    officialTitle: "Vehicular Manslaughter While Intoxicated",
    code: "191.5(b)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 191.5(b)",
    classification: "offense",
    elements: ["The defendant unlawfully killed another person while driving a vehicle", "The defendant violated Vehicle Code § 23140, § 23152, or § 23153", "The defendant committed an unlawful act or a lawful act performed in an unlawful manner while driving", "The defendant acted without gross negligence"],
    mentalState: "The statutory intoxicated-driving violation; gross negligence is not required.",
    grading: "Wobbler.",
    penalty: "Punishable by county jail up to 1 year or by 16 months, 2 years, or 4 years under Penal Code § 1170(h), as provided by Penal Code § 191.5(c)(2).",
    juryInstruction: { ref: "CALCRIM 590", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-assault-in-the-second-degree",
    canonicalId: "ca-assault-240",
    officialTitle: "Assault",
    code: "240",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 240",
    classification: "offense",
    elements: ["The defendant committed an act that would probably and directly result in the application of force", "The defendant acted willfully", "The defendant had the present ability to apply force"],
    mentalState: "Willful act with knowledge of facts making the application of force probable.",
    grading: "Misdemeanor.",
    penalty: "Punishable by county jail up to 6 months and/or a fine under Penal Code § 241.",
    juryInstruction: { ref: "CALCRIM 915", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-assault-in-the-second-degree",
    canonicalId: "ca-battery-243-a",
    officialTitle: "Battery",
    code: "243(a)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 243(a)",
    classification: "offense",
    elements: ["The defendant willfully touched another person in a harmful or offensive manner", "The touching was committed without legal justification"],
    mentalState: "Willful touching; no intent to injure is required.",
    grading: "Misdemeanor.",
    penalty: "Punishable by county jail up to 6 months and/or a fine under Penal Code § 243(a).",
    juryInstruction: { ref: "CALCRIM 960", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-rape-in-the-first-degree",
    canonicalId: "ca-rape-261-a2",
    officialTitle: "Rape by Force, Violence, Duress, or Threat",
    code: "261(a)(2)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 261(a)(2)",
    classification: "offense",
    elements: ["The defendant engaged in sexual intercourse with another person", "The act was accomplished against the person's will by force, violence, duress, menace, or fear"],
    mentalState: "Intentional sexual intercourse with knowledge of the coercive circumstance.",
    grading: "Felony.",
    penalty: "Punishable by 3, 6, or 8 years in state prison under Penal Code § 264.",
    juryInstruction: { ref: "CALCRIM 1000", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-rape-in-the-first-degree",
    canonicalId: "ca-rape-261-a1",
    officialTitle: "Rape of a Person Unable to Consent Due to a Disability",
    code: "261(a)(1)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 261(a)(1)",
    classification: "offense",
    elements: ["The defendant engaged in sexual intercourse", "The victim was incapable of giving legal consent because of a mental disorder or developmental or physical disability", "The defendant knew or reasonably should have known of the victim's condition"],
    mentalState: "Intentional sexual intercourse with knowledge or constructive knowledge of the victim's incapacity.",
    grading: "Felony.",
    penalty: "Punishable under Penal Code §§ 261 and 264; the term depends on the charged circumstance.",
    juryInstruction: { ref: "CALCRIM 1000", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-rape-in-the-first-degree",
    canonicalId: "ca-rape-261-a3",
    officialTitle: "Rape of a Person Unable to Resist Due to Intoxication",
    code: "261(a)(3)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 261(a)(3)",
    classification: "offense",
    elements: ["The defendant engaged in sexual intercourse", "The victim was prevented from resisting because of intoxication", "The defendant knew or reasonably should have known of the victim's condition"],
    mentalState: "Intentional sexual intercourse with knowledge or constructive knowledge of the victim's intoxication.",
    grading: "Felony.",
    penalty: "Punishable under Penal Code §§ 261 and 264; the term depends on the charged circumstance.",
    juryInstruction: { ref: "CALCRIM 1000", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-rape-in-the-first-degree",
    canonicalId: "ca-rape-261-a4",
    officialTitle: "Rape of a Person Unconscious of the Nature of the Act",
    code: "261(a)(4)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 261(a)(4)",
    classification: "offense",
    elements: ["The defendant engaged in sexual intercourse", "The victim was unconscious of the nature of the act because the victim was unconscious or asleep, or was unaware of the act or its essential characteristics due to fraud"],
    mentalState: "Intentional sexual intercourse under the statutory unconsciousness or fraud circumstance.",
    grading: "Felony.",
    penalty: "Punishable under Penal Code §§ 261 and 264; the term depends on the charged circumstance.",
    juryInstruction: { ref: "CALCRIM 1000", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-rape-in-the-first-degree",
    canonicalId: "ca-rape-261-a5",
    officialTitle: "Rape by Mistaken Identity",
    code: "261(a)(5)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 261(a)(5)",
    classification: "offense",
    elements: ["The defendant engaged in sexual intercourse", "The defendant induced the victim to submit by artifice, pretense, or concealment", "The victim submitted under the belief that the defendant was someone else"],
    mentalState: "Intentional sexual intercourse using the charged artifice, pretense, or concealment.",
    grading: "Felony.",
    penalty: "Punishable by 3, 6, or 8 years in state prison under Penal Code § 264.",
    juryInstruction: { ref: "CALCRIM 1000", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-rape-in-the-first-degree",
    canonicalId: "ca-rape-261-a6",
    officialTitle: "Rape by Threat of Future Retaliation",
    code: "261(a)(6)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 261(a)(6)",
    classification: "offense",
    elements: ["The defendant engaged in sexual intercourse against the victim's will", "The defendant threatened future retaliation", "There was a reasonable possibility the threat would be carried out"],
    mentalState: "Intentional sexual intercourse under a threat with a reasonable possibility of execution.",
    grading: "Felony.",
    penalty: "Punishable by 3, 6, or 8 years in state prison under Penal Code § 264.",
    juryInstruction: { ref: "CALCRIM 1000", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-rape-in-the-first-degree",
    canonicalId: "ca-rape-261-a7",
    officialTitle: "Rape by Threat of Official Authority",
    code: "261(a)(7)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 261(a)(7)",
    classification: "offense",
    elements: ["The defendant engaged in sexual intercourse against the victim's will", "The defendant threatened to use the authority of a public official to incarcerate, arrest, or deport the victim", "The victim reasonably believed the defendant was a public official"],
    mentalState: "Intentional sexual intercourse under the charged threat of official authority.",
    grading: "Felony.",
    penalty: "Punishable by 3, 6, or 8 years in state prison under Penal Code § 264.",
    juryInstruction: { ref: "CALCRIM 1000", url: CALCRIM_URL },
  }),
  exactAlternative({
    ...
    canonicalId: "ca-sexual-penetration-289-a1a",
    officialTitle: "Sexual Penetration by Force or Fear",
    code: "289(a)(1)(A)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 289(a)(1)(A)",
    classification: "offense",
    elements: ["The defendant caused penetration of another person's genital or anal opening with a foreign or unknown object", "The penetration was accomplished against the person's will by force, violence, duress, menace, or fear"],
    mentalState: "Intentional penetration with knowledge of the coercive circumstance.",
    grading: "Felony.",
    penalty: "Punishable by 3, 6, or 8 years in state prison under Penal Code § 289(a)(1)(A).",
    juryInstruction: { ref: "CALCRIM 1045", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-sexual-assault-in-the-second-degree",
    canonicalId: "ca-sexual-penetration-289-a1b",
    officialTitle: "Sexual Penetration of a Child Under 14 by Force or Fear",
    code: "289(a)(1)(B)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 289(a)(1)(B)",
    classification: "offense",
    elements: ["The defendant caused penetration of another person's genital or anal opening with a foreign or unknown object", "The penetration was accomplished against the person's will by force, violence, duress, menace, or fear", "The victim was under 14 years of age"],
    mentalState: "Intentional penetration under the charged coercive circumstance.",
    grading: "Felony.",
    penalty: "Punishable by 8, 10, or 12 years in state prison under Penal Code § 289(a)(1)(B).",
    juryInstruction: { ref: "CALCRIM 1045", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-sexual-assault-in-the-third-degree",
    canonicalId: "ca-sexual-battery-243-4-a",
    officialTitle: "Sexual Battery by Restraint",
    code: "243.4(a)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 243.4(a)",
    classification: "offense",
    elements: ["The defendant touched an intimate part of another person", "The touching was against the person's will", "The defendant restrained the victim for the purpose of sexual arousal, gratification, or abuse"],
    mentalState: "Intent to touch for sexual arousal, gratification, or abuse, plus intent to restrain.",
    grading: "Felony.",
    penalty: "Punishable by 2, 3, or 4 years in state prison under Penal Code § 243.4(a).",
    juryInstruction: { ref: "CALCRIM 935", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-sexual-assault-in-the-third-degree",
    canonicalId: "ca-sexual-battery-243-4-e1",
    officialTitle: "Misdemeanor Sexual Battery",
    code: "243.4(e)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 243.4(e)(1)",
    classification: "offense",
    elements: ["The defendant touched an intimate part of another person", "The touching was against the person's will", "The touching was for sexual arousal, gratification, or abuse"],
    mentalState: "Intent to touch for sexual arousal, gratification, or abuse.",
    grading: "Misdemeanor.",
    penalty: "Punishable by county jail up to 6 months and/or a fine under Penal Code § 243.4(e)(1).",
    juryInstruction: { ref: "CALCRIM 938", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-statutory-rape",
    canonicalId: "ca-unlawful-sexual-intercourse-261-5-b",
    officialTitle: "Unlawful Sexual Intercourse With a Minor",
    code: "261.5(b)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 261.5(b)",
    classification: "offense",
    elements: ["The defendant engaged in sexual intercourse with a person under 18", "The minor was not more than 3 years older or younger than the defendant"],
    mentalState: "Intentional sexual intercourse; knowledge of age is not required for the statutory offense.",
    grading: "Misdemeanor.",
    penalty: "Punishable by county jail up to 1 year and/or a fine under Penal Code § 261.5(b).",
    juryInstruction: { ref: "CALCRIM 1070", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-statutory-rape",
    canonicalId: "ca-unlawful-sexual-intercourse-261-5-c",
    officialTitle: "Unlawful Sexual Intercourse With a Minor, Age-Difference Variant",
    code: "261.5(c)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 261.5(c)",
    classification: "offense",
    elements: ["The defendant engaged in sexual intercourse with a person under 18", "The minor was more than 3 years younger than the defendant"],
    mentalState: "Intentional sexual intercourse; the statutory age and age-difference facts must be proved.",
    grading: "Misdemeanor or felony.",
    penalty: "Punishable by county jail up to 1 year or imprisonment under Penal Code § 1170(h), as provided by Penal Code § 261.5(c).",
    juryInstruction: { ref: "CALCRIM 1070", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-statutory-rape",
    canonicalId: "ca-unlawful-sexual-intercourse-261-5-d",
    officialTitle: "Unlawful Sexual Intercourse With a Minor, Felony Variant",
    code: "261.5(d)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 261.5(d)",
    classification: "offense",
    elements: ["The defendant engaged in sexual intercourse with a person under 16", "The defendant was at least 21 years old"],
    mentalState: "Intentional sexual intercourse; the statutory age facts must be proved.",
    grading: "Wobbler.",
    penalty: "May be punished as a misdemeanor or felony under Penal Code § 261.5(d), with felony imprisonment under Penal Code § 1170(h).",
    juryInstruction: { ref: "CALCRIM 1070", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-child-sexual-abuse",
    canonicalId: "ca-lewd-act-child-288-a",
    officialTitle: "Lewd or Lascivious Act on a Child Under 14",
    code: "288(a)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 288(a)",
    classification: "offense",
    elements: ["The defendant committed a lewd or lascivious act on or with a child", "The child was under 14", "The defendant acted with the intent to arouse, appeal to, or gratify sexual desire"],
    mentalState: "Intent to arouse, appeal to, or gratify sexual desire.",
    grading: "Felony.",
    penalty: "Punishable by 3, 6, or 8 years in state prison under Penal Code § 288(a).",
    juryInstruction: { ref: "CALCRIM 1110", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-child-sexual-abuse",
    canonicalId: "ca-lewd-act-child-288-c1",
    officialTitle: "Lewd or Lascivious Act on a Child Age 14 or 15",
    code: "288(c)(1)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 288(c)(1)",
    classification: "offense",
    elements: ["The defendant committed a lewd or lascivious act on or with a child", "The child was at least 14 and under 16", "The defendant was at least 10 years older and acted with the required sexual intent"],
    mentalState: "Intent to arouse, appeal to, or gratify sexual desire.",
    grading: "Public offense punishable as a misdemeanor or felony.",
    penalty: "Punishable by county jail up to 1 year or state prison for 1, 2, or 3 years under Penal Code § 288(c)(1).",
    juryInstruction: { ref: "CALCRIM 1110", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-grand-theft-in-the-first-degree",
    canonicalId: "ca-grand-theft-487-a",
    officialTitle: "Grand Theft by Value",
    code: "487(a)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 487(a)",
    classification: "offense",
    elements: ["The defendant took property belonging to another", "The defendant intended to permanently deprive the owner", "The property met the value threshold in § 487(a)"],
    mentalState: "Intent to permanently deprive the owner of possession.",
    grading: "Wobbler.",
    penalty: "May be punished as a misdemeanor or felony; felony imprisonment may be imposed under Penal Code § 1170(h).",
    juryInstruction: { ref: "CALCRIM 1801", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-grand-theft-in-the-first-degree",
    canonicalId: "ca-grand-theft-agricultural-487-b1a",
    officialTitle: "Grand Theft of Specified Agricultural Crops",
    code: "487(b)(1)(A)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 487(b)(1)(A)",
    classification: "offense",
    elements: ["The defendant took one of the agricultural crops specified in Penal Code § 487(b)(1)(A)", "The value of the crop exceeded $250", "The defendant intended to permanently deprive the owner"],
    mentalState: "Intent to permanently deprive the owner of possession.",
    grading: "Wobbler.",
    penalty: "May be punished as a misdemeanor or felony under Penal Code §§ 487(b)(1)(A) and 489; felony imprisonment may be imposed under Penal Code § 1170(h).",
    juryInstruction: { ref: "CALCRIM 1801", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-grand-theft-in-the-first-degree",
    canonicalId: "ca-grand-theft-firearm-487-d2",
    officialTitle: "Grand Theft of a Firearm",
    code: "487(d)(2)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 487(d)(2)",
    classification: "offense",
    elements: ["The defendant took a firearm belonging to another", "The defendant intended to permanently deprive the owner of the firearm"],
    mentalState: "Intent to permanently deprive the owner of possession.",
    grading: "Felony.",
    penalty: "Punishable by 16 months, 2 years, or 3 years in state prison under Penal Code § 489(a).",
    juryInstruction: { ref: "CALCRIM 1801", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-identity-theft",
    canonicalId: "ca-identity-theft-530-5-a",
    officialTitle: "Identity Theft",
    code: "530.5(a)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 530.5(a)",
    classification: "offense",
    elements: ["The defendant willfully obtained another person's personal identifying information", "The defendant used the information for an unlawful purpose without consent"],
    mentalState: "Willful unauthorized use of another person's identifying information for an unlawful purpose.",
    grading: "Wobbler.",
    penalty: "May be punished as a misdemeanor or felony under Penal Code § 530.5(a); felony imprisonment may be imposed under Penal Code § 1170(h).",
    juryInstruction: { ref: "CALCRIM 2040", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-identity-theft",
    canonicalId: "ca-identity-theft-530-5-c1",
    officialTitle: "Acquiring Personal Identifying Information With Intent to Defraud",
    code: "530.5(c)(1)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 530.5(c)(1)",
    classification: "offense",
    elements: ["The defendant acquired or retained another person's personal identifying information", "The defendant acted without authorization", "The defendant intended to defraud"],
    mentalState: "Intent to defraud.",
    grading: "Misdemeanor.",
    penalty: "Punishable by a fine or county jail up to 1 year under Penal Code § 530.5(c)(1).",
    juryInstruction: { ref: "CALCRIM 2040", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-insurance-fraud",
    canonicalId: "ca-insurance-fraud-550-a1",
    officialTitle: "Insurance Fraud by False Claim",
    code: "550(a)(1)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 550(a)(1)",
    classification: "offense",
    elements: ["The defendant presented or caused a false or fraudulent insurance claim or application to be presented to an insurer", "The defendant knew the claim or application was false or fraudulent"],
    mentalState: "Knowledge that the claim or application was false or fraudulent, with intent to defraud.",
    grading: "Felony.",
    penalty: "Punishable by 2, 3, or 5 years under Penal Code § 550(a)(1) and the penalty provisions of § 550(a).",
    juryInstruction: { ref: "CALCRIM 2000", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-insurance-fraud",
    canonicalId: "ca-insurance-fraud-550-b1",
    officialTitle: "Insurance Fraud by False Statement",
    code: "550(b)(1)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 550(b)(1)",
    classification: "offense",
    elements: ["The defendant made or prepared a written or oral statement as part of an insurance claim or application", "The statement contained materially false or misleading information", "The defendant knew it was false or misleading"],
    mentalState: "Knowing presentation of a materially false or misleading insurance statement with intent to defraud.",
    grading: "Felony.",
    penalty: "Punishable by 2, 3, or 5 years, or by the alternative fine and county-jail penalties stated in Penal Code § 550(b)(1).",
    juryInstruction: { ref: "CALCRIM 2000", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-computer-fraud",
    canonicalId: "ca-computer-crime-502-c1",
    officialTitle: "Unauthorized Computer Access to Defraud or Obtain Property",
    code: "502(c)(1)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 502(c)(1)",
    classification: "offense",
    elements: ["The defendant knowingly accessed or used a computer, system, or network without permission or beyond permission", "The defendant acted to defraud, extort, or wrongfully obtain property"],
    mentalState: "Knowing unauthorized access or use with intent to defraud, extort, or wrongfully obtain property.",
    grading: "Felony or misdemeanor depending on the charged conduct and loss.",
    penalty: "Punishment depends on the charged conduct and loss under Penal Code § 502(d)(1).",
    juryInstruction: { ref: "CALCRIM 1520", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-computer-fraud",
    canonicalId: "ca-computer-crime-502-c5",
    officialTitle: "Unauthorized Computer Damage or Disruption",
    code: "502(c)(5)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 502(c)(5)",
    classification: "offense",
    elements: ["The defendant knowingly and without permission disrupted or denied computer services to an authorized user"],
    mentalState: "Knowing disruption or denial of computer services without permission.",
    grading: "Felony or misdemeanor under Penal Code § 502(d)(1).",
    penalty: "A felony may be punished by 16 months, 2 years, or 3 years and a fine up to $10,000; a misdemeanor may be punished by up to 1 year in county jail and a fine up to $5,000 under Penal Code § 502(d)(1).",
    juryInstruction: { ref: "CALCRIM 1520", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-disturbing-the-peace",
    canonicalId: "ca-disturbing-the-peace-415-1",
    officialTitle: "Disturbing the Peace by Fighting",
    code: "415(1)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 415(1)",
    classification: "offense",
    elements: ["The defendant willfully and unlawfully fought or challenged another person to fight in a public place"],
    mentalState: "Willful and unlawful fighting or challenging another person to fight.",
    grading: "Misdemeanor.",
    penalty: "Punishable by up to 90 days in county jail, a fine up to $400, or both under Penal Code § 415.",
  }),
  exactAlternative({
    legacyId: "ca-disturbing-the-peace",
    canonicalId: "ca-disturbing-the-peace-415-2",
    officialTitle: "Disturbing the Peace by Loud or Unreasonable Noise",
    code: "415(2)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 415(2)",
    classification: "offense",
    elements: ["The defendant maliciously and willfully disturbed another person by loud and unreasonable noise"],
    mentalState: "Malicious and willful disturbance by loud and unreasonable noise.",
    grading: "Misdemeanor.",
    penalty: "Punishable by up to 90 days in county jail, a fine up to $400, or both under Penal Code § 415.",
  }),
  exactAlternative({
    legacyId: "ca-disturbing-the-peace",
    canonicalId: "ca-disturbing-the-peace-415-3",
    officialTitle: "Disturbing the Peace by Offensive Words",
    code: "415(3)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 415(3)",
    classification: "offense",
    elements: ["The defendant used offensive words in a public place", "The words were inherently likely to provoke an immediate violent reaction"],
    mentalState: "Willful use of words inherently likely to provoke an immediate violent reaction.",
    grading: "Misdemeanor.",
    penalty: "Punishable by up to 90 days in county jail, a fine up to $400, or both under Penal Code § 415.",
  }),
  exactAlternative({
    legacyId: "ca-dui-first-offense",
    canonicalId: "ca-dui-23152-a",
    officialTitle: "Driving Under the Influence of Alcohol",
    code: "23152(a)",
    lawCode: "VEH",
    citation: "Cal. Vehicle Code § 23152(a)",
    classification: "offense",
    elements: ["The defendant drove a vehicle", "The defendant was under the influence of an alcoholic beverage"],
    mentalState: "Voluntary operation while under the influence; no intent to violate the law is required.",
    grading: "Misdemeanor for a first offense, subject to prior-offense and aggravating facts.",
    penalty: "A first offense may include fines, probation, license consequences, and county jail under Vehicle Code §§ 23536 and 23538.",
  }),
  exactAlternative({
    legacyId: "ca-dui-first-offense",
    canonicalId: "ca-dui-23152-f",
    officialTitle: "Driving Under the Influence of a Drug",
    code: "23152(f)",
    lawCode: "VEH",
    citation: "Cal. Vehicle Code § 23152(f)",
    classification: "offense",
    elements: ["The defendant drove a vehicle", "The defendant was under the influence of a drug"],
    mentalState: "Voluntary operation while under the influence; no intent to violate the law is required.",
    grading: "Misdemeanor for a first offense, subject to prior-offense and aggravating facts.",
    penalty: "A first offense may include fines, probation, license consequences, and county jail under Vehicle Code §§ 23536 and 23538.",
  }),
  exactAlternative({
    legacyId: "ca-dui-first-offense",
    canonicalId: "ca-dui-23152-g",
    officialTitle: "Driving Under the Combined Influence of Alcohol and a Drug",
    code: "23152(g)",
    lawCode: "VEH",
    citation: "Cal. Vehicle Code § 23152(g)",
    classification: "offense",
    elements: ["The defendant drove a vehicle", "The defendant was under the combined influence of an alcoholic beverage and a drug"],
    mentalState: "Voluntary operation while under the combined influence; no intent to violate the law is required.",
    grading: "Misdemeanor for a first offense, subject to prior-offense and aggravating facts.",
    penalty: "A first offense may include fines, probation, license consequences, and county jail under Vehicle Code §§ 23536 and 23538.",
  }),
  exactAlternative({
    legacyId: "ca-dui-first-offense",
    canonicalId: "ca-dui-23152-b",
    officialTitle: "Driving With an Alcohol Concentration of 0.08 Percent or More",
    code: "23152(b)",
    lawCode: "VEH",
    citation: "Cal. Vehicle Code § 23152(b)",
    classification: "offense",
    elements: ["The defendant drove a vehicle", "The defendant's blood-alcohol concentration was 0.08 percent or more by weight at the time prohibited by § 23152(b)"],
    mentalState: "Voluntary operation; the prohibited alcohol concentration is an objective statutory element.",
    grading: "Misdemeanor for a first offense, subject to prior-offense and aggravating facts.",
    penalty: "A first offense may include fines, probation, license consequences, and county jail under Vehicle Code §§ 23536 and 23538.",
  }),
  exactAlternative({
    legacyId: "ca-failure-to-appear",
    canonicalId: "ca-failure-to-appear-1320-a",
    officialTitle: "Failure to Appear After Release on Misdemeanor Charge",
    code: "1320(a)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 1320(a)",
    classification: "offense",
    elements: ["The defendant was released on their own recognizance after being charged with or convicted of a misdemeanor", "The defendant willfully failed to appear as required to evade the court process", "The defendant had notice of the appearance obligation"],
    mentalState: "Willful failure to appear with knowledge of the required date and place.",
    grading: "Misdemeanor.",
    penalty: "Punishable by a fine up to $1,000, county jail up to 6 months, or both under Penal Code § 1320(a).",
  }),
  exactAlternative({
    legacyId: "ca-failure-to-appear",
    canonicalId: "ca-failure-to-appear-1320-b",
    officialTitle: "Failure to Appear After Release on Felony Charge",
    code: "1320(b)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 1320(b)",
    classification: "offense",
    elements: ["The defendant was released on their own recognizance after being charged with or convicted of a felony", "The defendant willfully failed to appear as required to evade the court process", "The defendant had notice of the appearance obligation"],
    mentalState: "Willful failure to appear with knowledge of the required date and place.",
    grading: "Felony.",
    penalty: "Punishable by a fine up to $5,000, county jail up to 1 year, imprisonment under Penal Code § 1170(h), or both under Penal Code § 1320(b).",
  }),
  exactAlternative({
    legacyId: "ca-protective-order-violation",
    canonicalId: "ca-protective-order-273-6-a",
    officialTitle: "Violation of a Protective Order",
    code: "273.6(a)",
    lawCode: "PEN",
  ...
  exactAlternative({
    legacyId: "ca-open-container",
    canonicalId: "ca-open-container-23222-a",
    officialTitle: "Driving With an Open Alcoholic Beverage",
    code: "23222(a)",
    lawCode: "VEH",
    citation: "Cal. Vehicle Code § 23222(a)",
    classification: "offense",
    elements: ["The defendant drove a motor vehicle", "The defendant had an opened alcoholic beverage on their person or in the passenger compartment"],
    mentalState: "Voluntary driving with the prohibited opened container.",
    grading: "Infraction.",
    penalty: "An infraction punishable by a fine under Vehicle Code § 23222(a).",
  }),
  exactAlternative({
    legacyId: "ca-open-container",
    canonicalId: "ca-open-container-23222-b",
    officialTitle: "Driving With an Open Cannabis Receptacle",
    code: "23222(b)(1)",
    lawCode: "VEH",
    citation: "Cal. Vehicle Code § 23222(b)(1)",
    classification: "offense",
    elements: ["The defendant drove a motor vehicle", "The defendant possessed an opened cannabis receptacle, a receptacle with a broken seal, or loose cannabis flower on their person"],
    mentalState: "Voluntary driving with the prohibited opened cannabis receptacle or cannabis.",
    grading: "Infraction.",
    penalty: "An infraction punishable by a fine up to $100 under Vehicle Code § 23222(b)(1).",
  }),
  exactAlternative({
    legacyId: "ca-indecent-exposure",
    canonicalId: "ca-indecent-exposure-314-1",
    officialTitle: "Indecent Exposure",
    code: "314(1)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 314(1)",
    classification: "offense",
    elements: ["The defendant willfully and lewdly exposed the body or private parts in a public place or where others may be offended"],
    mentalState: "Willful and lewd exposure.",
    grading: "Misdemeanor.",
    penalty: "Generally punishable as a misdemeanor; specific dwelling and repeat-conviction penalties are stated in Penal Code § 314.",
    juryInstruction: { ref: "CALCRIM 1160", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-illegal-fireworks",
    canonicalId: "ca-illegal-fireworks-12677",
    officialTitle: "Unlawful Possession of Dangerous Fireworks Without a Permit",
    code: "12677",
    lawCode: "HSC",
    citation: "Cal. Health & Safety Code § 12677",
    classification: "offense",
    elements: ["The defendant possessed dangerous fireworks", "The defendant did not hold a valid permit"],
    mentalState: "Knowing possession of dangerous fireworks without a valid permit.",
    grading: "Misdemeanor.",
    penalty: "Health and Safety Code § 12677 states the prohibition but not a specific term in its text; applicable fireworks penalty provisions govern punishment.",
  }),
  exactAlternative({
    legacyId: "ca-conspiracy",
    canonicalId: "ca-conspiracy-182-a1",
    officialTitle: "Conspiracy to Commit a Crime",
    code: "182(a)(1)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 182(a)(1)",
    classification: "offense",
    elements: ["Two or more people agreed to commit a crime", "The defendant intended that the crime be committed", "One conspirator committed an overt act in furtherance of the agreement"],
    mentalState: "Intent to agree and intent that the target crime be committed.",
    grading: "Follows the target offense; a felony conspiracy is punished as the target felony.",
    penalty: "Punishment is the same manner and extent as the target felony under Penal Code § 182(a)(1).",
    juryInstruction: { ref: "CALCRIM 415", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-accessory-after-the-fact",
    canonicalId: "ca-accessory-after-the-fact-32",
    officialTitle: "Accessory After the Fact",
    code: "32, 33",
    lawCode: "PEN",
    citation: "Cal. Penal Code §§ 32, 33",
    classification: "offense",
    elements: ["Another person committed a felony", "The defendant harbored, concealed, or aided that person", "The defendant knew the person committed the felony and intended to help them avoid arrest, trial, conviction, or punishment"],
    mentalState: "Knowledge of the felony and intent to help the felon avoid justice.",
    grading: "Felony.",
    penalty: "Punishable by a fine up to $5,000, imprisonment under Penal Code § 1170(h), county jail up to 1 year, or both under Penal Code § 33.",
    juryInstruction: { ref: "CALCRIM 440", url: CALCRIM_URL },
  }),
  exactAlternative({
    legacyId: "ca-criminal-solicitation",
    canonicalId: "ca-criminal-solicitation-653f-a",
    officialTitle: "Solicitation to Commit a Specified Crime",
    code: "653f(a)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 653f(a)",
    classification: "offense",
    elements: ["The defendant solicited another person to commit one of the crimes specified in Penal Code § 653f(a)", "The defendant intended that the solicited crime be committed"],
    mentalState: "Intent that the solicited crime be committed.",
    grading: "Punishment varies by the crime solicited.",
    penalty: "Punishable by up to 1 year in county jail, imprisonment under Penal Code § 1170(h), a fine up to $10,000, or both under Penal Code § 653f(a).",
  }),
  exactAlternative({
    legacyId: "ca-criminal-solicitation",
    canonicalId: "ca-criminal-solicitation-653f-b",
    officialTitle: "Solicitation to Commit Murder",
    code: "653f(b)",
    lawCode: "PEN",
    citation: "Cal. Penal Code § 653f(b)",
    classification: "offense",
    elements: ["The defendant solicited another person to commit murder", "The defendant intended that the murder be committed"],
    mentalState: "Intent that the solicited murder be committed.",
    grading: "Felony.",
    penalty: "Punishable by 3, 6, or 9 years in state prison under Penal Code § 653f(b).",
  }),
];
...
/** Exact options shown when an old saved selection is too broad to use safely. */
export const CALIFORNIA_RESELECTION_ALTERNATIVES: Record<string, string[]> = {
  ...
  "ca-assault-in-the-second-degree": ["ca-assault-240", "ca-battery-243-a", "ca-assault-with-deadly-weapon"],
  "ca-assault-in-the-third-degree": ["ca-assault-240", "ca-battery-243-a"],
  "ca-rape-in-the-first-degree": ["ca-rape-261-a1", "ca-rape-261-a2", "ca-rape-261-a3", "ca-rape-261-a4", "ca-rape-261-a5", "ca-rape-261-a6", "ca-rape-261-a7"],
  "ca-sexual-assault-in-the-second-degree": ["ca-sexual-penetration-289-a1a", "ca-sexual-penetration-289-a1b"],
  "ca-sexual-assault-in-the-third-degree": ["ca-sexual-battery-243-4-a", "ca-sexual-battery-243-4-e1"],
  "ca-statutory-rape": ["ca-unlawful-sexual-intercourse-261-5-b", "ca-unlawful-sexual-intercourse-261-5-c", "ca-unlawful-sexual-intercourse-261-5-d"],
  "ca-child-sexual-abuse": ["ca-lewd-act-child-288-a", "ca-lewd-act-child-288-c1"],
  "ca-grand-theft-in-the-first-degree": ["ca-grand-theft-487-a", "ca-grand-theft-agricultural-487-b1a", "ca-grand-theft-firearm-487-d2"],
  "ca-identity-theft": ["ca-identity-theft-530-5-a", "ca-identity-theft-530-5-c1"],
  "ca-insurance-fraud": ["ca-insurance-fraud-550-a1", "ca-insurance-fraud-550-b1"],
  "ca-computer-fraud": ["ca-computer-crime-502-c1", "ca-computer-crime-502-c5"],
  "ca-disturbing-the-peace": ["ca-disturbing-the-peace-415-1", "ca-disturbing-the-peace-415-2", "ca-disturbing-the-peace-415-3"],
  "ca-dui-first-offense": ["ca-dui-23152-a", "ca-dui-23152-b", "ca-dui-23152-f", "ca-dui-23152-g"],
  "ca-failure-to-appear": ["ca-failure-to-appear-1320-a", "ca-failure-to-appear-1320-b"],
  "ca-protective-order-violation": ["ca-protective-order-273-6-a"],
  "ca-open-container": ["ca-open-container-23222-a", "ca-open-container-23222-b"],
  "ca-indecent-exposure": ["ca-indecent-exposure-314-1"],
  "ca-illegal-fireworks": ["ca-illegal-fireworks-12677"],
  "ca-conspiracy": ["ca-conspiracy-182-a1"],
  "ca-accessory-after-the-fact": ["ca-accessory-after-the-fact-32"],
  "ca-criminal-solicitation": ["ca-criminal-solicitation-653f-a", "ca-criminal-solicitation-653f-b"],
};
...
export function getCaliforniaCanonicalRecord(id: string): CaliforniaCanonicalRecord | undefined {
  const direct = byCanonicalId.get(id);
  if (direct && selectableCanonicalIds.has(direct.canonicalId)) {
    return direct;
  }
...
export function getCaliforniaReselectionOptions(
  ...
  return (CALIFORNIA_RESELECTION_ALTERNATIVES[legacyId] ?? [])
    .map((canonicalId) => byCanonicalId.get(canonicalId))
    .filter((record): record is CaliforniaCanonicalRecord => Boolean(record?.selectable));
}
