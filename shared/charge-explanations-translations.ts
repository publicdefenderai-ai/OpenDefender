...
export const CHARGE_EXPLANATION_TRANSLATIONS: Record<string, ChargeTranslationEntry> = {
  ...
  ...OHIO_REVIEWED_BATCH.translations,
  "ohio-felonious-assault": {
    es: {
      draft: true, keyTerms: [],
      plainSummary: "La sección 2903.11(A) de Ohio prohíbe causar a sabiendas daño físico grave, o causar o intentar causar daño físico mediante un arma mortal o material peligroso, a otra persona o al ser no nacido de otra persona. El apartado (B) contempla por separado determinadas conductas sexuales realizadas a sabiendas con conocimiento de un resultado positivo como portador del VIH: sin revelarlo previamente; con alguien que el autor sabe o tiene motivos razonables para creer que carece de capacidad mental para apreciar la importancia de ese conocimiento; o con una persona menor de dieciocho años que no sea su cónyuge. Para esta sección, insertar un instrumento u objeto que no sea parte del cuerpo en la abertura vaginal o anal de otra persona queda excluido de la conducta sexual, salvo que el autor supiera en ese momento que llevaba su propio fluido corporal. También importan las definiciones y excepciones relativas al embarazo. No es simplemente una etiqueta de agresión con arma.",
      degreeContext: "Normalmente es de segundo grado; el apartado (A) con víctima agente del orden o investigador del BCI que cumpla la definición legal es de primer grado. El daño físico grave a una víctima protegida activa la regla de prisión obligatoria de primer grado. Para hechos ocurridos a partir del 22 de marzo de 2019, los mínimos ordinarios son de 2 a 8 años (segundo grado) o de 3 a 11 años (primer grado), con máximo de pena indeterminada según la sección 2929.144; para un solo delito grave que cumpla los requisitos, el máximo es el mínimo más el 50%. Las multas básicas máximas son de hasta $15,000 (segundo grado) o $20,000 (primer grado), no importes fijos. Una especificación válida de conocimiento del embarazo exige el mínimo obligatorio aplicable para esos hechos de primer o segundo grado, no seis meses. Una especificación válida de acelerante con desfiguración permanente grave o incapacidad permanente sustancial añade seis años, consecutivos y anteriores a la pena del delito base, con un máximo de una pena de este tipo para delitos del mismo acto. Una especificación válida de víctima menor de diez años con daño incapacitante permanente añade seis años, consecutivos y anteriores a la pena base, pero impide cualquier otra pena de prisión adicional por el mismo delito. Usar un vehículo motorizado como arma mortal bajo (A)(2) exige suspensión de licencia de clase dos, de tres años a perpetuidad. Las condenas que cumplan los requisitos en ambas especificaciones, de motivación sexual y de depredador sexual violento, pueden activar penas de cadena perpetua; la conducta sexual por sí sola no establece esas especificaciones. Los hechos anteriores, otras alegaciones y las penas totales requieren revisión separada.",
    },
    zh: {
      draft: true, keyTerms: [],
      plainSummary: "俄亥俄州第2903.11(A)款禁止明知地对他人或他人的未出生胎儿造成严重身体伤害，或使用致命武器或危险军械造成或企图造成身体伤害。(B)款另行规定，在明知自己作为HIV携带者的检测结果呈阳性时，明知地实施特定性行为的情形：事先未披露该信息；对方是行为人明知或有合理理由认为缺乏理解该信息重要性的心智能力的人；或对方未满十八岁且不是行为人的配偶。就本条而言，将非身体组成部分的器具或物体插入他人的阴道口或肛门，不属于性行为，除非行为人当时知道该物体带有其本人的体液。还须考虑妊娠相关定义和例外。该罪并不只是持械袭击的泛称。",
      degreeContext: "通常为二级重罪；(A)款中受害人为治安执法人员或符合法定定义的BCI调查员时，为一级重罪。对受保护受害人造成严重身体伤害会触发一级重罪的强制监禁规则。对于2019年3月22日当日或之后的行为，普通最低刑期为二级重罪2至8年或一级重罪3至11年，不定期刑的最高期限依第2929.144条确定；对于单一符合条件的重罪，最高期限为最低刑期加50%。基本罚金上限为二级重罪15,000美元或一级重罪20,000美元，并非固定罚款。符合条件的明知受害人怀孕的附加指控，要求对上述日期范围内的一级或二级重罪判处适用的强制最低刑期，而不是六个月。符合条件的使用助燃剂并造成永久严重毁容或永久重大功能丧失的附加指控，增加六年监禁，须在基础罪行刑期之前连续服刑；同一行为涉及的重罪最多适用一次此类刑期。符合条件的未满十岁受害人遭受永久致残伤害的附加指控，增加六年监禁，须在基础刑期之前连续服刑，但禁止对同一罪行再判任何其他额外监禁期限。在(A)(2)款中将机动车用作致命武器，要求实施二级驾照停权，期限为三年至终身。性动机和性暴力掠夺者两项附加指控均获符合条件的定罪时，可能触发终身监禁；性行为本身并不确立这些附加指控。更早的行为、其他指控及总刑罚须另行审查。",
    },
  },
  ...
  "check-fraud": {
    es: {
      draft: true,
      plainSummary: `El fraude con cheques o un cargo por cheque sin fondos generalmente se refiere a usar, crear o entregar un cheque con el conocimiento y la intención exigidos por la ley aplicable. El estado de la cuenta, el monto, el propósito alegado y cualquier requisito de aviso o pago pueden afectar el cargo. El nombre del delito, sus elementos, clasificación y defensas varían según la jurisdicción; no aplique la ley de cheques de otro estado a este caso.`,
      keyTerms: [
        { plainMeaning: `La fiscalía generalmente debe probar el conocimiento y la intención que exige la ley aplicable, que pueden incluir saber que el cheque no sería aceptado y tener la intención de obtener algo de valor.`, example: `La ley puede exigir probar que sabía que la cuenta no tenía fondos cuando emitió o entregó el cheque` },
        { plainMeaning: `La cuenta pudo no tener fondos suficientes, estar cerrada o no existir, o pertenecer a otra persona, según el cargo.`, example: `Una ley puede distinguir entre un cheque común sin fondos y un cheque de una cuenta cerrada o con una firma falsificada` },
        { plainMeaning: `El monto, la cantidad de cheques, los antecedentes, la víctima y otros hechos pueden afectar la clasificación y las defensas.`, example: `La misma conducta puede clasificarse de forma distinta si se trata de un cheque pequeño por primera vez o de varios cheques por un monto mayor` },
        { plainMeaning: `Según la jurisdicción, la conducta puede incluir escribir, firmar, emitir, entregar, depositar o pasar un cheque.`, example: `Una ley puede abarcar tanto a quien escribe el cheque como a quien lo entrega sabiendo que no será pagado` },
        { plainMeaning: `La clasificación y las penas dependen de la jurisdicción y de los hechos.`, example: `Algunos estados usan umbrales basados en el monto; otros aplican una clasificación fija o una ley distinta de fraude o hurto` },
      ],
      degreeContext: `La clasificación, las penas, los requisitos de aviso o subsanación, la restitución y las opciones de desvío varían ampliamente según la jurisdicción. Algunos estados clasifican los cheques sin fondos según el monto; otros usan un delito menor fijo, una ley de fraude o hurto, o reglas separadas para cheques falsificados y cheques sin fondos. Confirme la ley vigente y las consecuencias exactas con un abogado autorizado en la jurisdicción del caso.`,
    },
    zh: {
      draft: true,
      plainSummary: `支票欺诈或无资金支票指控通常涉及在具备适用法律要求的明知和意图的情况下使用、制作或传递支票。账户状态、支票金额、被指称的目的以及是否需要通知或偿还款项都可能影响指控。具体罪名、要件、分类和抗辩因司法管辖区而异；不要把其他州的支票法律用于本案。`,
      keyTerms: [
        { plainMeaning: `检方通常必须证明适用法律要求的明知和意图，例如明知支票不会被兑现并意图取得有价值的东西。`, example: `法律可能要求证明您在开具或传递支票时知道账户没有足够资金` },
        { plainMeaning: `账户可能资金不足、已经关闭或不存在，或者属于他人，具体取决于所指控的罪名。`, example: `法律可能区分普通无资金支票与来自已关闭账户或带有伪造签名的支票` },
        { plainMeaning: `支票金额、支票数量、前科、受害人和其他事实可能影响罪名分类及可用抗辩。`, example: `同一行为在首次涉及小额支票和涉及多张或大额支票时，可能有不同分类` },
        { plainMeaning: `根据司法管辖区，相关行为可能包括书写、签名、开具、交付、存入或传递支票。`, example: `法律可能同时涵盖写支票的人和明知支票有问题仍将其交给商家的人` },
        { plainMeaning: `罪名分类和刑罚取决于司法管辖区及案件事实。`, example: `有些州按金额设定门槛，另一些州使用固定分类或不同的欺诈、盗窃法律` },
      ],
      degreeContext: `罪名分类、刑罚、通知或补救要求、赔偿规则和转介选项因司法管辖区而有很大差异。有些州按金额划分无资金支票；另一些州使用固定轻罪、欺诈或盗窃法律，或对伪造支票和无资金支票分别规定。请与案件所在司法管辖区的持牌律师确认现行法律和具体后果。`,
    },
  },
