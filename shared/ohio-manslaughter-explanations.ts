...
export const OHIO_MANSLAUGHTER_EXPLANATIONS: ChargeExplanation[] = [
  {
    jurisdiction: "OH", canonicalChargeId: "oh-orc-2903-03-voluntary-manslaughter",
    chargePattern: /^voluntary manslaughter$/i,
  ...
  {
    jurisdiction: "OH", canonicalChargeId: "oh-orc-2903-04-involuntary-manslaughter",
    chargePattern: /^involuntary manslaughter$/i,
