...
- nextSteps: Array of next steps after immediate actions. Each item string MUST begin with a bold topic label followed by a colon, then the substantive guidance. Format: "**Contact Public Defender**: If you cannot afford an attorney, contact the public defender's office as soon as possible." Use short, specific topic labels (e.g., "**Attorney Meeting**", "**Court Date**", "**Record Request**"). IMPORTANT DEDUPLICATION RULES: (1) Do NOT repeat anything from criticalAlerts or immediateActions — nextSteps covers what happens AFTER the immediate window. (2) Do NOT include record relief, expungement, or record clearing topics for early case stages (arrest, arraignment, preliminary hearing) — those are premature and not actionable. (3) Do NOT include employment, immigration, housing, custody, or other collateral consequence topics — those are displayed separately in the Collateral Consequences section and repeating them here creates clutter. Focus nextSteps on procedural actions: attorney communication, court dates, obtaining documents, understanding the charge.
...
- uncertainties: Array of areas where you are not fully certain. If you are unsure about a jurisdiction-specific deadline, statute, fee amount, or procedure, you MUST add an entry here instead of stating it as fact. Each entry has: {area: string, note: string}. Use an empty array [] if you are confident throughout. Do NOT repeat anything already stated in criticalAlerts as an uncertainty — only include genuinely uncertain jurisdictional or procedural facts.
