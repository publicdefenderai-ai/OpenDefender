...
//          Virginia Indigent Defense Commission (indigentdefense.virginia.gov), State PD office websites
// Last Updated: March 2026 (quarterly refresh — added local public defender offices)
// Verification note: All entries sourced from official government websites. Phone numbers and addresses
//   for county_public_defender and court_appointed_program entries should be re-verified quarterly
//   against the source website listed in the dataSource field comments. See check-public-defenders.ts.
...
export const legalAidOrganizationsSeed: InsertLegalAidOrganization[] = [
  ...
  // Source: Virginia Indigent Defense Commission — indigentdefense.virginia.gov
  // Added: March 2026. Verify quarterly against source website.
  // These offices handle STATE criminal cases. They are separate from the federal
  // public defenders listed above, which only handle federal cases.
  // ==========================================================================

  // ── VIRGINIA — Local Public Defender Offices ──────────────────────────────
  // Source: Virginia Indigent Defense Commission (VIDC), indigentdefense.virginia.gov
  // Virginia has a statewide public defender system with offices in each
  // judicial circuit. All offices are managed by VIDC.

  {
    name: "Richmond City Public Defender",
    organizationType: "county_public_defender",
    address: "1 North 9th Street, Suite 10",
    city: "Richmond",
    state: "VA",
    zipCode: "23219",
    county: "Richmond City",
    countyServed: ["Richmond City"],
    phone: "(804) 786-4731",
    email: null,
    website: "https://indigentdefense.virginia.gov",
    latitude: "37.5385",
    longitude: "-77.4338",
    services: ["State Criminal Defense", "Misdemeanor Defense", "Felony Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants in state criminal cases in Richmond City Circuit and General District Courts. Income eligibility determined at first hearing.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Fairfax County Public Defender",
    organizationType: "county_public_defender",
    address: "4103 Chain Bridge Road, Suite 500",
    city: "Fairfax",
    state: "VA",
    zipCode: "22030",
    county: "Fairfax County",
    countyServed: ["Fairfax County", "City of Fairfax"],
    phone: "(703) 246-3040",
    email: null,
    website: "https://indigentdefense.virginia.gov",
    latitude: "38.8462",
    longitude: "-77.3064",
    services: ["State Criminal Defense", "Misdemeanor Defense", "Felony Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants in state criminal cases in Fairfax County and City of Fairfax courts. Income eligibility determined at first hearing.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Norfolk City Public Defender",
    organizationType: "county_public_defender",
    address: "150 St. Paul's Boulevard, Suite 1200",
    city: "Norfolk",
    state: "VA",
    zipCode: "23510",
    county: "Norfolk City",
    countyServed: ["Norfolk City"],
    phone: "(757) 664-4973",
    email: null,
    website: "https://indigentdefense.virginia.gov",
    latitude: "36.8508",
    longitude: "-76.2859",
    services: ["State Criminal Defense", "Misdemeanor Defense", "Felony Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants in state criminal cases in Norfolk Circuit and General District Courts. Income eligibility determined at first hearing.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Virginia Beach Public Defender",
    organizationType: "county_public_defender",
    ...
    countyServed: ["Virginia Beach City"],
    phone: "(757) 385-4733",
    email: null,
    website: "https://indigentdefense.virginia.gov",
    latitude: "36.7682",
    longitude: "-76.0319",
    services: ["State Criminal Defense", "Misdemeanor Defense", "Felony Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants in state criminal cases in Virginia Beach Circuit and General District Courts. Income eligibility determined at first hearing.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Chesterfield County Public Defender",
    organizationType: "county_public_defender",
    address: "9500 Courthouse Road",
    city: "Chesterfield",
    state: "VA",
    zipCode: "23832",
    county: "Chesterfield County",
    countyServed: ["Chesterfield County"],
    phone: null,
    email: null,
    website: "https://indigentdefense.virginia.gov",
    latitude: "37.3776",
    longitude: "-77.5052",
    services: ["State Criminal Defense", "Misdemeanor Defense", "Felony Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants in state criminal cases in Chesterfield County courts. Income eligibility determined at first hearing.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Henrico County Public Defender",
    organizationType: "county_public_defender",
    ...
    longitude: "-77.4800",
    services: ["State Criminal Defense", "Misdemeanor Defense", "Felony Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants in state criminal cases in Henrico County courts. Income eligibility determined at first hearing.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    ...
    organizationType: "county_public_defender",
    address: "1425 North Courthouse Road, Suite 2400",
    city: "Arlington",
    state: "VA",
    zipCode: "22201",
    county: "Arlington County",
    countyServed: ["Arlington County", "City of Alexandria"],
    phone: "(703) 228-7420",
    email: null,
    website: "https://indigentdefense.virginia.gov",
    latitude: "38.8816",
    longitude: "-77.0910",
    services: ["State Criminal Defense", "Misdemeanor Defense", "Felony Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants in state criminal cases in Arlington County and City of Alexandria courts. Income eligibility determined at first hearing.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Prince William County Public Defender",
    organizationType: "county_public_defender",
    ...
    countyServed: ["Prince William County", "City of Manassas", "City of Manassas Park"],
    phone: null,
    email: null,
    website: "https://indigentdefense.virginia.gov",
    latitude: "38.7510",
    longitude: "-77.4753",
    services: ["State Criminal Defense", "Misdemeanor Defense", "Felony Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants in state criminal cases in Prince William County, City of Manassas, and City of Manassas Park courts. Income eligibility determined at first hearing.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Loudoun County Public Defender",
    organizationType: "county_public_defender",
    address: "18 East Market Street",
    city: "Leesburg",
    state: "VA",
    zipCode: "20176",
    county: "Loudoun County",
    countyServed: ["Loudoun County"],
    phone: null,
    email: null,
    website: "https://indigentdefense.virginia.gov",
    latitude: "39.1157",
    longitude: "-77.5636",
    services: ["State Criminal Defense", "Misdemeanor Defense", "Felony Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants in state criminal cases in Loudoun County courts. Income eligibility determined at first hearing.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Newport News Public Defender",
    organizationType: "county_public_defender",
    address: "2501 Washington Avenue",
    city: "Newport News",
    state: "VA",
    zipCode: "23607",
    county: "Newport News City",
    countyServed: ["Newport News City"],
    phone: null,
    email: null,
    website: "https://indigentdefense.virginia.gov",
    latitude: "37.0871",
    longitude: "-76.4730",
    services: ["State Criminal Defense", "Misdemeanor Defense", "Felony Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants in state criminal cases in Newport News Circuit and General District Courts. Income eligibility determined at first hearing.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Hampton Public Defender",
    organizationType: "county_public_defender",
    address: "236 North King Street",
    city: "Hampton",
    state: "VA",
    zipCode: "23669",
    county: "Hampton City",
    countyServed: ["Hampton City"],
    phone: null,
    email: null,
    website: "https://indigentdefense.virginia.gov",
    latitude: "37.0299",
    longitude: "-76.3452",
    services: ["State Criminal Defense", "Misdemeanor Defense", "Felony Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants in state criminal cases in Hampton Circuit and General District Courts. Income eligibility determined at first hearing.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Portsmouth Public Defender",
    organizationType: "county_public_defender",
    ...
    longitude: "-76.2983",
    services: ["State Criminal Defense", "Misdemeanor Defense", "Felony Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants in state criminal cases in Portsmouth Circuit and General District Courts. Income eligibility determined at first hearing.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Chesapeake Public Defender",
    organizationType: "county_public_defender",
    ...
    longitude: "-76.2452",
    services: ["State Criminal Defense", "Misdemeanor Defense", "Felony Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants in state criminal cases in Chesapeake Circuit and General District Courts. Income eligibility determined at first hearing.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Roanoke City Public Defender",
    organizationType: "county_public_defender",
    address: "315 West Church Avenue, Suite 514",
    city: "Roanoke",
    state: "VA",
    zipCode: "24011",
    county: "Roanoke City",
    countyServed: ["Roanoke City", "Roanoke County"],
    phone: null,
    email: null,
    website: "https://indigentdefense.virginia.gov",
    latitude: "37.2710",
    longitude: "-79.9414",
    services: ["State Criminal Defense", "Misdemeanor Defense", "Felony Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants in state criminal cases in Roanoke City and County courts. Income eligibility determined at first hearing.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Lynchburg Public Defender",
    organizationType: "county_public_defender",
    address: "900 Church Street, Suite 600",
    city: "Lynchburg",
    state: "VA",
    zipCode: "24504",
    county: "Lynchburg City",
    countyServed: ["Lynchburg City", "Campbell County"],
    phone: null,
    email: null,
    website: "https://indigentdefense.virginia.gov",
    latitude: "37.4138",
    longitude: "-79.1422",
    services: ["State Criminal Defense", "Misdemeanor Defense", "Felony Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants in state criminal cases in Lynchburg and Campbell County courts. Income eligibility determined at first hearing.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Charlottesville/Albemarle Public Defender",
    organizationType: "county_public_defender",
    address: "315 East High Street",
    city: "Charlottesville",
    state: "VA",
    zipCode: "22902",
    county: "Albemarle County",
    countyServed: ["City of Charlottesville", "Albemarle County", "Greene County", "Louisa County", "Fluvanna County"],
    phone: null,
    email: null,
    website: "https://indigentdefense.virginia.gov",
    latitude: "38.0293",
    longitude: "-78.4767",
    services: ["State Criminal Defense", "Misdemeanor Defense", "Felony Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants in state criminal cases in Charlottesville, Albemarle, Greene, Louisa, and Fluvanna courts. Income eligibility determined at first hearing.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Harrisonburg/Rockingham Public Defender",
    organizationType: "county_public_defender",
    address: "91 Court Square",
    city: "Harrisonburg",
    state: "VA",
    zipCode: "22801",
    county: "Rockingham County",
    countyServed: ["City of Harrisonburg", "Rockingham County"],
    phone: null,
    email: null,
    website: "https://indigentdefense.virginia.gov",
    latitude: "38.4496",
    longitude: "-78.8689",
    services: ["State Criminal Defense", "Misdemeanor Defense", "Felony Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants in state criminal cases in Harrisonburg and Rockingham County courts. Income eligibility determined at first hearing.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Fredericksburg/Spotsylvania Public Defender",
    organizationType: "county_public_defender",
    address: "601 Caroline Street",
    city: "Fredericksburg",
    state: "VA",
    zipCode: "22401",
    county: "Spotsylvania County",
    countyServed: ["City of Fredericksburg", "Spotsylvania County", "Stafford County", "King George County"],
    phone: null,
    email: null,
    website: "https://indigentdefense.virginia.gov",
    latitude: "38.3032",
    longitude: "-77.4605",
    services: ["State Criminal Defense", "Misdemeanor Defense", "Felony Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants in state criminal cases in Fredericksburg, Spotsylvania, Stafford, and King George courts. Income eligibility determined at first hearing.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Petersburg Public Defender",
    organizationType: "county_public_defender",
    address: "35 East Tabb Street",
    city: "Petersburg",
    state: "VA",
    zipCode: "23803",
    county: "Petersburg City",
    countyServed: ["City of Petersburg", "Dinwiddie County", "Prince George County", "Colonial Heights"],
    phone: null,
    email: null,
    website: "https://indigentdefense.virginia.gov",
    latitude: "37.2279",
    longitude: "-77.4019",
    services: ["State Criminal Defense", "Misdemeanor Defense", "Felony Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants in state criminal cases in Petersburg and surrounding courts. Income eligibility determined at first hearing.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Winchester/Frederick County Public Defender",
    organizationType: "county_public_defender",
    ...
    countyServed: ["City of Winchester", "Frederick County", "Clarke County", "Warren County", "Shenandoah County", "Page County"],
    phone: null,
    email: null,
    website: "https://indigentdefense.virginia.gov",
    latitude: "39.1856",
    longitude: "-78.1633",
    services: ["State Criminal Defense", "Misdemeanor Defense", "Felony Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants in state criminal cases in Winchester, Frederick, Clarke, Warren, Shenandoah, and Page courts. Income eligibility determined at first hearing.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Staunton/Augusta County Public Defender",
    organizationType: "county_public_defender",
    address: "113 East Beverly Street",
    city: "Staunton",
    state: "VA",
    zipCode: "24401",
    county: "Augusta County",
    countyServed: ["City of Staunton", "City of Waynesboro", "Augusta County", "Highland County", "Bath County"],
    phone: null,
    email: null,
    website: "https://indigentdefense.virginia.gov",
    latitude: "38.1496",
    longitude: "-79.0717",
    services: ["State Criminal Defense", "Misdemeanor Defense", "Felony Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants in state criminal cases in Staunton, Waynesboro, Augusta, Highland, and Bath courts. Income eligibility determined at first hearing.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Suffolk/Isle of Wight Public Defender",
    organizationType: "county_public_defender",
    address: "441 Market Street",
    city: "Suffolk",
    state: "VA",
    zipCode: "23434",
    county: "Suffolk City",
    countyServed: ["City of Suffolk", "Isle of Wight County", "Southampton County"],
    phone: null,
    email: null,
    website: "https://indigentdefense.virginia.gov",
    latitude: "36.7282",
    longitude: "-76.5836",
    services: ["State Criminal Defense", "Misdemeanor Defense", "Felony Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants in state criminal cases in Suffolk, Isle of Wight, and Southampton courts. Income eligibility determined at first hearing.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Williamsburg/James City Public Defender",
    organizationType: "county_public_defender",
    address: "101 Mounts Bay Road, Suite B",
    city: "Williamsburg",
    state: "VA",
    zipCode: "23185",
    county: "James City County",
    countyServed: ["City of Williamsburg", "James City County", "York County"],
    phone: null,
    email: null,
    website: "https://indigentdefense.virginia.gov",
    latitude: "37.2707",
    longitude: "-76.7075",
    services: ["State Criminal Defense", "Misdemeanor Defense", "Felony Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants in state criminal cases in Williamsburg, James City, and York courts. Income eligibility determined at first hearing.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Bristol/Washington County Public Defender",
    organizationType: "county_public_defender",
    ...
    countyServed: ["City of Bristol", "Washington County", "Scott County", "Lee County", "Wise County", "Dickenson County", "Buchanan County"],
    phone: null,
    email: null,
    website: "https://indigentdefense.virginia.gov",
    latitude: "36.5951",
    longitude: "-82.1887",
    services: ["State Criminal Defense", "Misdemeanor Defense", "Felony Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants in state criminal cases in Bristol and Southwest Virginia courts. Income eligibility determined at first hearing.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Eastern Shore Public Defender",
    organizationType: "county_public_defender",
    address: "23316 Courthouse Avenue",
    city: "Accomac",
    state: "VA",
    zipCode: "23301",
    county: "Accomack County",
    countyServed: ["Accomack County", "Northampton County"],
    phone: null,
    email: null,
    website: "https://indigentdefense.virginia.gov",
    latitude: "37.7157",
    longitude: "-75.6663",
    services: ["State Criminal Defense", "Misdemeanor Defense", "Felony Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants in state criminal cases in Accomack and Northampton courts. Income eligibility determined at first hearing.",
    dataSource: "state_pd_website",
    isActive: true,
  },

  // ==========================================================================
  // PHASE A — STATE-LEVEL PUBLIC DEFENDER CONTACTS
  // One entry per state with centralized PD system.
  // Source: Each state's official public defender website.
  // These are the main statewide office contacts; local branch offices to be
  // expanded in subsequent data collection passes.
  // All phone numbers and addresses need quarterly verification against source.
  // ==========================================================================

  {
    name: "New Jersey Office of the Public Defender — Main Office",
    organizationType: "county_public_defender",
    address: "25 Market Street, P.O. Box 850",
    city: "Trenton",
    state: "NJ",
    zipCode: "08625",
    county: null,
    ...
    phone: "(609) 292-7087",
    email: null,
    website: "https://www.njpublicdefender.org",
    latitude: "40.2206",
    longitude: "-74.7697",
    services: ["State Criminal Defense", "Felony Defense", "Appellate Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants charged with indictable (felony-level) offenses in New Jersey state courts. Local regional offices handle county-level cases — see njpublicdefender.org for your county's office.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Massachusetts Committee for Public Counsel Services (CPCS)",
    organizationType: "county_public_defender",
    address: "197 Friend Street",
    city: "Boston",
    state: "MA",
    ...
    latitude: "42.3636",
    longitude: "-71.0630",
    services: ["State Criminal Defense", "Felony Defense", "Misdemeanor Defense", "Juvenile Defense", "Mental Health Defense", "Appellate Defense"],
    eligibility: "Indigent defendants in Massachusetts state criminal proceedings. CPCS assigns both staff attorneys and private bar advocates. See publiccounsel.net for regional office contacts.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Connecticut Office of the Public Defender — Main Office",
    organizationType: "county_public_defender",
    ...
    phone: "(203) 805-6400",
    email: null,
    website: "https://www.ocpd.state.ct.us",
    latitude: "41.5582",
    longitude: "-73.0515",
    services: ["State Criminal Defense", "Felony Defense", "Misdemeanor Defense", "Juvenile Defense", "Death Penalty Defense", "Appellate Defense"],
    eligibility: "Indigent defendants in Connecticut state criminal courts. Connecticut has a statewide unified PD system with offices in each judicial district — see ocpd.state.ct.us for your district's office.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Maryland Office of the Public Defender — Main Office",
    organizationType: "county_public_defender",
    address: "6 St. Paul Street, Suite 1400",
    city: "Baltimore",
    state: "MD",
    zipCode: "21202",
    county: null,
    ...
    longitude: "-76.6122",
    services: ["State Criminal Defense", "Felony Defense", "Misdemeanor Defense", "Juvenile Defense", "Death Penalty Defense", "Appellate Defense"],
    eligibility: "Indigent defendants charged in Maryland state criminal courts. The OPD has offices in all 24 jurisdictions — see opd.state.md.us for your county's office.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Alaska Public Defender Agency — Main Office",
    organizationType: "county_public_defender",
    ...
    phone: "(907) 334-4400",
    email: null,
    website: "https://law.alaska.gov/department/pd.html",
    latitude: "61.2181",
    longitude: "-149.9003",
    services: ["State Criminal Defense", "Felony Defense", "Misdemeanor Defense", "Juvenile Defense", "Appellate Defense"],
    eligibility: "Indigent defendants in Alaska state criminal courts. The agency has offices in Anchorage, Fairbanks, Juneau, Kenai, and other locations — see the agency website for regional offices.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Delaware Office of Defense Services — Public Defender Division",
    organizationType: "county_public_defender",
    address: "820 North French Street",
    city: "Wilmington",
    state: "DE",
    zipCode: "19801",
    county: null,
    ...
    phone: "(302) 577-5200",
    email: null,
    website: "https://ogs.delaware.gov/ods",
    latitude: "39.7447",
    longitude: "-75.5484",
    services: ["State Criminal Defense", "Felony Defense", "Misdemeanor Defense", "Juvenile Defense", "Appellate Defense"],
    eligibility: "Indigent defendants in Delaware state criminal courts. Delaware has a unified statewide public defender system with offices in all three counties.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Hawaii Office of the Public Defender — Main Office",
    organizationType: "county_public_defender",
    address: "1130 North Nimitz Highway, Suite A-254G",
    city: "Honolulu",
    state: "HI",
    zipCode: "96817",
    county: null,
    ...
    phone: "(808) 586-2433",
    email: null,
    website: "https://opd.hawaii.gov",
    latitude: "21.3296",
    longitude: "-157.8799",
    services: ["State Criminal Defense", "Felony Defense", "Misdemeanor Defense", "Juvenile Defense", "Appellate Defense"],
    eligibility: "Indigent defendants in Hawaii state criminal courts. The OPD has offices on Oahu, Maui, and Hawaii Island.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "New Mexico Law Offices of the Public Defender — Main Office",
    organizationType: "county_public_defender",
    address: "301 North Guadalupe Street, Suite 101",
    city: "Santa Fe",
    state: "NM",
    zipCode: "87501",
    county: null,
    ...
    latitude: "35.6869",
    longitude: "-105.9378",
    services: ["State Criminal Defense", "Felony Defense", "Misdemeanor Defense", "Juvenile Defense", "Appellate Defense", "Capital Defense"],
    eligibility: "Indigent defendants in New Mexico state criminal courts. LOPD has 16 district offices statewide — see lopdnm.us for your district's office.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Oregon Office of Public Defense Services — Main Office",
    organizationType: "county_public_defender",
    address: "1175 Court Street NE",
    city: "Salem",
    state: "OR",
    zipCode: "97301",
    county: null,
    ...
    phone: "(503) 378-3349",
    email: null,
    website: "https://www.oregonpublicdefenders.org",
    latitude: "44.9429",
    longitude: "-123.0351",
    services: ["State Criminal Defense", "Felony Defense", "Misdemeanor Defense", "Juvenile Defense", "Appellate Defense", "Death Penalty Defense"],
    eligibility: "Indigent defendants in Oregon state criminal courts. Oregon contracts with independent public defense offices statewide — see the website for your county's assigned provider.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Rhode Island Office of the Public Defender — Main Office",
    organizationType: "county_public_defender",
    ...
    phone: "(401) 222-3492",
    email: null,
    website: "https://www.opd.ri.gov",
    latitude: "41.8210",
    longitude: "-71.4128",
    services: ["State Criminal Defense", "Felony Defense", "Misdemeanor Defense", "Juvenile Defense", "Appellate Defense"],
    eligibility: "Indigent defendants in Rhode Island state criminal courts. Rhode Island has a unified statewide system serving all defendants.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Vermont Defender General's Office",
    organizationType: "county_public_defender",
    address: "6 Baldwin Street",
    city: "Montpelier",
    state: "VT",
    zipCode: "05633",
    county: null,
    ...
    phone: "(802) 828-3168",
    email: null,
    website: "https://defgen.vermont.gov",
    latitude: "44.2601",
    longitude: "-72.5754",
    services: ["State Criminal Defense", "Felony Defense", "Misdemeanor Defense", "Juvenile Defense", "Appellate Defense"],
    eligibility: "Indigent defendants in Vermont state criminal courts. The Defender General supervises both the Public Defender Division and the Appellate Defender.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "West Virginia Public Defender Services — Main Office",
    organizationType: "county_public_defender",
    address: "90 MacCorkle Avenue SW, Suite 101",
    ...
    phone: "(304) 558-3905",
    email: null,
    website: "https://pds.wv.gov",
    latitude: "38.3532",
    longitude: "-81.7121",
    services: ["State Criminal Defense", "Felony Defense", "Misdemeanor Defense", "Juvenile Defense", "Appellate Defense"],
    eligibility: "Indigent defendants in West Virginia state criminal courts. PDS provides both a Public Defender Corporation system and contracts with private attorneys in some counties.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Wyoming State Public Defender — Main Office",
    organizationType: "county_public_defender",
    ...
    phone: "(307) 777-7884",
    email: null,
    website: "https://wyomingpublicdefender.com",
    latitude: "41.1400",
    longitude: "-104.8202",
    services: ["State Criminal Defense", "Felony Defense", "Misdemeanor Defense", "Juvenile Defense", "Appellate Defense"],
    eligibility: "Indigent defendants in Wyoming state criminal courts. The SPD has regional offices throughout the state — see wyomingpublicdefender.com for your region.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Montana Office of the State Public Defender — Main Office",
    organizationType: "county_public_defender",
    address: "107 West Lawrence Street, Suite 212",
    city: "Helena",
    state: "MT",
    zipCode: "59601",
    county: null,
    ...
    phone: "(406) 444-2272",
    email: null,
    website: "https://opd.mt.gov",
    latitude: "46.5958",
    longitude: "-112.0270",
    services: ["State Criminal Defense", "Felony Defense", "Misdemeanor Defense", "Juvenile Defense", "Appellate Defense"],
    eligibility: "Indigent defendants in Montana state criminal courts. The OPD has regional offices statewide — see opd.mt.gov for your region.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Minnesota Board of Public Defense — Main Office",
    organizationType: "county_public_defender",
    address: "331 Second Avenue South, Suite 900",
    city: "Minneapolis",
    state: "MN",
    zipCode: "55401",
    county: null,
    ...
    phone: "(612) 279-3522",
    email: null,
    website: "https://mbpd.mn.gov",
    latitude: "44.9778",
    longitude: "-93.2650",
    services: ["State Criminal Defense", "Felony Defense", "Misdemeanor Defense", "Juvenile Defense", "Appellate Defense"],
    eligibility: "Indigent defendants in Minnesota state criminal courts. Minnesota has 10 public defender districts corresponding to the judicial districts — see mbpd.mn.gov for your district.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Colorado State Public Defender — Main Office",
    organizationType: "county_public_defender",
    address: "1300 Broadway, Suite 400",
    city: "Denver",
    state: "CO",
    zipCode: "80203",
    county: null,
    ...
    phone: "(303) 764-1400",
    email: null,
    website: "https://www.coloradopd.org",
    latitude: "39.7393",
    longitude: "-104.9848",
    services: ["State Criminal Defense", "Felony Defense", "Misdemeanor Defense", "Juvenile Defense", "Appellate Defense", "Death Penalty Defense"],
    eligibility: "Indigent defendants in Colorado state criminal courts. The CSPD has over 20 regional offices — see coloradopd.org for your county's office.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "Louisiana Public Defender Board — Statewide Contact",
    organizationType: "county_public_defender",
    ...
    latitude: "30.4515",
    longitude: "-91.1871",
    services: ["State Criminal Defense", "Felony Defense", "Misdemeanor Defense", "Juvenile Defense"],
    eligibility: "Indigent defendants in Louisiana state criminal courts. Each judicial district has its own public defender office. See lpdb.la.gov for your parish's public defender.",
    dataSource: "state_pd_website",
    isActive: true,
  },
  {
    name: "New Hampshire Office of the Public Defender — Main Office",
    organizationType: "county_public_defender",
    address: "10 Ferry Street, Suite 202",
    city: "Concord",
    state: "NH",
    zipCode: "03301",
    county: null,
    ...
    phone: "(603) 224-1236",
    email: null,
    website: "https://www.nhpd.org",
    latitude: "43.2081",
    longitude: "-71.5376",
    services: ["State Criminal Defense", "Felony Defense", "Misdemeanor Defense", "Juvenile Defense", "Appellate Defense"],
    eligibility: "Indigent defendants in New Hampshire state criminal courts. The NHOPD has offices in 10 locations statewide — see nhpd.org for your county's office.",
    dataSource: "state_pd_website",
    isActive: true,
  },
];
