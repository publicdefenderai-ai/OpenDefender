...
#### Engineer primary-source research pass — July 2026 (MA, TN, IN, SC, KY, AL, LA, OR, OK, NV, CT)

| State | Date | Findings | Status |
|---|---|---|---|
| MA | 2026-07 | Mass. R. Crim. P. 14(a)(1)(A): **automatic disclosure** — prosecution must provide most discoverable materials without a defense request. Timing tracks first pretrial conference (~21 days District Court, ~28 days Superior Court). Prior "30 days after arraignment" was a generic placeholder; string corrected to "Within 21–28 days of arraignment" with citation. Remains in `PROCEDURAL_DEADLINE_ESTIMATE_JURISDICTIONS` until `preliminaryHearing` is also cited. | Corrected; **attorney review pending** |
| TN | 2026-07 | Tenn. R. Crim. P. 16: **request-triggered** — defendant must serve a written request to initiate discovery; no automatic post-arraignment deadline. String already accurate ("Upon request"); source citation comment added inline. | Engineer-verified; **attorney review pending** |
| IN | 2026-07 | Ind. Code § 35-36-1: discovery is **court-ordered by motion** — defense must file a motion; no fixed automatic post-arraignment deadline. String corrected from bare "30 days" to "30 days after arraignment (approximate; Ind. Code § 35-36-1 — court-ordered by motion)." | Corrected; **attorney review pending** |
| SC | 2026-07 | SC Rule 5(a)(2) SCRCrimP: **request-triggered** — prosecution's disclosure obligation activated by defendant's written demand; 30-day response window follows demand. String already accurate ("Within 30 days of written demand"); citation comment added inline. | Engineer-verified; **attorney review pending** |
| KY | 2026-07 | Ky. RCr 7.24: **request-triggered** — defendant must serve a written demand; no fixed automatic post-arraignment deadline. String corrected from bare "30 days" to "30 days after arraignment (approximate; Ky. RCr 7.24 — request-triggered)." | Corrected; **attorney review pending** |
| AL | 2026-07 | Ala. R. Crim. P. 16.1: **request-triggered** — prosecution must disclose within 14 days of defendant's written request. String already accurate ("Within 14 days of written request"); citation comment added inline. | Engineer-verified; **attorney review pending** |
| LA | 2026-07 | La. Code Crim. Proc. Ann. Art. 716–723: **motion-triggered** — defendant must file a motion for discovery; prosecution has no automatic disclosure obligation. String corrected from bare "30 days" to "30 days after arraignment (approximate; La. Code Crim. Proc. Ann. Art. 716 — motion-triggered)." Remains in `PROCEDURAL_DEADLINE_ESTIMATE_JURISDICTIONS`. | Corrected; **attorney review pending** |
| OR | 2026-07 | ORS § 135.815: **automatic disclosure** — prosecution must disclose listed items without a defense request; statute says "as soon as practicable" with no fixed post-arraignment day limit. String corrected from bare "30 days" to "30 days after arraignment (approximate; ORS § 135.815 — automatic disclosure)." | Corrected; **attorney review pending** |
| OK | 2026-07 | Okla. Stat. tit. 22 § 2002(A): **request-triggered** — defendant must file a written request; no automatic post-arraignment disclosure. String corrected from bare "30 days" to "30 days after arraignment (approximate; Okla. Stat. tit. 22 § 2002(A) — request-triggered)." Remains in `PROCEDURAL_DEADLINE_ESTIMATE_JURISDICTIONS`. | Corrected; **attorney review pending** |
| NV | 2026-07 | NRS § 174.234: **mandatory automatic disclosure** — prosecution must provide listed items without request; statute says "as soon as practicable" with no fixed post-arraignment day limit. String corrected from bare "30 days" to "30 days after arraignment (approximate; NRS § 174.234 — mandatory automatic disclosure)." | Corrected; **attorney review pending** |
| CT | 2026-07 | Conn. Prac. Book § 40-11(a): **automatic disclosure** — prosecution must disclose listed items without a defense request; within 3 business days of arraignment for in-custody defendants, or at/before arraignment if released. Prior "30 days after arraignment" was materially inaccurate. String corrected to "Within 3 business days of arraignment for in-custody defendants; at or before arraignment if released." P1-97 scenario keyword updated from '30 days' to '3 business days'. Remains in `PROCEDURAL_DEADLINE_ESTIMATE_JURISDICTIONS` until `preliminaryHearing` is also cited. | Corrected; **attorney review pending** |

All other mapped states (CA, TX, NY, FL, IL, PA, WA, OH, GA, CO, MN, MO, WI, MD, federal) have had **no** primary-source research pass for the supplemental fields (`preliminaryHearing`, `discoveryDeadline`).  Passing scenarios confirm internal consistency only.
