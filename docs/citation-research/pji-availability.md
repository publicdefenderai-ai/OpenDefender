...
| IL | Illinois Pattern Jury Instructions (Crim.) | IL Sup. Ct. | Yes (HTML) | Yes | No | Yes | **IMPL** — IPI-CR refs + illinoiscourts.gov chapter PDF URLs; murder, manslaughter, robbery, burglary, rape, assault, DUI, drugs, attempt; **16.01 criminal damage/vandalism** (Ch. 16 GUID 50f36433, verified 2026-06); **Ch. 16 criminal trespass to real property** (§ 21-3, same GUID, exact sub-instruction unverified); **19.07 disorderly conduct** (§ 26-1, Ch. 19 GUID 8e77f5e4, verified 2026-06); **19.09 harassment by telephone** (predecessor 720 ILCS 135/1-1 → replaced by § 26.5-2, no updated IPI-CR issued, 19.09 is the applicable instruction, Ch. 19 GUID 8e77f5e4, verified 2026-06); Ch. 19 titled "Mob Action" but contains disorderly conduct (19.07) and harassment (19.09–19.10) instructions |
...
| MS | Mississippi Model Jury Instructions | MS Bar | No | No | Yes | No | **IMPL** — Miss. Model JI (Crim.) refs only (paywalled; no instructionUrl); murder (1-1/1-3/1-5), manslaughter (1-7/1-9), attempted murder (1-20), assault (16-1), DV (16-10), robbery (23-1/23-3), burglary (19-1/19-3), rape/sexual assault (25-1/25-5), DUI (27-40), drug trafficking (27-20), PWID (27-25), drug possession (27-10), petty theft (12-1), grand theft (12-3), shoplifting (12-5), trespass (22-1), vandalism (22-5), resisting arrest (24-1), failure to appear (24-5), harassment (28-5), disorderly conduct (28-10), loitering (28-15), public intoxication (28-20); **inchoate**: aiding/abetting (2-1), accessory after the fact (2-5), attempt (3-1), conspiracy (3-5), solicitation (3-10); **enhancements**: gang (29-1), hate crime (29-5), firearm (30-1), recidivist (33-1); **weapons**: unlawful carrying (30-5), felon-in-possession (30-10), discharge of firearm (30-15), prohibited weapon (30-20); **fraud/financial**: wire fraud (12-10), mail fraud (12-15), check fraud (12-20), identity theft (12-25), credit card fraud (12-30), money laundering (13-1), insurance fraud (13-5), tax fraud (13-10), computer fraud (13-15) |
| AR | Arkansas Model Jury Instructions (Crim.) | AR Judicial Council | No | No | Yes | No | **IMPL** — AMI Crim. refs only (paywalled; no instructionUrl); murder (1001/1002/1003), manslaughter (1004/1005), crim neg homicide (1006), vehicular homicide (1008), assault (2001), DV (2015), robbery (3001/3002), burglary (3501/3502), rape (4003), sexual assault (4001), DUI (5001), drug trafficking (6001), drug possession (6002), petty theft (7003), grand theft (7001/7002), shoplifting (7005), vandalism (7101), trespass (7201), harassment (9001), disorderly conduct (9101), loitering (9102), public intoxication (9201), resisting arrest (9301), failure to appear (9401); **inchoate**: aiding/abetting (401), accessory after the fact (402), attempt (501), solicitation (502), conspiracy (601); **enhancements**: recidivist/habitual offender (701), gang (8001), hate crime (8101), firearm (8201), drug school zone (6010); **weapons**: unlawful carrying (8202), felon-in-possession (8203), discharge of firearm (8204), prohibited weapon (8205); **fraud/financial**: wire fraud (7301), mail fraud (7302), check fraud (7303), identity theft (7304), credit card fraud (7305), money laundering (8301), insurance fraud (8401), tax fraud (8501), computer fraud (8601) |
...
| NV | Nevada Jury Instructions | NV Cts. / State Bar | No | No | Yes | No | **IMPL** — Nev. JI refs only (paywalled; no instructionUrl); murder (51/52), manslaughter (53/54), vehicular homicide (55), assault (70), DV (75), robbery (120/122), burglary (131/133), sexual assault/rape (81/82), DUI (245), drug trafficking (200), PWID (205), drug possession (§28.01), petty theft (§15.10), grand theft (§15.20/§15.25), shoplifting (§15.30), trespass (§20.07), vandalism (§21.01), harassment (§20.05), resisting arrest (§19.05), failure to appear/bail jumping (§19.10), loitering (§20.06), **disorderly conduct (§20.04)**, **public intoxication (§20.03)**, **battery/misdemeanor (§8.01)**, **petit larceny (§15.10)**, **distribution of controlled substance (§28.05)**; **weapons**: unlawful carrying (§9.01), felon-in-possession (§9.02), discharge of firearm (§9.03), prohibited weapon (§9.04); **inchoate**: attempt (§5.01), conspiracy (§5.05), solicitation (§5.10), aiding & abetting (§5.15); **fraud/financial**: wire fraud/false representation (§15.40), check fraud/worthless check (§15.50), identity theft (§15.60), embezzlement (§15.70), money laundering (§16.01); **traffic/minor-offense additions (2026-07)**: noise-violation → §20.04, illegal-camping → §20.06, panhandling → §20.06; **omitted (no Nev. JI pattern instruction)**: open-container (regulatory traffic), minor-in-possession (regulatory alcohol), false-info-to-police (no dedicated § listed), driving-without-insurance (regulatory), expired-registration (regulatory), expired-inspection (regulatory/administrative), indecent-exposure (not in listed §§), animal-cruelty-misdemeanor (no §), truancy (civil/administrative), littering (regulatory), illegal-fireworks (regulatory) |
