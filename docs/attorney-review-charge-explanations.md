# Attorney Review Checklist: Charge Explanations Flagged for Review (2026-08)

**Status:** PENDING REVIEW  
**Date generated:** 2026-08  
**File:** `shared/charge-explanations.ts`  
**Entries requiring review:** 16 existing entries, newly flagged for review (13 AI-drafted without statutory sources; 3 AI-drafted with statutory sources)

---

## Instructions for Reviewing Attorney

The 16 entries below already existed in `shared/charge-explanations.ts`; this pass did not add new charge categories, it added the `pendingAttorneyReview` flag and the risk-area notes below to entries that were originally drafted by an AI assistant from general legal knowledge, pattern jury instructions, and in some cases cited statutes. They have **not** been verified by a licensed criminal defense attorney.
