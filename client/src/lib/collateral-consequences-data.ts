...
export const DRIVERS_LICENSE_RULES: Record<string, DriversLicenseRule> = {
  ...
  // ── Alabama ────────────────────────────────────────────────────────────────
  AL: { state: 'AL', stateName: 'Alabama', firstOffenseDuiSuspensionDays: 90, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'Ala. Code §§ 32-5A-191(c)(1), 32-5A-195; Ala. Code § 32-6-19', notes: 'Ala. Code Title 32 (Motor Vehicles) reviewed; no standalone drug conviction (non-DUI) license suspension provision found.', dataConfidence: 'medium', lastVerified: '2026-07' },

  // ── Alaska ─────────────────────────────────────────────────────────────────
  AK: { state: 'AK', stateName: 'Alaska', firstOffenseDuiSuspensionDays: 90, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'Alaska Stat. §§ 28.15.165(a)(1), 28.35.030', notes: 'Alaska Stat. Title 28 (Motor Vehicles) reviewed; no standalone drug conviction (non-DUI) license suspension provision found.', dataConfidence: 'medium', lastVerified: '2026-07' },

  // ── Arizona ────────────────────────────────────────────────────────────────
  AZ: { state: 'AZ', stateName: 'Arizona', firstOffenseDuiSuspensionDays: 90, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'Ariz. Rev. Stat. §§ 28-1381, 28-3318, 28-3319', notes: 'Administrative suspension runs concurrent with criminal suspension. IID required on all reinstatements. Ariz. Rev. Stat. Title 28 (Transportation) reviewed; no standalone drug conviction (non-DUI) license suspension provision found.', dataConfidence: 'medium', lastVerified: '2026-07' },

  // ── Arkansas ───────────────────────────────────────────────────────────────
  AR: { state: 'AR', stateName: 'Arkansas', firstOffenseDuiSuspensionDays: 180, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'Ark. Code Ann. §§ 5-65-104, 5-65-118, 27-16-915', notes: 'Ark. Code Ann. Title 27 (Transportation) reviewed; no standalone drug conviction (non-DUI) license suspension provision found.', dataConfidence: 'medium', lastVerified: '2026-07' },
  ...
  // ── Colorado ───────────────────────────────────────────────────────────────
  CO: { state: 'CO', stateName: 'Colorado', firstOffenseDuiSuspensionDays: 270, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'Colo. Rev. Stat. §§ 42-2-126(3)(a), 42-2-132.5', notes: '9-month revocation. IID required for reinstatement and for early restricted license. Colo. Rev. Stat. Title 42 (Vehicles and Traffic) reviewed; no standalone drug conviction (non-DUI) license suspension provision found; Colorado did not adopt the federal 23 U.S.C. § 159 drug-conviction suspension mandate.', dataConfidence: 'medium', lastVerified: '2026-07' },

  // ── Connecticut ────────────────────────────────────────────────────────────
  CT: { state: 'CT', stateName: 'Connecticut', firstOffenseDuiSuspensionDays: 45, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'Conn. Gen. Stat. §§ 14-227b, 14-227c; Conn. Gen. Stat. § 14-111e', notes: '45-day hard suspension followed by IID period. Administrative hearing must be requested within 7 days. Conn. Gen. Stat. Title 14 (Motor Vehicles) reviewed; no standalone drug conviction (non-DUI) license suspension provision found.', dataConfidence: 'medium', lastVerified: '2026-07' },

  // ── Delaware ───────────────────────────────────────────────────────────────
  DE: { state: 'DE', stateName: 'Delaware', firstOffenseDuiSuspensionDays: 180, hardshipLicenseAvailable: false, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'Del. Code Ann. tit. 21 §§ 2742, 4177', notes: 'No hardship license for first DUI. IID required for reinstatement. Del. Code Ann. tit. 21 (Motor Vehicles) reviewed; no standalone drug conviction (non-DUI) license suspension provision found.', dataConfidence: 'medium', lastVerified: '2026-07' },

  // ── District of Columbia ───────────────────────────────────────────────────
  DC: { state: 'DC', stateName: 'District of Columbia', firstOffenseDuiSuspensionDays: 180, hardshipLicenseAvailable: false, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'D.C. Code §§ 50-2201.04a, 50-2201.05b', notes: 'D.C. Code Title 50 (Motor and Non-Motor Vehicles and Traffic) reviewed; no standalone drug conviction (non-DUI) license suspension provision found.', dataConfidence: 'medium', lastVerified: '2026-07' },
  ...
  // ── Georgia ────────────────────────────────────────────────────────────────
  GA: { state: 'GA', stateName: 'Georgia', firstOffenseDuiSuspensionDays: 365, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: true, source: 'O.C.G.A. §§ 40-5-63, 40-5-64, 40-6-391; O.C.G.A. § 40-5-75 (drug conviction)', notes: '1-year DUI suspension. Limited permit available after 120 days with IID. Admin hearing request required within 30 days of arrest. Drug conviction (controlled substance offense under O.C.G.A. Title 16 Ch. 13) triggers 1-year suspension under § 40-5-75.', dataConfidence: 'high', lastVerified: '2026-07' },

  // ── Hawaii ─────────────────────────────────────────────────────────────────
  HI: { state: 'HI', stateName: 'Hawaii', firstOffenseDuiSuspensionDays: 365, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'Haw. Rev. Stat. §§ 291E-41, 291E-44.5', notes: '1-year revocation. Conditional license with IID available after 30-day hard revocation. Haw. Rev. Stat. Title 17 (Motor and Other Vehicles) reviewed; no standalone drug conviction (non-DUI) license suspension provision found.', dataConfidence: 'medium', lastVerified: '2026-07' },

  // ── Idaho ──────────────────────────────────────────────────────────────────
  ID: { state: 'ID', stateName: 'Idaho', firstOffenseDuiSuspensionDays: 90, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'discretionary', adminSuspensionOnArrest: true, drugConvictionSuspension: true, source: 'Idaho Code §§ 18-8004, 18-8008, 49-335; Idaho Code § 18-8010 (drug conviction)', notes: 'Drug conviction under the Uniform Controlled Substances Act (Idaho Code Title 37, Ch. 27) or the Drug Paraphernalia Act (Title 37, Ch. 28) requires the court to direct suspension of the person\'s driving privileges under Idaho Code § 18-8010.', dataConfidence: 'high', lastVerified: '2026-07' },
  ...
  // ── Michigan ───────────────────────────────────────────────────────────────
  MI: { state: 'MI', stateName: 'Michigan', firstOffenseDuiSuspensionDays: 180, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'Mich. Comp. Laws §§ 257.303, 257.625k', notes: '180-day suspension. Restricted license with IID available for first 90 days. MCL § 257.319h (the former drug conviction license suspension provision) was repealed by 2016 PA 224; Michigan no longer suspends licenses for standalone drug convictions not involving driving.', dataConfidence: 'high', lastVerified: '2026-07' },

  // ── Minnesota ──────────────────────────────────────────────────────────────
  MN: { state: 'MN', stateName: 'Minnesota', firstOffenseDuiSuspensionDays: 90, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'Minn. Stat. §§ 169A.20, 169A.54, 171.306', notes: '90-day administrative revocation. Ignition interlock program allows driving during revocation period. Drug conviction revocation (formerly Minn. Stat. § 171.17(a)(10)) was REPEALED effective August 1, 2015 (Laws 2015, ch. 65, art. 4, § 8). Drug convictions no longer trigger automatic license revocation.', dataConfidence: 'high', lastVerified: '2026-07' },

  // ── Mississippi ────────────────────────────────────────────────────────────
  MS: { state: 'MS', stateName: 'Mississippi', firstOffenseDuiSuspensionDays: 90, hardshipLicenseAvailable: false, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'Miss. Code Ann. §§ 63-11-23, 63-11-30, 63-11-45', notes: 'No hardship license for first conviction. IID required as condition of reinstatement. Miss. Code Ann. Title 63 (Motor Vehicles and Traffic Regulations) reviewed; no standalone drug conviction (non-DUI) license suspension provision found.', dataConfidence: 'medium', lastVerified: '2026-07' },

  // ── Missouri ───────────────────────────────────────────────────────────────
  MO: { state: 'MO', stateName: 'Missouri', firstOffenseDuiSuspensionDays: 30, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'Mo. Rev. Stat. §§ 302.505, 302.525, 302.530', notes: '90-day admin suspension: 30-day hard then 60-day IID-restricted. Limited driving privilege available after 30 days. Mo. Rev. Stat. Ch. 302 (Drivers\' and Commercial Drivers\' Licenses) reviewed; no standalone drug conviction (non-DUI) license suspension provision found.', dataConfidence: 'medium', lastVerified: '2026-07' },

  // ── Montana ────────────────────────────────────────────────────────────────
  MT: { state: 'MT', stateName: 'Montana', firstOffenseDuiSuspensionDays: 180, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'discretionary', adminSuspensionOnArrest: false, drugConvictionSuspension: false, source: 'Mont. Code Ann. §§ 61-8-402, 61-8-442', notes: 'No pre-conviction administrative suspension. 6-month court-ordered suspension. Restricted license available. Mont. Code Ann. Title 61 (Motor Vehicles) reviewed; no standalone drug conviction (non-DUI) license suspension provision found.', dataConfidence: 'medium', lastVerified: '2026-07' },

  // ── Nebraska ───────────────────────────────────────────────────────────────
  NE: { state: 'NE', stateName: 'Nebraska', firstOffenseDuiSuspensionDays: 180, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'Neb. Rev. Stat. §§ 60-4,164, 60-6,197.04, 60-6,211.11', notes: '180-day revocation. Limited license with IID available after 30 days. Neb. Rev. Stat. Ch. 60 (Motor Vehicles) reviewed; no standalone drug conviction (non-DUI) license suspension provision found.', dataConfidence: 'medium', lastVerified: '2026-07' },

  // ── Nevada ─────────────────────────────────────────────────────────────────
  NV: { state: 'NV', stateName: 'Nevada', firstOffenseDuiSuspensionDays: 185, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'Nev. Rev. Stat. §§ 484C.210, 484C.460', notes: '185-day revocation. Restricted license with IID available. Nev. Rev. Stat. Title 43 (Public Safety; Vehicles) reviewed; no standalone drug conviction (non-DUI) license suspension provision found.', dataConfidence: 'medium', lastVerified: '2026-07' },

  // ── New Hampshire ──────────────────────────────────────────────────────────
  NH: { state: 'NH', stateName: 'New Hampshire', firstOffenseDuiSuspensionDays: 270, hardshipLicenseAvailable: false, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'N.H. Rev. Stat. Ann. §§ 265-A:14, 265-A:18, 265-A:36', notes: '9-month license loss. No occupational or hardship license available for first DUI. N.H. Rev. Stat. Ann. Title XXI (Motor Vehicles) reviewed; no standalone drug conviction (non-DUI) license suspension provision found.', dataConfidence: 'medium', lastVerified: '2026-07' },

  // ── New Jersey ─────────────────────────────────────────────────────────────
  NJ: { state: 'NJ', stateName: 'New Jersey', firstOffenseDuiSuspensionDays: null, hardshipLicenseAvailable: false, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: false, drugConvictionSuspension: true, source: 'N.J. Stat. Ann. §§ 39:4-50, 39:4-50.17; N.J. Stat. Ann. § 2C:35-16 (drug conviction)', notes: 'DUI suspension tied to BAC: 0.08–0.09% = 3 months; 0.10–0.14% = 7–12 months; ≥ 0.15% = IID required during and after. No hardship license. No pre-conviction administrative suspension. Drug conviction (controlled dangerous substance offense under N.J.S.A. 2C:35) triggers mandatory 6-month to 2-year license suspension under § 2C:35-16, separate from any DUI proceedings.', dataConfidence: 'high', lastVerified: '2026-07' },

  // ── New Mexico ─────────────────────────────────────────────────────────────
  NM: { state: 'NM', stateName: 'New Mexico', firstOffenseDuiSuspensionDays: 365, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'N.M. Stat. Ann. §§ 66-8-111, 66-8-111.1, 66-8-102', notes: '1-year revocation. Ignition interlock license available immediately. N.M. Stat. Ann. Ch. 66 (Motor Vehicles) reviewed; no standalone drug conviction (non-DUI) license suspension provision found.', dataConfidence: 'medium', lastVerified: '2026-07' },

  // ── New York ───────────────────────────────────────────────────────────────
  NY: { state: 'NY', stateName: 'New York', firstOffenseDuiSuspensionDays: 365, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'N.Y. Veh. & Traf. Law §§ 1193, 1194, 1198', notes: '1-year revocation for DWI. Hardship privilege available in limited circumstances. IID required for all DWI convictions. Drug conviction suspension (formerly N.Y. Veh. & Traf. Law § 510(2)(b)(v)) was REPEALED effective November 16, 2021 (Laws of 2021, ch. 769; S6579-A / A7244-A). Drug convictions no longer trigger automatic license suspension.', dataConfidence: 'high', lastVerified: '2026-07' },

  // ── North Carolina ─────────────────────────────────────────────────────────
  NC: { state: 'NC', stateName: 'North Carolina', firstOffenseDuiSuspensionDays: 365, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'discretionary', adminSuspensionOnArrest: true, drugConvictionSuspension: true, source: 'N.C. Gen. Stat. §§ 20-16.5, 20-17, 20-179.3; N.C. Gen. Stat. § 20-17.3 (drug conviction)', notes: '1-year DWI revocation. Limited driving privilege available after 30 days. IID required if BAC ≥ 0.15 or repeat offense. Drug conviction under Art. 5 of Chapter 90 (Controlled Substances Act) triggers mandatory 1-year license revocation under § 20-17.3; persons under 18 face mandatory revocation until age 21 or 1 year, whichever is longer.', dataConfidence: 'high', lastVerified: '2026-07' },

  // ── North Dakota ───────────────────────────────────────────────────────────
  ND: { state: 'ND', stateName: 'North Dakota', firstOffenseDuiSuspensionDays: 91, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'N.D. Cent. Code §§ 39-08-01, 39-20-04.1, 39-20-07', notes: '91-day suspension. IID required for restricted license. N.D. Cent. Code Title 39 (Motor Vehicles) reviewed; no standalone drug conviction (non-DUI) license suspension provision found.', dataConfidence: 'medium', lastVerified: '2026-07' },

  // ── Ohio ───────────────────────────────────────────────────────────────────
  OH: { state: 'OH', stateName: 'Ohio', firstOffenseDuiSuspensionDays: 180, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'discretionary', adminSuspensionOnArrest: false, drugConvictionSuspension: false, source: 'Ohio Rev. Code Ann. §§ 4511.19, 4511.191, 4510.17', notes: 'ALS triggered by test result (not arrest), 90 days; refusal = 1 year. OVI criminal suspension 6 months to 3 years. Court may impose IID as a condition of limited driving privileges. Ohio Rev. Code Ann. Title XLV (Motor Vehicles — Chapters 4501–4513) reviewed; no standalone drug conviction (non-DUI) license suspension provision found.', dataConfidence: 'medium', lastVerified: '2026-07' },

  // ── Oklahoma ───────────────────────────────────────────────────────────────
  OK: { state: 'OK', stateName: 'Oklahoma', firstOffenseDuiSuspensionDays: 180, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'Okla. Stat. tit. 47 §§ 753, 754, 6-205.1', notes: 'Okla. Stat. tit. 47 (Motor Vehicles) §§ 6-205 and 6-205.1 reviewed; mandatory revocation grounds are DUI/DWI, manslaughter, and like offenses — no standalone drug conviction (non-DUI) license revocation provision found.', dataConfidence: 'medium', lastVerified: '2026-07' },

  // ── Oregon ─────────────────────────────────────────────────────────────────
  OR: { state: 'OR', stateName: 'Oregon', firstOffenseDuiSuspensionDays: 365, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'O.R.S. §§ 813.010, 813.410, 813.600', notes: '1-year implied consent suspension (3 years for refusal). DUII hardship permit with IID available after 30 days. Drug conviction license suspension (formerly required under O.R.S. § 809.235) was REPEALED effective January 1, 2016 (Or. Laws 2015, ch. 614, HB 2355). Drug convictions no longer trigger automatic license suspension.', dataConfidence: 'high', lastVerified: '2026-07' },

  // ── Pennsylvania ───────────────────────────────────────────────────────────
  PA: { state: 'PA', stateName: 'Pennsylvania', firstOffenseDuiSuspensionDays: null, hardshipLicenseAvailable: false, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: false, drugConvictionSuspension: true, source: '75 Pa. C.S. §§ 3802, 3804, 1547; 75 Pa. C.S. § 1532(b) (drug conviction)', notes: 'DUI suspension depends on BAC tier: General Impairment (0.08–0.099%) = no suspension for first offense. High BAC (0.10–0.159%) = 12 months. Highest BAC (≥ 0.16%) or refusal = 12 months. No hardship license for DUI in PA. Drug felony conviction under The Controlled Substance, Drug, Device and Cosmetic Act (35 P.S. § 780-113) triggers mandatory 6-month to 2-year license suspension under 75 Pa. C.S. § 1532(b)(1); misdemeanor violations of § 13(a)(31) or (32) also trigger suspension.', dataConfidence: 'high', lastVerified: '2026-07' },

  // ── Rhode Island ───────────────────────────────────────────────────────────
  RI: { state: 'RI', stateName: 'Rhode Island', firstOffenseDuiSuspensionDays: 90, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'discretionary', adminSuspensionOnArrest: true, drugConvictionSuspension: true, source: 'R.I. Gen. Laws §§ 31-27-2, 31-27-2.8; R.I. Gen. Laws § 31-27-2.4 (drug conviction)', notes: 'Drug conviction under R.I. Gen. Laws Title 21 (Food and Drugs) triggers mandatory 6-month to 1-year license suspension under § 31-27-2.4; for persons under 18 the suspension runs until age 18 or 6 months, whichever is longer.', dataConfidence: 'high', lastVerified: '2026-07' },

  // ── South Carolina ─────────────────────────────────────────────────────────
  SC: { state: 'SC', stateName: 'South Carolina', firstOffenseDuiSuspensionDays: 180, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'S.C. Code Ann. §§ 56-5-2990, 56-5-2941', notes: '6-month suspension. Restricted license with IID available from day 1 of suspension. S.C. Code Ann. Title 56 (Motor Vehicles) reviewed; S.C. Code § 56-1-286 covers DUI involving drugs but does not create a standalone drug conviction (non-DUI) license suspension; no such provision found.', dataConfidence: 'medium', lastVerified: '2026-07' },

  // ── South Dakota ───────────────────────────────────────────────────────────
  SD: { state: 'SD', stateName: 'South Dakota', firstOffenseDuiSuspensionDays: 30, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'discretionary', adminSuspensionOnArrest: false, drugConvictionSuspension: false, source: 'S.D. Codified Laws §§ 32-23-10, 32-23-11', notes: 'No pre-conviction administrative suspension. 30-day court suspension; occupational permit available. S.D. Codified Laws Title 32 (Motor Vehicles) reviewed; no standalone drug conviction (non-DUI) license suspension provision found.', dataConfidence: 'medium', lastVerified: '2026-07' },

  // ── Tennessee ──────────────────────────────────────────────────────────────
  TN: { state: 'TN', stateName: 'Tennessee', firstOffenseDuiSuspensionDays: 365, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: false, drugConvictionSuspension: true, source: 'Tenn. Code Ann. §§ 55-10-401, 55-10-411, 55-10-417; Tenn. Code Ann. § 55-50-503 (drug conviction)', notes: 'No pre-conviction administrative suspension. 1-year DUI court revocation. Restricted license with IID available. Drug conviction under the Tennessee Drug Control Act (Tenn. Code Ann. § 39-17-401 et seq.) triggers mandatory license revocation under § 55-50-503; revocation period depends on offense class.', dataConfidence: 'high', lastVerified: '2026-07' },
  ...
  // ── Utah ───────────────────────────────────────────────────────────────────
  UT: { state: 'UT', stateName: 'Utah', firstOffenseDuiSuspensionDays: 120, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'Utah Code Ann. §§ 41-6a-502, 41-6a-515.5, 53-3-223', notes: '120-day suspension. IID required for reinstatement. Utah Code Ann. Title 53 (Public Safety Code) and Title 41 (Motor Vehicles) reviewed; no standalone drug conviction (non-DUI) license suspension provision found.', dataConfidence: 'medium', lastVerified: '2026-07' },

  // ── Vermont ────────────────────────────────────────────────────────────────
  VT: { state: 'VT', stateName: 'Vermont', firstOffenseDuiSuspensionDays: 90, hardshipLicenseAvailable: false, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'Vt. Stat. Ann. tit. 23 §§ 1205, 1208, 1213', notes: 'No hardship license for first DUI. IID required upon reinstatement. Vt. Stat. Ann. tit. 23 (Motor Vehicles) reviewed; no standalone drug conviction (non-DUI) license suspension provision found.', dataConfidence: 'medium', lastVerified: '2026-07' },

  // ── Virginia ───────────────────────────────────────────────────────────────
  VA: { state: 'VA', stateName: 'Virginia', firstOffenseDuiSuspensionDays: 365, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: false, drugConvictionSuspension: false, source: 'Va. Code Ann. §§ 18.2-270, 46.2-391, 18.2-272', notes: '7-day administrative license suspension at arrest. Criminal conviction: 12-month revocation. Restricted license with IID available immediately from day 1 of revocation. Drug conviction suspension (formerly Va. Code Ann. § 18.2-259.1) was REPEALED effective July 1, 2021 (2021 Va. Acts ch. 551, HB 1842 / SB 1133). Drug convictions no longer trigger automatic license suspension.', dataConfidence: 'high', lastVerified: '2026-07' },

  // ── Washington ─────────────────────────────────────────────────────────────
  WA: { state: 'WA', stateName: 'Washington', firstOffenseDuiSuspensionDays: 90, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'Wash. Rev. Code §§ 46.20.308, 46.20.3101, 46.61.502', notes: '90-day DOL suspension (test) or 1 year (refusal). Ignition interlock license available during suspension. RCW Title 46 (Motor Vehicles) reviewed; drug conviction license suspension (formerly RCW 46.20.285) was REPEALED by 2011 Wash. Laws ch. 96, § 40. Drug convictions no longer trigger automatic license suspension.', dataConfidence: 'high', lastVerified: '2026-07' },

  // ── West Virginia ──────────────────────────────────────────────────────────
  WV: { state: 'WV', stateName: 'West Virginia', firstOffenseDuiSuspensionDays: 180, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'W. Va. Code §§ 17C-5-2, 17C-5A-1, 17C-5A-3a', notes: 'W. Va. Code Title 17C (Motor Vehicle Safety) reviewed; no standalone drug conviction (non-DUI) license suspension provision found.', dataConfidence: 'medium', lastVerified: '2026-07' },

  // ── Wisconsin ──────────────────────────────────────────────────────────────
  WI: { state: 'WI', stateName: 'Wisconsin', firstOffenseDuiSuspensionDays: 270, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'required', adminSuspensionOnArrest: false, drugConvictionSuspension: false, source: 'Wis. Stat. §§ 343.305, 343.30, 343.10', notes: '9-month revocation for first OWI. First OWI is a civil forfeiture (not criminal); no admin suspension. IID required for reinstatement. Wis. Stat. Ch. 343 (Operators\' Licenses) reviewed; no standalone drug conviction (non-DUI) license suspension provision found.', dataConfidence: 'medium', lastVerified: '2026-07' },

  // ── Wyoming ────────────────────────────────────────────────────────────────
  WY: { state: 'WY', stateName: 'Wyoming', firstOffenseDuiSuspensionDays: 90, hardshipLicenseAvailable: true, ignitionInterlockRequired: 'discretionary', adminSuspensionOnArrest: true, drugConvictionSuspension: false, source: 'Wyo. Stat. Ann. §§ 31-6-102, 31-6-107, 31-7-128', notes: 'Wyo. Stat. Ann. Title 31 (Motor Vehicles) reviewed; no standalone drug conviction (non-DUI) license suspension provision found.', dataConfidence: 'medium', lastVerified: '2026-07' },
