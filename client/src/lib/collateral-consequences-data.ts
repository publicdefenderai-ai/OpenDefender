...
export const COLLATERAL_CONSEQUENCE_RULES: Record<string, CollateralConsequenceRule> = {
  ...
  AL: {
    ...
    benefits: {
      ...
      snapDetails: 'Ban applies during probation/parole; restored after supervision completed.',
      tanfDrugFelonyBan: 'modified',
      tanfDetails: 'Ban applies during probation/parole.',
    },
    housing: {
  ...
  DE: {
    ...
    benefits: {
      snapDrugFelonyBan: 'no_ban',
      snapDetails: 'Delaware fully opted out.',
      tanfDrugFelonyBan: 'no_ban',
      tanfDetails: 'Delaware fully opted out.',
    },
    housing: {
      fairChanceHousingLaw: false,
    },
  ...
  ID: {
    ...
    benefits: {
      snapDrugFelonyBan: 'no_ban',
      snapDetails: 'Idaho fully opted out of the SNAP drug felony ban.',
      tanfDrugFelonyBan: 'modified',
      tanfDetails: 'TANF: drug testing and treatment requirements apply; eligibility may be conditional.',
    },
    housing: {
      fairChanceHousingLaw: false,
    },
  ...
  MS: {
    ...
    benefits: {
      snapDrugFelonyBan: 'modified',
      snapDetails: 'Mississippi modified the SNAP ban; applies only during active supervision.',
  ...
  MO: {
    ...
    voting: {
      ...
      notes: 'Rights restored automatically upon completing all supervision (prison, parole, and probation).',
    },
    employment: {
      banTheBoxScope: 'public_only',
      banTheBoxSource: 'Mo. Executive Order 16-04 (2016)',
      licensingNexusReform: true,
      licensingNexusSource: 'Mo. Rev. Stat. § 324.011 (SB 262, 2021) — nexus required for license denial',
    },
    benefits: {
      snapDrugFelonyBan: 'no_ban',
      snapDetails: 'Missouri fully opted out of the SNAP drug felony ban.',
      tanfDrugFelonyBan: 'modified',
      tanfDetails: 'TANF: drug testing requirements apply; eligibility conditional on testing negative.',
    },
    housing: {
      fairChanceHousingLaw: false,
    },
  ...
  NC: {
    ...
    voting: {
      ...
      notes: 'NC Supreme Court ruled in 2022 that the law disenfranchising people on probation/parole was unconstitutional. Rights are now restored upon release from active incarceration. Parolees and probationers can vote.',
    },
    employment: {
      banTheBoxScope: 'public_only',
  ...
  ND: {
    ...
    voting: {
      ...
      notes: 'Rights restored upon completing all supervision. Automatic; no application required.',
    },
    employment: {
      banTheBoxScope: 'none',
      licensingNexusReform: true,
  ...
  SC: {
    ...
    benefits: {
      snapDrugFelonyBan: 'modified',
      snapDetails: 'Ban applies during active supervision; lifted after completion.',
      tanfDrugFelonyBan: 'modified',
      tanfDetails: 'TANF: drug testing requirements apply.',
    },
    housing: {
  ...
  VA: {
    ...
    employment: {
      banTheBoxScope: 'public_only',
      banTheBoxSource: 'Va. Code Ann. § 2.2-2831 (Executive Order 41, 2015; codified 2020)',
      licensingNexusReform: true,
      licensingNexusSource: 'Va. Code Ann. § 54.1-204 (SB 1127, 2021)',
    },
    benefits: {
      snapDrugFelonyBan: 'no_ban',
      snapDetails: 'Virginia fully opted out.',
      tanfDrugFelonyBan: 'no_ban',
      tanfDetails: 'Virginia fully opted out.',
    },
    housing: {
      fairChanceHousingLaw: true,
