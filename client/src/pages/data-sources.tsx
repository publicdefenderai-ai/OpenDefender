              ...
              <CardContent className="p-6 space-y-4">
                ...
                <div>
                  ...
                  <div className="space-y-3 text-sm text-muted-foreground">
                    ...
                    <div className="border border-border rounded-lg p-4">
                      <p className="font-semibold text-foreground mb-1">State-specific: 20 additional charges (16 states so far)</p>
                      <p>
                        ...
                        Michigan, Washington, Massachusetts, and Tennessee. Expanding this coverage to the
                        remaining 36 jurisdictions is ongoing.
                      </p>
                    </div>
                    <div className="border border-border rounded-lg p-4">
