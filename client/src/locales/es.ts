export default {
  ...
  "home": {
    ...
    "urgentHelp": {
      ...
      "stayCalmText": "La resistencia física, incluso a un arresto ilegal, puede ponerle en peligro físico y resultar en cargos adicionales. Mantener las manos visibles y permanecer calmado durante el encuentro es más seguro y preserva opciones para un desafío legal posterior.",
      ...
      "noConsentTitle": "3. Negarse a un Registro",
      "noConsentText": "Negarse claramente a un registro preserva ciertos derechos y protecciones, incluso si la policía realiza el registro de todos modos.",
      "publicDefenderTitle": "4. Abogado Designado por el Tribunal",
      "publicDefenderText": "Las personas que no pueden pagar un abogado tienen el derecho constitucional a uno sin costo. Este derecho se ejerce típicamente informando al tribunal en la primera comparecencia. El juez entonces organiza el nombramiento antes de que pueda proceder cualquier interrogatorio.",
    ...
    "dataSources": {
      ...
      "transparency": {
        ...
        "heading": "Fuentes de datos y metodología",
        "intro": "Un inventario fácil de consultar del contenido legal, práctico y de recursos públicos usado por OpenDefender. Los conteos provienen de los registros mantenidos; un enlace o registro no equivale a verificación legal.",
        "reviewed": "Inventario revisado en agosto de 2026",
        "disclaimer": "Información educativa, no asesoría legal.",
        "limitationsHeading": "Lea esto antes de confiar en un resultado",
        "limitationsIntro": "La cobertura y la confianza varían según el conjunto de datos y el registro. Las etiquetas describen la evidencia, no prometen que una respuesta sea correcta para cada persona o tribunal.",
        "limitations": [
          "Algunos registros y explicaciones de cargos son sintetizados o generales, no estatutos actuales reproducidos literalmente.",
          "Los procedimientos combinan reglas de alta confianza con cinco registros territoriales de confianza media; algunos campos de audiencia preliminar y descubrimiento siguen siendo estimaciones.",
          "Los enlaces de desvío, ayuda legal, detención, consulados y tribunales pueden cambiar. Revisar un enlace no confirma elegibilidad, horarios, admisión ni que un programa siga operando.",
          "Algunas fuentes son de pago, no están disponibles, son locales o dependen de un proveedor externo. Confirme los detalles importantes con una fuente oficial actual y un abogado."
        ],
        "legendHeading": "Cómo leer la confianza",
        "legendIntro": "Estas etiquetas sencillas se asignan al nivel del conjunto de datos. Mixta significa que contiene más de un estándar de evidencia.",
        "skipToInventory": "Ir al inventario de temas",
        "inventoryHeading": "Inventario de temas",
        "inventoryIntro": "Use los enlaces para saltar directamente a un conjunto de datos. Cada tarjeta muestra el conteo mantenido, la fecha más defendible, la ruta de la fuente y una limitación visible.",
        "topicNavigation": "Navegación de temas de fuentes",
        "additionalInformation": "Información adicional de transparencia",
        "showEvidence": "Mostrar notas de evidencia",
        "hideEvidence": "Ocultar notas de evidencia",
        "openSource": "Abrir ruta de la fuente",
        "opensNewTab": "se abre en una pestaña nueva",
        "outOfScopeHeading": "Lo que esta página no afirma",
        "outOfScopeIntro": "El inventario no promete cobertura completa o actual en todos los lugares.",
        "outOfScope": [
          "Cada regla de un tribunal local, ordenanza municipal o práctica del condado.",
          "Elegibilidad, fondos, admisión o disponibilidad en vivo de un recurso o programa.",
          "Revisión por un abogado, exactitud legal garantizada o sustitución de asesoría legal.",
          "Jurisprudencia en tiempo real, resultados previos al juicio o análisis BJS en vivo."
        ],
        "reportHeading": "¿Encontró un problema en una fuente o dato?",
        "reportBody": "Indique la jurisdicción, el tema, el registro o enlace y la corrección propuesta. Usamos los avisos para priorizar revisiones; un aviso no cambia un registro hasta confirmarlo.",
        "nySources": {
          "eyebrow": "Fuentes de cargos de Nueva York",
          "title": "Cómo se verifican las fuentes de los cargos de Nueva York",
          "intro": "Los registros de cargos de Nueva York usan un proceso de procedencia específico para que pueda ver qué fuente oficial se comprobó, qué publicará la base de datos y por qué una entrada puede quedar retenida.",
          "authorityTitle": "Autoridad oficial",
          "authorityBody": "Para los registros del Penal Law de Nueva York, la base de datos de fuentes usa únicamente la API Open Legislation del Senado del Estado de Nueva York. Cada consulta registra los identificadores estructurados de la ley y la sección, el título oficial, el texto completo de la sección, la fecha de vigencia, el historial de publicación y un hash de contenido SHA-256. El enlace de cita oficial abre la página de la ley del Senado en formato legible.",
          "failClosedTitle": "Por qué un cargo puede no estar disponible",
          "failClosedBody": "El importador falla de forma cerrada: si la API no devuelve un título oficial y el texto completo de la sección, o las disposiciones requeridas no corresponden exactamente al cargo, el registro queda retenido. Los registros retenidos no aparecen en la selección de cargos de Nueva York ni reciben orientación específica o exportaciones. Una actualización fallida o un cambio en la fuente no se publica como autoridad vigente; el cargo afectado se retira de la selección y su enlace de procedencia actual se desactiva hasta que se restaure la fuente exacta o el cambio sea revisado y promovido. Si no existe un manifiesto completado, se niega la disponibilidad de Nueva York.",
          "catalogTitle": "Alias y registros locales",
          "catalogBody": "Solo se permite un alias o cambio de nombre exacto cuando se confirma la sección de la API; las búsquedas actuales usan el título oficial. Las discrepancias materiales y los marcadores quedan retenidos. Los registros del código administrativo de la ciudad de Nueva York son solo de referencia porque están fuera de la API del Senado estatal y no tienen texto de fuente almacenado.",
          "reviewTitle": "La verificación de la API no es aprobación de un abogado",
          "reviewBody": "La verificación de la API confirma la identidad de la fuente, el texto devuelto, las fechas y el hash de contenido. No significa que un abogado haya aprobado los elementos, el estado mental, la clasificación, las penas o la interpretación de vigencia. Esos campos legales permanecen marcados como revisión por abogado pendiente hasta que los revise un profesional.",
          "linksTitle": "Consulte las divulgaciones subyacentes",
          "linksIntro": "Compare esta explicación con el inventario de fuentes mantenido, la divulgación de enlaces de estatutos, las divulgaciones de datos legales y las páginas oficiales del Senado.",
          "apiLink": "API Open Legislation del Senado de Nueva York",
        ...
        "paSources": {
          "eyebrow": "Fuentes de cargos de Pensilvania",
          "title": "Cómo se verifican las fuentes de los cargos de Pensilvania",
          "intro": "Los registros de cargos de Pensilvania usan las páginas oficiales de los Estatutos Consolidados de la Asamblea General de Pensilvania. El manifiesto conserva las 112 filas del catálogo, pero solo publica registros con respaldo legal completo y exacto.",
          "authorityTitle": "Autoridad oficial",
          "authorityBody": "El importador obtiene los Estatutos Consolidados de Pensilvania desde legis.state.pa.us, sigue el marco de estatutos del sitio cuando es necesario, verifica el título y la sección, guarda el texto completo, registra la obtención y la evidencia de vigencia y calcula un hash SHA-256.",
          "failClosedTitle": "Por qué un cargo puede no estar disponible",
          "failClosedBody": "Si la página oficial no está disponible, falta la sección o el título, un cargo compuesto está incompleto, la cita es federal o no consolidada, o la correspondencia del catálogo es sustancialmente distinta, la fila queda retenida. Las filas retenidas de Pensilvania no aparecen en selección, orientación, búsqueda ni exportaciones.",
          "catalogTitle": "Texto legal y materiales complementarios",
          "catalogBody": "Los materiales de la Comisión de Sentencias de Pensilvania pueden complementar la clasificación o las penas, pero no pueden sustituir el texto oficial del delito. El importador nunca infiere un reemplazo de una sección cercana.",
          "reviewTitle": "La verificación de una fuente no equivale a la aprobación de un abogado",
          "reviewBody": "La verificación confirma el editor oficial, la sección, el título, el texto, los metadatos y el hash. No significa que un abogado haya aprobado los elementos, el estado mental, la clasificación, las penas o la vigencia; esos campos siguen pendientes de revisión legal.",
          "linksTitle": "Revise las divulgaciones subyacentes",
          "linksIntro": "Compare esta explicación con el inventario de fuentes, la divulgación de enlaces legales, las divulgaciones de datos legales y los estatutos oficiales de la Asamblea General de Pensilvania.",
          "officialLink": "Ejemplo de sección oficial de Pensilvania",
          "inventoryLink": "Inventario de fuentes de cargos",
          "statuteLink": "Divulgación de enlaces de estatutos",
          "disclaimerLink": "Divulgaciones generales de datos legales",
          "chargeLookupTitle": "Consulte la procedencia actual de un cargo",
        ...
        "sourceTypes": {
          ...
          "secondaryResearch": "Investigación secundaria",
          "synthesizedResearch": "Contenido educativo sintetizado",
          "publicDirectory": "Directorio o recurso público",
          "externalProvider": "Proveedor externo",
          "mixedResearch": "Investigación legal mixta"
        },
        "confidence": {
          "primary": "Revisada en fuente primaria",
          "secondary": "Revisada en fuente secundaria",
          "synthesized": "Sintetizada / general",
          "availability": "Comprobación de enlace / disponibilidad",
          "conditional": "Comprobación condicional del proveedor",
          "mixed": "Evidencia mixta"
        },
        "confidenceDescription": {
          "primary": "Se revisó el texto legal o gubernamental primario específico de los registros indicados.",
          "secondary": "Investigaciones públicas o directorios especializados respaldan los registros; no es una opinión legal.",
          "synthesized": "Contenido educativo o editorial reunido de fuentes generales; no lo cite como estatuto.",
          "availability": "Se revisó un enlace, contacto o registro. Esto no prueba elegibilidad ni operación actual.",
          "conditional": "Un proveedor puede validar una consulta si está disponible; el resultado depende del proveedor, los datos y el servicio.",
          "mixed": "Distintas partes usan distintos niveles de evidencia; lea la limitación y la nota de evidencia."
        },
        "coverage": {
          ...
          "legalAid": "{{count}} registros (organizaciones / etiquetas jurisdiccionales).",
          "glossary": "{{count}} términos del glosario.",
          "courtServices": "{{count}} entradas de sistemas judiciales.",
          "statuteLinks": "{{count}} configuraciones de URL jurisdiccionales.",
          "detention": "{{count}} registros (instalaciones / estados).",
          "consulates": "{{count}} registros de contacto por país.",
          "publicResources": "Enlaces de recursos públicos usados por páginas de apoyo; no se afirma que sean completos.",
          "juryInstructions": "Series y referencias seleccionadas; no todos los cargos o jurisdicciones.",
          "validation": "Se documentan tres servicios externos de validación o consulta.",
          "statistics": "Publicaciones estadísticas nombradas; no hay un canal BJS en vivo activo.",
          "ai": "Se documenta un proveedor externo de IA."
        },
        "items": {
          "federalStatutes": { "title": "Estatutos federales", "summary": "Un conjunto inicial pequeño de entradas federales para referencias de derecho federal.", "freshness": "Índice revisado en julio de 2026; compruebe el código actual.", "limitation": "No es todo el Código de EE.UU.; un enlace activo no demuestra que una disposición aplique.", "evidence": "Las entradas citan texto del Cornell Legal Information Institute. Es una ruta a texto primario, no aprobación de un abogado." },
          "charges": { "title": "Cargos penales", "summary": "El catálogo organiza nombres de delitos, clasificaciones y citas en estados, territorios, D.C. y jurisdicción federal.", "freshness": "El conteo se lee del registro de cargos mantenido.", "limitation": "El catálogo es seleccionado y parcialmente sintetizado. Algunos códigos son marcadores internos; verifique cada cita en el código oficial actual.", "evidence": "El registro contiene 7.155 entradas: 3.772 delitos graves, 3.322 delitos menores y 61 infracciones en 57 códigos jurisdiccionales." },
          "explanations": { "title": "Explicaciones de cargos", "summary": "Explicaciones sencillas relacionan patrones de cargos con términos, grados y detalles jurisdiccionales.", "freshness": "Los campos de fuentes y capas se leen de los registros mantenidos.", "limitation": "Solo 49 de 60 explicaciones base tienen una fuente registrada. La cobertura de capas varía; las demás son generales.", "evidence": "Hay 60 explicaciones base y 2.818 registros de capas jurisdiccionales. Una fuente registrada aún requiere revisar la ley actual." },
          "procedure": { "title": "Reglas de procedimiento y plazos", "summary": "Reglas de lectura de cargos, fianza, juicio rápido, llamadas y ciertos plazos previos al juicio alimentan la cronología.", "freshness": "El índice indica que la revisión jurisdiccional fue revalidada en julio de 2026.", "limitation": "Hay 57 entradas: 52 de alta confianza y cinco territoriales de confianza media. Algunos campos de audiencia preliminar y descubrimiento son estimaciones.", "evidence": "Las reglas separan la confianza del registro de los campos estimados. Las estimaciones no son garantías y pueden regir órdenes locales." },
          "collateral": { "title": "Consecuencias colaterales", "summary": "Información estatal sobre voto, empleo, beneficios, vivienda, licencias, inmigración, registros y plazos.", "freshness": "La mayoría de los registros están fechados en marzo de 2026; revise la ley actual.", "limitation": "Las consecuencias dependen del delito, la sentencia, supervisión, agencias y hechos no representados aquí.", "evidence": "Los registros mantenidos cubren 51 claves jurisdiccionales en varias familias, con confianza mixta." },
          "rights": { "title": "Derechos constitucionales", "summary": "Resúmenes educativos generales sobre silencio, abogado, registros y juicio rápido.", "freshness": "Contenido editorial estático; no se afirma vigencia universal.", "limitation": "Los resúmenes amplios tienen excepciones y procedimientos estatales. No son una base completa de derecho constitucional.", "evidence": "Se enlazan materiales constitucionales públicos; confirme la regla en la jurisdicción aplicable." },
          "expungement": { "title": "Eliminación y alivio de antecedentes", "summary": "Resúmenes jurisdiccionales distinguen eliminación, sellado, anulación y otras formas de alivio.", "freshness": "Cada entrada tiene su fecha; los registros antiguos necesitan revisión.", "limitation": "Cambian elegibilidad, tarifas, plazos y formularios. Una regla listada no determina elegibilidad.", "evidence": "El registro mantenido tiene 52 jurisdicciones y conserva citas y fechas cuando están disponibles." },
          "diversion": { "title": "Programas de desvío", "summary": "Directorio de programas estatales y locales de desvío o tribunales especializados.", "freshness": "El encabezado indica abril de 2026; algunos registros pueden ser anteriores.", "limitation": "Los 111 registros no son un directorio completo. Revisar URL no confirma elegibilidad, fondos, admisión, horarios ni operación.", "evidence": "110 registros están marcados como activos. Las fuentes incluyen NADCP, NDAA, tribunales, fiscales y agencias públicas." },
          "legalAid": { "title": "Organizaciones de ayuda legal", "summary": "Registros iniciales de defensores públicos, inmigración, ayuda civil y defensores federales.", "freshness": "El encabezado indica última actualización en marzo de 2026; contacte a la organización.", "limitation": "Un registro o enlace activo no significa que acepte el caso, atienda a la persona o tenga capacidad.", "evidence": "El registro tiene 198 organizaciones en 55 etiquetas jurisdiccionales y usa fuentes EOIR, LSC y defensorías." },
          "glossary": { "title": "Glosario legal", "summary": "Definiciones en lenguaje sencillo de términos usados en el producto.", "freshness": "El conteo y los términos se leen del glosario mantenido.", "limitation": "Son resúmenes educativos y pueden omitir significados o excepciones jurisdiccionales.", "evidence": "El glosario contiene 50 términos con enlaces opcionales y fechas por término." },
          "courtServices": { "title": "Servicios judiciales y enlaces", "summary": "Sitios y localizadores oficiales ayudan a encontrar información judicial local.", "freshness": "El mapa judicial figura verificado en enero de 2025; los enlaces pueden cambiar.", "limitation": "Una página o localizador no es una base de reglas locales ni confirma un plazo o servicio.", "evidence": "El registro tiene 52 sistemas judiciales. Confirme reglas y trámites con el tribunal." },
          "statuteLinks": { "title": "Configuraciones de enlaces de estatutos", "summary": "Rutas y generación de URL por jurisdicción para encontrar texto legal público.", "freshness": "Los enlaces se revisan con scripts; compruebe la página actual.", "limitation": "Una URL que responde solo indica disponibilidad. Redirecciones o espejos pueden no ser oficiales o actuales.", "evidence": "La configuración cubre 52 claves jurisdiccionales y registra rutas oficiales o secundarias según el lugar." },
          "detention": { "title": "Instalaciones de detención", "summary": "Información pública de contacto e instalaciones para búsquedas de recursos de detención.", "freshness": "Los directorios cambian sin aviso; llame a la instalación o agencia.", "limitation": "Una instalación listada no prueba dónde está detenida una persona ni que visitas o teléfonos funcionen.", "evidence": "El registro lista 29 instalaciones en 13 estados y usa investigación pública relacionada con ICE." },
          "consulates": { "title": "Contactos consulares", "summary": "Contactos consulares por país para preparación familiar y recursos de emergencia.", "freshness": "Los datos cambian; use la fuente oficial del país antes de llamar.", "limitation": "Un contacto no promete respuesta, representación legal o asistencia en un caso concreto.", "evidence": "El registro tiene 20 países con sitio web y contacto consular principal." },
          "publicResources": { "title": "Otros recursos públicos", "summary": "Enlaces nacionales como 211, HUD, EEOC, reinserción y apoyo comunitario.", "freshness": "Los enlaces se revisan periódicamente, no continuamente.", "limitation": "Es una selección, no un directorio completo; geografía, elegibilidad y disponibilidad varían.", "evidence": "El índice interno identifica organizaciones y usos. Revisar enlaces no verifica calidad o elegibilidad." },
          "juryInstructions": { "title": "Referencias de instrucciones al jurado", "summary": "Series, números y rutas públicas seleccionadas asociadas con registros de cargos.", "freshness": "La cobertura es selectiva; confirme con el tribunal emisor.", "limitation": "Algunas series son de pago y no todos los cargos o jurisdicciones tienen referencia.", "evidence": "La capa contiene referencias seleccionadas; un número no prueba que el texto actual sea igual." },
          "validation": { "title": "Servicios externos de validación", "summary": "Consultas opcionales apoyan verificaciones de citas, casos, estatutos y ordenanzas municipales.", "freshness": "La disponibilidad y respuesta del proveedor cambia al consultar.", "limitation": "La validación condicional no garantiza exactitud legal. Cobertura, autenticación, límites y consulta afectan el resultado.", "evidence": "Se documentan CourtListener, OpenLaws y LOCUS-v1. LOCUS solo complementa cargos de ordenanzas locales." },
          "statistics": { "title": "Estadísticas citadas en el contenido", "summary": "Referencias estadísticas públicas usadas en contenido educativo y de apoyo, separadas de las bases de reglas legales.", "freshness": "Las estadísticas pueden envejecer aunque la publicación siga disponible; importa la edición citada.", "limitation": "Los análisis BJS y las API de estadísticas delictivas en vivo no son fuentes activas del producto. Las cifras históricas no predicen un caso individual.", "evidence": "Las referencias incluyen el Sourcebook FY 2024 de la U.S. Sentencing Commission y estudios BJS sobre acusados de delitos graves y detención previa al juicio; revise el alcance y fecha de cada publicación." },
          "ai": { "title": "Proveedor de orientación de IA", "summary": "Divulgación del proveedor externo usado para orientación, resúmenes y documentos.", "freshness": "Los detalles del proveedor pueden cambiar; revise la divulgación actual.", "limitation": "La IA puede estar incompleta, estimada, mal traducida o equivocada. No es abogado ni asesoría legal.", "evidence": "Proveedor: Anthropic Claude Sonnet 4 (claude-sonnet-4-6) por API. Antes de procesar, OpenDefender intenta ocultar identificadores comunes como nombres, teléfonos, direcciones y números de Seguro Social, pero puede omitir datos. Los prompts de la API no se usan para entrenar modelos; Anthropic puede conservar datos de la API hasta 30 días bajo sus términos estándar. OpenDefender conserva temporalmente casos y comentarios en la memoria del servidor, normalmente hasta 24 horas o un reinicio. No existe privilegio abogado-cliente." }
        }
      }
    },
  ...
  "support": {
    ...
    "reputation": {
      ...
      "rapSheet": {
        "sectionTitle": "Revise su Historial Penal en Busca de Errores",
        "sectionSubtitle": "Investigaciones han encontrado que más de 6 de cada 10 historiales penales estatales oficiales contienen al menos un error significativo. Estos errores pueden inflar los montos de fianza, afectar las ofertas de acuerdos y causar negaciones injustas de vivienda y empleo. Puede solicitar sus registros y revisarlos sistemáticamente.",
        "step1Title": "Paso 1: Solicite sus registros",
        "step1Intro": "Necesita dos registros: su historial federal del FBI y su historial penal estatal.",
        "fbiTitle": "Resumen de Historia de Identidad del FBI (registro federal)",
        "fbiBody": "Solicítelo en línea en IdentityHistory.fbi.gov. La solicitud es gratuita. Recibirá una copia de cada arresto y disposición federal en los registros del FBI para sus huellas dactilares. El procesamiento típicamente toma algunas semanas.",
        "stateTitle": "Historial penal estatal",
        "stateBody": "Contacte la división de registros de la policía estatal o el administrador de tribunales en el estado donde ha sido arrestado o condenado. Las tarifas típicamente oscilan entre $10 y $30. Busque el nombre de su estado más 'solicitud de historial penal' para encontrar la agencia correcta.",
        "step2Title": "Paso 2: Verifique los tres errores más comunes",
        "step2Intro": "Para cada entrada en su registro, busque estos problemas específicos.",
        "error1Title": "Disposiciones faltantes",
        "error1Body": "Una disposición es el resultado de un caso: condenado, desestimado, derivado, absuelto o no presentado. La investigación muestra que menos de la mitad de todos los registros de arresto contienen una disposición registrada. Sin una, el arresto parece sin resolver incluso si los cargos fueron descartados o usted fue encontrado no culpable. Busque cada entrada de arresto que no tenga un resultado correspondiente.",
        "error1Fix": "Contacte el tribunal donde se escuchó el caso y solicite una copia certificada de la disposición. Envíela al repositorio estatal relevante o al FBI como corrección.",
        "error2Title": "Registros impropios sin sellar o sin borrar",
        "error2Body": "Si un caso fue sellado o eliminado, no debería aparecer en su historial penal. Si lo hace, eso es un error. Compare cada entrada en su registro con cualquier orden de sellado o eliminación que haya recibido.",
        "error2Fix": "Contacte el tribunal y el repositorio penal estatal con una copia de la orden de sellado o eliminación y solicite que la entrada sea eliminada o corregida.",
        "error3Title": "Vacaturas de órdenes de arresto no registradas",
        "error3Body": "Una orden de arresto que fue revocada o cancelada por un tribunal puede aún aparecer como pendiente en los registros de historial penal. Una orden de arresto pendiente puede resultar en detención, negación de vivienda o re-arresto por una orden que legalmente ya no existe.",
        "error3Fix": "Si tiene una orden judicial cancelando una orden de arresto, contacte el tribunal emisor y el repositorio penal estatal. Están obligados a actualizar el registro.",
        "step3Title": "Paso 3: Envíe correcciones",
        "step3Intro": "Cada agencia tiene su propio proceso de corrección.",
        "fbiFix": "Las correcciones del FBI se realizan a través del mismo portal IdentityHistory.fbi.gov. Necesitará documentación que respalde la corrección.",
        "stateFix": "Las correcciones estatales se realizan a través del repositorio de historial penal estatal, típicamente la división de registros de la policía estatal. Contáctelos directamente con documentación.",
        "fcraNote": "Si el error aparece en una verificación de antecedentes realizada por un empleador o arrendador, el proceso de disputa de la FCRA cubierto en la sección anterior también aplica.",
        "timingTitle": "Cuándo esto importa más",
        "timingBody": "Corregir errores antes de una audiencia de fianza, negociación de acuerdo, solicitud de vivienda o solicitud de empleo tiene el mayor impacto práctico. Los errores encontrados después de una decisión adversa aún son corregibles pero requieren más pasos.",
        "fbiLinkLabel": "Solicitud de Resumen de Historia de Identidad del FBI",
        "fbiLinkDesc": "Solicite su historial penal federal directamente del FBI. Gratuito."
      },
  ...
  "rights": {
    ...
    "detailedRights": {
      ...
      "arrest": {
        ...
        "keyPoints": "Qué saber durante un arresto:",
        "c1": "Su derecho a guardar silencio significa que no está obligado a responder preguntas policiales más allá de identificarse en la mayoría de los estados. Invocarlo requiere una declaración verbal clara.",
        "c2": "Su derecho a un abogado aplica desde el momento del arresto — no necesita esperar una advertencia Miranda. Para invocarlo, diga claramente: 'Quiero un abogado.' La policía debe dejar de interrogarle una vez declarado.",
        "c3": "Consentir un registro de su persona, vehículo o domicilio no es obligatorio en la mayoría de situaciones. La policía necesita una orden judicial o una excepción legal reconocida para la mayoría de los registros.",
        "c4": "La resistencia física a un arresto — incluso uno ilegal — normalmente conlleva cargos penales adicionales. Los tribunales han sostenido que el remedio para un arresto ilegal es el recurso legal posterior, no la resistencia en el momento.",
        "c5": "Todo lo que diga a la policía desde el momento del arresto puede usarse como prueba, independientemente de la intención. Las declaraciones destinadas a explicar la situación a menudo la complican.",
  ...
  "messages": {
    ...
    "captchaRequired": "Por favor complete la verificación a continuación y luego toque Reintentar.",
    "immigrationSummary": "**Información sobre Aplicación de Inmigración**\n\nSi le preocupa la aplicación de inmigración, esto es lo que importa legalmente.\n\n**Derecho a permanecer en silencio:** Este derecho aplica a preguntas sobre estatus migratorio. Las personas no están obligadas a responder preguntas sobre dónde nacieron, cómo entraron al país o su estatus migratorio.\n\n**Derecho a un abogado:** Este derecho existe en los procedimientos de inmigración. Hablar con un abogado antes de responder preguntas o firmar documentos es generalmente aconsejable.\n\n**Entrada al hogar:** Los oficiales de inmigración típicamente requieren una orden judicial firmada por un juez para entrar a un hogar. Una orden administrativa de ICE (Formulario I-200) no tiene la misma autoridad.\n\n**Documentos:** Firmar documentos sin revisión legal puede renunciar a derechos. Las personas en esta situación típicamente se benefician de hablar con un abogado antes de firmar cualquier cosa.\n\nPara orientación completa sobre inmigración, visite nuestra página de [Guía de Inmigración](/immigration-guidance).\n\n**¿En qué más puedo ayudarle?**",
    ...
    "immigrationUrgent": {
      "reminder": "🚨 **Información Inmediata sobre Derechos:**\n\n• Permanecer calmado ayuda a preservar la seguridad y las opciones para un desafío legal posterior.\n• El derecho a permanecer en silencio aplica. Las preguntas sobre estatus migratorio no tienen que responderse.\n• Preguntar si es libre de irse es una forma reconocida de determinar si está siendo detenido.\n• Firmar documentos sin entenderlos puede renunciar a derechos.\n• El derecho a hablar con un abogado aplica.\n\n**¿Dónde está ocurriendo esto?**",
      "atHome": "🏠 **Sus Derechos en Casa:**\n\n• Se requiere una orden judicial firmada por un juez para entrar a un hogar. Una orden administrativa de ICE (Formulario I-200) no tiene la misma autoridad.\n• Declarar en la puerta que no consiente la entrada es una afirmación legalmente reconocida de derechos.\n• Si los oficiales entran sin una orden judicial, eso es relevante para cualquier desafío legal posterior.\n• Información como nombres y números de placa de los oficiales es típicamente útil para un abogado que revisa el incidente.\n\n📞 **Contactos de Emergencia:**\n• Foro Nacional de Inmigración: 1-800-954-6287\n• ACLU: Envíe \"IMMIGRANT\" al 88823\n\n**Conecte con un abogado de inmigración inmediatamente:**",
      "atWork": "💼 **Sus Derechos en el Trabajo:**\n\n• El derecho a permanecer en silencio aplica en encuentros laborales con autoridades de inmigración.\n• Una orden debe especificar el lugar y los nombres de las personas que cubre. Leerla cuidadosamente es importante.\n• Las declaraciones hechas durante el encuentro pueden usarse en procedimientos de inmigración.\n• Las preguntas sobre estatus migratorio no tienen que responderse.\n• Un abogado puede estar presente durante el interrogatorio.\n\n📋 Su empleador no puede tomar represalias contra usted por ejercer sus derechos.\n\n**Aprenda más sobre redadas en el trabajo y responsabilidades del empleador:**",
      "inPublic": "🚶 **Sus Derechos en Público/en Puntos de Control:**\n\n• El derecho a permanecer en silencio sobre estatus migratorio aplica en encuentros públicos.\n• En puntos de control migratorio, pueden hacerse preguntas sobre ciudadanía. Este derecho al silencio sigue aplicando.\n• Permanecer calmado ayuda a preservar la seguridad y las opciones para un desafío legal posterior.\n• Si es detenido, el derecho a hablar con un abogado aplica.\n\n📞 **Contactos de Emergencia:**\n• Foro Nacional de Inmigración: 1-800-954-6287\n• DOJ Revisión de Inmigración: 1-800-898-7180\n\n**Conecte con un abogado de inmigración:**"
    },
    "immigrationPlanning": {
    ...
    "immigrationDetained": {
      ...
      "portOfEntry": "**En un Puerto de Entrada (Aeropuerto/Frontera):**\n\n🛂 **Información Clave:**\n• La Oficina de Aduanas y Protección Fronteriza (CBP) tiene mayor autoridad en puertos de entrada que en otros contextos. Aplican reglas diferentes a las que rigen la aplicación interior.\n• El derecho a hablar con un abogado sigue aplicando.\n• Firmar documentos sin entenderlos completamente puede renunciar a derechos.\n\n📞 **Para Ciudadanos de EE.UU. y Residentes Permanentes:**\nNo se puede negar la entrada, aunque pueden ocurrir retrasos e interrogatorios adicionales.\n\n**Conecte con un abogado de inmigración inmediatamente:**",
  ...
  "chargeSelector": {
    ...
    "noResults": "No se encontraron cargos que coincidan con su búsqueda",
      ...
      "authorityUnavailable": "La autoridad vigente no está disponible. No se pueden seleccionar cargos hasta verificar la fuente oficial.",
...
"attorney": {
  ...
  "first24Hours": {
    ...
    "beforeArrest": {
      ...
      "policeWantToTalkC1Title": "Entrevistas Voluntarias",
      "policeWantToTalkC1": "En la mayoría de los estados generalmente no está obligado a responder preguntas policiales más allá de identificarse. Acceder a una entrevista voluntaria — incluso una descrita como rutinaria — crea un registro que puede usarse en procedimientos futuros.",
      "policeWantToTalkC2Title": "Invocar Sus Derechos",
      "policeWantToTalkC2": "Puede invocar su derecho a guardar silencio diciendo: 'Quisiera un abogado antes de hablar con usted.' La policía debe dejar de interrogarle una vez que lo diga claramente.",
      "policeWantToTalkC3Title": "Si Decide Hablar",
      "policeWantToTalkC3": "Si decide hablar con los investigadores, consultar previamente con un abogado que conozca su situación generalmente produce mejores resultados.",
      ...
      "targetLetterC1Title": "Qué Significa",
      "targetLetterC1": "Una carta de objetivo significa que un gran jurado lo investiga como posible acusado. Existen opciones legales en esta etapa que pueden no estar disponibles después de presentarse los cargos — el momento importa.",
      "targetLetterC2Title": "Declaraciones",
      "targetLetterC2": "Las declaraciones hechas a fiscales o investigadores pasan a formar parte del registro oficial y pueden usarse en cualquier proceso judicial futuro.",
      "targetLetterC3Title": "Destrucción de Documentos",
      "targetLetterC3": "Eliminar o destruir materiales relacionados con la investigación — incluso de manera informal — puede cargarse como obstrucción a la justicia, separadamente del asunto de fondo.",
      ...
      "warrantC1Title": "Quedan Opciones",
      "warrantC1": "Si sabe que existe una orden de arresto, aún quedan opciones legales. Un abogado puede organizar a veces una entrega coordinada que permita una audiencia de fianza el mismo día — generalmente un mejor resultado que un arresto inesperado.",
      "warrantC2Title": "Evasión",
      "warrantC2": "Continuar evadiendo una orden de arresto activa generalmente resulta en cargos adicionales y dificulta la obtención de fianza cuando finalmente ocurre el arresto.",
      "warrantC3Title": "Investigar Primero",
      "warrantC3": "La naturaleza de los cargos, el tribunal que emitió la orden y el monto probable de la fianza son aspectos que un abogado puede investigar antes de la entrega — lo que puede afectar significativamente cómo se desarrolla el proceso.",
      ...
      "detainedC1Title": "Detención vs. Arresto",
      "detainedC1": "La detención es diferente al arresto. Preguntar '¿Soy libre de irme?' establece cuál de los dos ocurre. Si la respuesta es sí, puede retirarse con calma. Si es no, está siendo detenido y puede invocar su derecho a guardar silencio.",
      "detainedC2Title": "Derecho al Silencio",
      "detainedC2": "No está obligado a responder preguntas sobre su paradero, con quién estaba o qué hacía. Esto aplica durante la detención así como durante el arresto.",
      "detainedC3Title": "Resistencia Física",
      "detainedC3": "Resistirse físicamente a un control o detención — incluso uno que crea ilegal — conlleva sus propias consecuencias legales. El mecanismo apropiado es el recurso judicial.",
      ...
      "probationParoleC1Title": "Dos Procedimientos",
      "probationParoleC1": "Un nuevo arresto mientras está en libertad condicional o supervisión normalmente activa dos procedimientos paralelos: los nuevos cargos y un proceso de violación separado. Estos corren simultáneamente y pueden ser en tribunales diferentes.",
      "probationParoleC2Title": "Orden de Supervisión",
      "probationParoleC2": "Una orden de supervisión puede mantenerle en custodia incluso después de que se fije fianza por los nuevos cargos — son dos órdenes separadas que requieren resolución independiente.",
      "probationParoleC3Title": "Estándar de Violación",
      "probationParoleC3": "Un arresto solo puede activar una audiencia de violación — no se requiere condena por los nuevos cargos. El estándar de prueba en una audiencia de violación es más bajo que en un juicio penal.",
      "probationParoleC4Title": "Declaraciones al Oficial",
      "probationParoleC4": "Las declaraciones a un oficial de libertad condicional o supervisión pueden no tener las mismas protecciones legales que las declaraciones a la policía. Se debe buscar orientación de un abogado antes de cualquier comunicación con su oficial.",
    ...
    "steps": {
      "step1": {
        ...
        "c1Title": "Invocar Sus Derechos",
        "c1": "Para invocar su derecho a guardar silencio, diga claramente: «Estoy invocando mi derecho a guardar silencio.» Para solicitar un abogado, diga: «Quiero un abogado.» Una vez que lo diga claramente, la policía está obligada a dejar de interrogarle.",
        "c2Title": "Cumplimiento Físico",
        "c2": "Resistirse físicamente a un arresto — incluso uno que crea ilegal — conlleva cargos penales adicionales bajo las leyes de la mayoría de los estados. La forma de impugnar un arresto ilegal es a través de los tribunales después del hecho, no en el lugar.",
        "c3Title": "Consentimiento para Registro",
        "c3": "Consentir un registro de su persona, vehículo o domicilio no es obligatorio en la mayoría de situaciones. Puede declarar: «No consiento este registro.»",
        "c4Title": "Declaraciones a la Policía",
      ...
      "step2": {
        ...
        "c1Title": "El Proceso de Fichaje",
        "c1": "El fichaje incluye huellas dactilares, fotografías, inventario de pertenencias y el registro formal de los cargos. Cooperar con el proceso de fichaje es un requisito legal.",
        "c2Title": "Llamada Telefónica",
        "c2": "Generalmente tiene derecho a al menos una llamada telefónica después del fichaje, aunque el momento varía según el estado. Todas las llamadas desde la cárcel excepto las realizadas a su abogado son grabadas.",
        "c3Title": "Necesidades Médicas",
        "c3": "Si toma medicación o tiene una condición médica, informe al personal de fichaje por escrito de inmediato. Las cárceles están legalmente obligadas a proporcionar medicación esencial — documente cada solicitud.",
        "c4Title": "El Papeleo de la Acusación",
        "c4": "El papeleo del fichaje nombra a la oficina que presentó los cargos — consulte el encabezado. Anote el nombre de la oficina fiscal y los cargos exactos tal como aparecen escritos. No es el mismo que el departamento de policía.",
        "c5Title": "Preguntas en el Fichaje",
        "c5": "Las preguntas sobre el incidente o su paradero formuladas durante el fichaje están relacionadas con el caso. Todo lo que diga sobre el caso en esta etapa puede usarse como prueba.",
      ...
      "step3": {
        ...
        "c1Title": "Las Llamadas Son Grabadas",
        "c1": "Todas las llamadas desde la cárcel excepto las realizadas a su abogado son grabadas y monitoreadas. Los fiscales pueden acceder y usar lo dicho en una llamada como prueba. Mantenga esta llamada breve y práctica.",
        "c2Title": "Qué Compartir",
        "c2": "Lo más importante que debe compartir: el nombre del centro, su número de fichaje, los cargos tal como están escritos y cualquier fecha de tribunal asignada. La persona a quien llame necesita esto para encontrar un abogado y dar seguimiento a su caso.",
        "c3Title": "Representación Legal",
        "c3": "Si no puede pagar un abogado, el tribunal designa uno en su primera comparecencia. Un familiar puede contactar la oficina del defensor público del condado donde fue arrestado para preguntar sobre el proceso de designación.",
        "c4Title": "Qué No Discutir",
        "c4": "Esta llamada no es el lugar para describir lo que ocurrió, discutir evidencia o coordinar con alguien relacionado con el caso. Esas conversaciones no están protegidas y pasan a formar parte del registro.",
      ...
      "step4": {
        ...
        "c1Title": "Cómo Se Fija la Fianza",
        "c1": "Si se fija fianza, y por qué monto, depende de los cargos, los antecedentes penales, los vínculos con la comunidad y el riesgo de fuga. Estos factores se presentan al tribunal en una audiencia de fianza.",
        "c2Title": "Condiciones de Fianza",
        "c2": "Si se le pone en libertad bajo fianza, cada condición de la fianza es un requisito legal. Cualquier infracción — incluso accidental — normalmente resulta en un arresto inmediato y la pérdida del dinero depositado.",
        "c3Title": "Tipos de Fianza",
        "c3": "Las opciones de fianza incluyen: pago total, fianza (un agente de fianzas cobra generalmente el 10-15%, no reembolsable), fianza con propiedad, o libertad bajo su propia palabra si el tribunal lo concede.",
        "c4Title": "Si Permanece Detenido",
        "c4": "Si permanece detenido, un abogado puede solicitar una audiencia de reducción de fianza. Este es un paso importante que su abogado debe conocer tan pronto sea contactado.",
      ...
      "step5": {
        ...
        "c1Title": "Derecho a Representación",
        "c1": "El derecho a un abogado se aplica en cada etapa crítica de su caso. Si no puede pagar uno, el tribunal designa un defensor público en su primera comparecencia — usted le dice al juez que necesita abogado designado.",
        "c2Title": "Participación Temprana",
        "c2": "Cuanto antes se involucre un abogado, más opciones quedan disponibles. Algunos pasos — como cartas de preservación de pruebas para filmaciones de vigilancia o cámaras corporales — tienen ventanas de tiempo que se cierran horas o días después de un arresto.",
        "c3Title": "Privilegio Abogado-Cliente",
        "c3": "Todo lo que le diga a su abogado está protegido por el privilegio abogado-cliente. Lo que le diga a cualquier otra persona — familiares, amigos o personal de la cárcel — no está protegido y puede usarse como prueba.",
      ...
      "step6": {
        ...
        "c1Title": "Introducir una Declaración",
        "c1": "En la lectura de cargos, los cargos se leen formalmente y se le pide que introduzca una declaración. Tres opciones están disponibles: culpable, no culpable y nolo contendere. Cada una tiene efectos legales diferentes en su caso. Su abogado debe aconsejarle cuál elegir según los hechos de su situación.",
        "c2Title": "Sin Representación",
        "c2": "Si comparece sin abogado, informe al juez. Puede pedir más tiempo para conseguir uno, o solicitar abogado de oficio en esta audiencia.",
        "c3Title": "Qué Es la Lectura de Cargos",
        "c3": "La lectura de cargos es un paso procesal — no el punto donde se decide el caso. Intentar explicar su situación o abordar los méritos del caso en la lectura de cargos generalmente no ayuda y puede crear problemas.",
        "c4Title": "Fianza en la Lectura de Cargos",
        "c4": "La fianza puede abordarse en la lectura de cargos. Si está detenido, se pueden presentar argumentos de fianza aquí. Si ya fue puesto en libertad, las condiciones pueden ajustarse.",
        "whoCharges": {
      ...
      "step7": {
        ...
        "c1Title": "Fechas Judiciales",
        "c1": "Las fechas judiciales son obligatorias. Faltar a una audiencia resulta en una orden de arresto y la pérdida de cualquier fianza. Establezca múltiples recordatorios para cada fecha programada.",
        "c2Title": "Condiciones de Fianza",
        "c2": "Las condiciones de la fianza deben seguirse exactamente. Cualquier infracción — incluso accidental — resulta en arresto inmediato.",
        "c3Title": "Conversaciones",
        "c3": "Las conversaciones sobre su caso fuera del privilegio abogado-cliente no están protegidas. Las llamadas desde la cárcel, mensajes de texto, conversaciones con familiares y amigos, y publicaciones en redes sociales pueden ser obtenidas y usadas como prueba.",
        "c4Title": "Contacto con Testigos",
        "c4": "El contacto con supuestas víctimas o testigos durante un caso activo puede plantear preocupaciones legales incluida la obstrucción a la justicia. Un abogado debe asesorar antes de cualquier contacto de ese tipo.",
        "c5Title": "Su Recuerdo",
        "c5": "Su recuerdo de lo sucedido es potencialmente importante para su defensa. Registrar sus memorias mientras están frescas puede ser útil para compartir con su abogado.",
  ...
  "howTo": {
    ...
    "reentry": "Recursos de Reinserción",
    "reentryDesc": "Restauración de identificación, vivienda, empleo y derechos de voto tras la encarcelación",
    "rightToCounsel": "Derecho a un Abogado",
    "rightToCounselDesc": "Cuándo comienza su derecho a un abogado, cómo invocarlo y la brecha crítica antes de la lectura de cargos.",
    ...
    "personalHealthDesc": "Manejo de necesidades de salud durante su caso, incluyendo medicamentos, seguro médico y citas.",
