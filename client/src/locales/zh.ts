  ...
  "first24Hours": {
    ...
    "steps": {
      ...
      "step6": {
        ...
        "context": "您将被正式宣读对您的指控，并被要求作出答辩。这不是为您的案件辩护的时机。这是保留所有选项的时机。",
        "do1": "在起诉时答辩「无罪」，除非您的律师在审查案件后专门建议了其他做法。",
        "do2": "这保留了您的所有选择。您随时可以改变无罪答辩。",
        "do3": "如果已获保释释放，请穿着整洁得体的衣服出庭。",
        "dont1": "不要在起诉时认罪。您无法反悔，而且您还没有时间评估完整案件。",
        "dont2": "不要向法官谈论案件的事实。",
