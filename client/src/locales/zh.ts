export default {
  ...
  "privacyPolicy": {
    ...
    "caseData": {
      ...
      "serverRestart": {
        "title": "完全不存储数据的工具",
        "description": "记录清除资格评估工具和公设辩护人入档表格不发出任何服务器请求。评估工具完全在您的浏览器中作为决策树运行。入档表格是您手写填写的可打印文件。使用这些工具时，不会以电子方式提交、传输或存储任何信息。"
      }
    },
    "noDataTools": {
      "title": "不收集任何数据的工具",
      "description": "记录清除资格评估工具和公设辩护人入档表格在任何时候都不发出服务器请求。评估工具完全在您的浏览器中作为决策树运行。入档表格是您手写填写的可打印文件。使用这些工具时，不会以电子方式提交、传输或存储任何信息。"
    },
    "technical": {
      "title": "技术详情",
      "sessions": {
