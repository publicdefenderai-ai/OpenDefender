export default {
  ...
  "home": {
    "hero": {
      ...
      "path2Label": "获取指导",
      "path2Desc": "针对您的指控、截止日期和下一步的个性化路线图",
      "path3Label": "生活支持",
  ...
  "howTo": {
    ...
    "paths": {
      ...
      "path2": {
        "badge": "了解您的具体情况",
        "headline": "个性化案件指导",
        "subhead": "回答几个问题，获取根据您的指控、所在地区和情况量身定制的AI驱动指导。隐私保护设计——您的回答从不被存储。",
        "bullet1": "5步流程：安全检查、位置、指控、情况、详情",
        "bullet2": "用通俗语言解释您的指控",
        "bullet3": "识别您所在州的转处计划和认罪选项",
        "bullet4": "由Claude AI提供支持，具备法律准确性验证",
        "cta": "获取案件指导"
      },
      "path3": {
