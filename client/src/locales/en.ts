export default {
  ...
  "home": {
    ...
    "urgentHelp": {
      ...
      "stayCalmText": "Physical resistance, even to an unlawful arrest, can put you in physical danger and result in additional charges. Keeping hands visible and remaining calm during the encounter is safer and preserves options for later legal challenge.",
      ...
      "noConsentTitle": "3. Refusing a Search",
      "noConsentText": "Clearly refusing permission for a search preserves certain rights and protections, even if police still conduct a search.",
      "publicDefenderTitle": "4. Court-Appointed Attorney",
      "publicDefenderText": "People who cannot afford an attorney have a constitutional right to one at no cost. This right is typically exercised by informing the court at the first appearance. The judge then arranges appointment before any questioning may proceed.",
    ...
    "dataSources": {
      ...
      ,"transparency": {
        ...
        "intro": "A scan-friendly inventory of the legal, practical, and public-resource content used across OpenDefender. Counts come from the maintained project records; a link or a record is not the same as legal verification.",
        "reviewed": "Inventory reviewed August 2026",
        "disclaimer": "Educational information, not legal advice.",
        "limitationsHeading": "Read this before relying on a result",
        "limitationsIntro": "Coverage and confidence vary by dataset and by record. The labels below describe the evidence behind a dataset, not a promise that an answer is correct for every person or court.",
        "limitations": [
          "Some charge records and explanations are synthesized or general rather than verbatim current statutes.",
          "Procedure records mix high-confidence rules with five medium-confidence territory records; some preliminary-hearing and discovery fields remain estimates.",
          "Diversion, legal-aid, detention, consulate, and court links can change. A URL check cannot confirm eligibility, open hours, intake, or that a program still operates.",
          "Some source material is paywalled, unavailable, local, or dependent on an external provider. Important details need confirmation with a current official source and an attorney."
        ],
        "legendHeading": "How to read confidence",
        "legendIntro": "These plain-language labels are assigned at the dataset level. Mixed means the dataset contains more than one evidence standard.",
        "skipToInventory": "Skip to topic inventory",
        "inventoryHeading": "Topic inventory",
        "inventoryIntro": "Use the topic links to jump directly to a dataset. Each card shows the maintained count, the latest defensible freshness statement, the source path, and a limitation that stays visible.",
        "topicNavigation": "Data source topic navigation",
        "additionalInformation": "Additional transparency information",
        "showEvidence": "Show evidence notes",
        "hideEvidence": "Hide evidence notes",
        "openSource": "Open source path",
        "opensNewTab": "opens in a new tab",
        "outOfScopeHeading": "What this page does not claim",
        "outOfScopeIntro": "The inventory is intentionally not a promise of complete or current coverage everywhere.",
        "outOfScope": [
          "Every local court rule, municipal ordinance, or county-level practice.",
          "Live eligibility, funding, intake, or availability for any resource or diversion program.",
          "Attorney review, guaranteed legal accuracy, or a substitute for legal advice.",
          "Real-time case law, pretrial outcomes, or live BJS analytics in the product."
        ],
        "reportHeading": "Found a source or data problem?",
        "reportBody": "Tell us the jurisdiction, topic, record or link, and what should be corrected. We use reports to prioritize re-checks; a report does not change a record until it is confirmed.",
        "nySources": {
          "eyebrow": "New York charge sources",
          "title": "How New York charge sources are verified",
          "intro": "New York charge records use a dedicated provenance process so you can see which official source was checked, what the database will publish, and why an entry may be withheld.",
          "authorityTitle": "Official authority",
          "authorityBody": "For New York Penal Law records, the source database uses only the New York State Senate Open Legislation API. Each retrieval records the structured law and section identifiers, official title, full section text, active date, publication history, and a SHA-256 content hash. The official citation link opens the Senate's human-readable law page.",
          "failClosedTitle": "Why a charge may be unavailable",
          "failClosedBody": "The importer fails closed: if the API does not return an official title and full section text, or required provisions do not map exactly to the charge, the row is withheld. Withheld rows do not appear in New York charge selection and do not receive charge-specific guidance or exports. A failed refresh or source change is not published as current authority; the affected charge is withdrawn from selection and its current provenance link is deactivated until the exact source is restored or the change is reviewed and promoted. If no completed manifest exists, New York availability is denied.",
          "catalogTitle": "Aliases and local records",
          "catalogBody": "An exact alias or rename is allowed only when the API section is confirmed; current lookup uses the official title. A material mismatch or placeholder is withheld. New York City administrative-code entries are reference-only because they are outside the state Senate API and have no stored source text.",
          "reviewTitle": "API verification is not attorney approval",
          "reviewBody": "API verification confirms source identity, returned text, dates, and the content hash. It does not mean a lawyer has approved the elements, mental state, grading, penalties, or currentness interpretation. Those legal fields remain marked pending attorney review until counsel reviews them.",
          "linksTitle": "Review the underlying disclosures",
          "linksIntro": "Compare this explanation with the maintained source inventory, statute-link disclosure, legal-data disclosures, and the Senate's official pages.",
          "apiLink": "NY Senate Open Legislation API",
        ...
        "paSources": {
          "eyebrow": "Pennsylvania charge sources",
          "title": "How Pennsylvania charge sources are verified",
          "intro": "Pennsylvania charge records use the Pennsylvania General Assembly's official Consolidated Statutes pages. The committed manifest preserves all 112 catalog rows, but publishes only records with complete, exact statutory support.",
          "authorityTitle": "Official authority",
          "authorityBody": "The importer retrieves Pennsylvania Consolidated Statutes from legis.state.pa.us, follows the site's statute frame when needed, verifies the title and section, stores the complete returned text, records retrieval and currentness evidence, and computes a SHA-256 content hash.",
          "failClosedTitle": "Why a charge may be unavailable",
          "failClosedBody": "If the official page is unavailable, the section or title is missing, a compound charge is incomplete, the citation is federal or unconsolidated, or the catalog mapping is materially different, the row is withheld. Withheld Pennsylvania rows do not appear in selection, guidance, search, or exports.",
          "catalogTitle": "Statutory text versus supplements",
          "catalogBody": "Pennsylvania Sentencing Commission material may supplement grading or penalty context, but it cannot replace official Pennsylvania statutory offense text. The importer never infers a replacement from a nearby section.",
          "reviewTitle": "Source verification is not attorney approval",
          "reviewBody": "Verification confirms the official publisher, section, title, returned text, retrieval metadata, and hash. It does not mean a lawyer approved the elements, mental state, grading, penalties, or currentness interpretation; those fields remain pending attorney review.",
          "linksTitle": "Review the underlying disclosures",
          "linksIntro": "Compare this explanation with the maintained source inventory, statute-link disclosure, legal-data disclosures, and the Pennsylvania General Assembly's official statutes.",
          "officialLink": "Example official Pennsylvania section",
          "inventoryLink": "Criminal-charge source inventory",
          "statuteLink": "Statute-link disclosure",
          "disclaimerLink": "General legal-data disclosures",
          "chargeLookupTitle": "Inspect a charge's current provenance",
        ...
        "sourceTypes": {
          ...
          "synthesizedResearch": "Synthesized educational content",
          "publicDirectory": "Public directory or resource",
          "externalProvider": "External provider",
          "mixedResearch": "Mixed legal research"
        },
        "confidence": {
          "primary": "Primary-source checked",
          "secondary": "Secondary-source checked",
          "synthesized": "Synthesized / general",
          "availability": "Link / availability check",
          "conditional": "Conditional provider check",
          "mixed": "Mixed evidence"
        },
        "confidenceDescription": {
          "primary": "Specific government or primary legal text was checked for the stated records.",
          "secondary": "Public research or specialist directories support the records; coverage is not a legal opinion.",
          "synthesized": "Plain-language or editorial content assembled from general legal sources; do not cite it as a statute.",
          "availability": "A link, contact, or directory record was checked. This does not prove eligibility or current operations.",
          "conditional": "A provider can validate a request when available; the result depends on the provider, inputs, and service status.",
          "mixed": "Different parts of this dataset use different evidence levels; read the limitation and evidence note."
        },
        "coverage": {
          ...
          "legalAid": "{{count}} directory records (organizations / jurisdiction labels).",
          "glossary": "{{count}} glossary terms.",
          "courtServices": "{{count}} court-system entries.",
          "statuteLinks": "{{count}} jurisdiction URL configurations.",
          "detention": "{{count}} facility records (facilities / states).",
          "consulates": "{{count}} country contact records.",
          "publicResources": "Public-resource links used by support and resource pages; no completeness claim.",
          "juryInstructions": "Selected instruction series and references; not all charges or jurisdictions.",
          "validation": "Three external validation or lookup services are documented.",
          "statistics": "Named statistical publications; no live BJS feed is active.",
          "ai": "One external AI provider is documented."
        },
        "items": {
          "federalStatutes": { "title": "Federal statutes", "summary": "A small seed set of federal statutory entries used as a starting point for federal-law references.", "freshness": "Source index reviewed July 2026; check the current code.", "limitation": "The seed set is not the entire U.S. Code and a live URL does not establish that a provision applies.", "evidence": "Entries cite Cornell Legal Information Institute text. This is a primary-text path, not attorney sign-off." },
          "charges": { "title": "Criminal charges", "summary": "The charge catalog organizes common offense names, classifications, and citations across states, territories, D.C., and federal jurisdiction.", "freshness": "Count is read from the maintained charge export.", "limitation": "The catalog is curated and partly synthesized. Some codes are organizational placeholders; verify every citation in the current official code.", "evidence": "The maintained export contains 7,155 records: 3,772 felony, 3,322 misdemeanor, and 61 infraction records across 57 jurisdiction codes." },
          "explanations": { "title": "Charge explanations", "summary": "Plain-language explanations connect selected charge patterns to terms, degree context, and jurisdiction-specific detail.", "freshness": "Source fields and overlays are read from the maintained exports.", "limitation": "Only 49 of 60 base explanations have a recorded source field. Overlay coverage varies; the remaining explanations are general rather than silently treated as state law.", "evidence": "The export has 60 base explanations and 2,818 jurisdiction overlay records. A recorded source still requires checking the cited current law." },
          "procedure": { "title": "Procedure and deadline rules", "summary": "Arraignment, bail, speedy-trial, phone-call, and selected pretrial timing rules feed the case timeline and guidance.", "freshness": "Source index says the jurisdiction pass was re-verified July 2026.", "limitation": "There are 57 entries: 52 high-confidence state/D.C./federal records and five medium-confidence territory records. Preliminary-hearing and discovery fields include estimates.", "evidence": "The maintained rules distinguish record confidence from estimated fields. Estimates are not guarantees and local orders can control." },
          "collateral": { "title": "Collateral consequences", "summary": "State-level voting, employment, benefits, housing, licensing, immigration, registry, and deadline information.", "freshness": "Most maintained records are dated March 2026; check the record and current law.", "limitation": "Consequences can depend on offense, sentence, supervision, agency rules, and facts not represented here.", "evidence": "The maintained exports cover 51 jurisdiction keys across multiple consequence families with mixed confidence." },
          "rights": { "title": "Constitutional rights", "summary": "General educational summaries of rights such as silence, counsel, search, and speedy trial.", "freshness": "Static editorial content; no universal currentness claim.", "limitation": "Broad summaries have exceptions and state-specific procedures. They are not a complete constitutional or case-law database.", "evidence": "The page points to Constitution Congress and related public legal materials; users should confirm the rule in the governing jurisdiction." },
          "expungement": { "title": "Expungement and record relief", "summary": "Jurisdiction-specific eligibility summaries distinguish expungement, sealing, set-aside, and other forms of record relief.", "freshness": "Entries carry individual update dates; older records need re-checking.", "limitation": "Eligibility, fees, waiting periods, and forms change. A listed rule is not an eligibility determination.", "evidence": "The maintained export has 52 jurisdiction records and records the source citations and update date where available." },
          "diversion": { "title": "Diversion programs", "summary": "A directory of statewide and local diversion or problem-solving programs used in resource searches.", "freshness": "Dataset header says April 2026; individual records may be older.", "limitation": "The 111 records are not a complete directory. URL checks cannot establish eligibility, funding, intake, hours, or continued operation.", "evidence": "110 records are currently marked active in the export. Sources include NADCP, NDAA, courts, prosecutors, and other public agencies." },
          "legalAid": { "title": "Legal-aid organizations", "summary": "Seeded public-defender, immigration, civil legal-aid, and federal defender directory records.", "freshness": "Dataset header says last updated March 2026; check the organization directly.", "limitation": "A directory record or working link does not mean the organization accepts this case, serves this person, or has capacity.", "evidence": "The maintained seed contains 198 organizations across 55 jurisdiction labels and draws on EOIR, LSC, public defender, and federal defender sources." },
          "glossary": { "title": "Legal glossary", "summary": "Plain-language definitions for legal terms used in the product.", "freshness": "Count and terms are read from the maintained glossary export.", "limitation": "Definitions are educational summaries and may omit jurisdiction-specific meanings or exceptions.", "evidence": "The maintained glossary contains 50 terms with optional source links and per-term dates." },
          "courtServices": { "title": "Court services and locator links", "summary": "Official court-system websites and locator paths help users find local court information.", "freshness": "The maintained court map is documented as verified January 2025; links can change.", "limitation": "A court homepage or locator is not a local-rule database and does not confirm a deadline or service availability.", "evidence": "The export has 52 court-system entries. Local rules and clerk instructions must be confirmed with the court." },
          "statuteLinks": { "title": "Statute-link configurations", "summary": "Jurisdiction-specific URL generation and citation paths used to find public statute text.", "freshness": "URL configurations are checked by link-review scripts; check the current page.", "limitation": "A responding URL is an availability signal, not substantive verification. Mirrors and redirects may not be current or official.", "evidence": "The maintained configuration covers 52 jurisdiction keys and records different official or secondary paths by jurisdiction." },
          "detention": { "title": "Detention facilities", "summary": "Public contact and facility information used for detention-resource searches.", "freshness": "Directory data can change without notice; call the facility or agency.", "limitation": "A listed facility is not proof that a person is held there, that visitation is available, or that contact information is current.", "evidence": "The maintained export lists 29 facilities across 13 states and uses public ICE and FOIA-related research." },
          "consulates": { "title": "Consulate contacts", "summary": "Country-level consular contact records for family-preparedness and emergency-resource flows.", "freshness": "Contact details can change; use the country’s official source before calling.", "limitation": "A contact record does not promise emergency response, legal representation, or assistance in a particular case.", "evidence": "The maintained export has 20 country records with a main website and consulate contact." },
          "publicResources": { "title": "Other public resources", "summary": "National resource links such as 211, HUD, EEOC, reentry, and community-support organizations.", "freshness": "Links are reviewed periodically, not continuously.", "limitation": "This is a curated set, not a complete resource directory; geography, eligibility, and availability vary.", "evidence": "The internal source index names the public organizations and their intended use. Link checks do not verify service quality or eligibility." },
          "juryInstructions": { "title": "Jury-instruction references", "summary": "Selected instruction-series names, numbers, and public document paths associated with charge records.", "freshness": "Coverage is maintained selectively and should be checked against the issuing court.", "limitation": "Some series are paywalled and not all charges or jurisdictions have an instruction reference.", "evidence": "The overlay contains selected instruction references; a citation number is not proof that the current instruction has that wording." },
          "validation": { "title": "External validation services", "summary": "Optional provider lookups support citation, case-law, statute, and municipal-ordinance checks.", "freshness": "Provider availability and responses can change at request time.", "limitation": "Conditional validation is not guaranteed legal accuracy. Provider coverage, authentication, rate limits, and query quality affect results.", "evidence": "The documented services include CourtListener, OpenLaws, and LOCUS-v1. LOCUS is supplementary for local ordinances only." },
          "statistics": { "title": "Statistics cited in content", "summary": "Public statistical references used in educational and support content, separate from the legal-rule datasets.", "freshness": "Statistics can age even when the publication remains available; the cited edition matters.", "limitation": "BJS analytics and live crime-statistics APIs are not active product data sources. Historical statistics do not predict an individual case.", "evidence": "Named references include the U.S. Sentencing Commission FY 2024 Sourcebook and BJS studies on felony defendants and pretrial detention; check the cited publication for scope and date." },
          "ai": { "title": "AI guidance provider", "summary": "Disclosure of the external provider used for case guidance, summaries, and document assistance.", "freshness": "Provider and model details can change; review the current product disclosure.", "limitation": "AI output may be incomplete, estimated, mistranslated, or wrong. It is not a lawyer, legal advice, or a substitute for the cited source.", "evidence": "Provider: Anthropic Claude Sonnet 4 (claude-sonnet-4-6) via API. Before processing, OpenDefender attempts to redact common identifiers such as names, phone numbers, addresses, and Social Security numbers, but redaction may miss details. API prompts are not used to train models; Anthropic may retain API data for up to 30 days under standard terms. OpenDefender keeps case and feedback records temporarily in server memory, generally expiring within 24 hours or on restart. This is not attorney-client privileged." }
        }
      }
    },
  ...
  "support": {
    ...
    "reputation": {
      ...
      "rapSheet": {
        "sectionTitle": "Check Your Criminal Record for Errors",
        "sectionSubtitle": "Research has found that more than 6 in 10 official state criminal records contain at least one significant error. These errors can inflate bail amounts, affect plea offers, and cause wrongful denials of housing and employment. You can request your records and check them systematically.",
        "step1Title": "Step 1: Request your records",
        "step1Intro": "You need two records: your federal record from the FBI and your state criminal history.",
        "fbiTitle": "FBI Identity History Summary (federal record)",
        "fbiBody": "Request online at IdentityHistory.fbi.gov. The request is free. You will receive a copy of every federal arrest and disposition in the FBI's records for your fingerprints. Processing typically takes a few weeks.",
        "stateTitle": "State criminal history",
        "stateBody": "Contact the state police records division or court administrator in the state where you have been arrested or convicted. Fees typically range from $10 to $30. Each state has its own process. Search your state name plus 'criminal history request' to find the right agency.",
        "step2Title": "Step 2: Check for the three most common errors",
        "step2Intro": "For each entry in your record, look for these specific problems.",
        "error1Title": "Missing dispositions",
        "error1Body": "A disposition is the outcome of a case: convicted, dismissed, diverted, acquitted, or no-billed. Research shows fewer than half of all arrest records contain a recorded disposition. Without one, the arrest looks unresolved even if charges were dropped or you were found not guilty. Look for every arrest entry that has no corresponding outcome listed.",
        "error1Fix": "Contact the court where the case was heard and request a certified copy of the disposition. Submit it to the relevant state repository or the FBI as a correction.",
        "error2Title": "Improperly unsealed or uncleared records",
        "error2Body": "If a case was sealed or expunged, it should not appear on your criminal history. If it does, that is an error. Compare every entry in your record against any sealing or expungement orders you have received.",
        "error2Fix": "Contact the court and the state criminal repository with a copy of the sealing or expungement order and request that the entry be removed or corrected.",
        "error3Title": "Unrecorded warrant vacaturs",
        "error3Body": "A warrant that was recalled or vacated by a court may still appear as outstanding in criminal history records. An outstanding warrant can result in detention, denial of housing, or re-arrest for a warrant that legally no longer exists.",
        "error3Fix": "If you have a court order vacating a warrant, contact the issuing court and the state criminal repository. They are required to update the record.",
        "step3Title": "Step 3: Submit corrections",
        "step3Intro": "Each agency has its own correction process.",
        "fbiFix": "FBI corrections go through the same IdentityHistory.fbi.gov portal. You will need documentation supporting the correction.",
        "stateFix": "State corrections go through the state criminal history repository, typically the state police records division. Contact them directly with documentation.",
        "fcraNote": "If the error is appearing on a background check run by an employer or landlord, the FCRA dispute process covered in the section above also applies.",
        "timingTitle": "When this matters most",
        "timingBody": "Correcting errors before a bail hearing, plea negotiation, housing application, or job application has the most practical impact. Errors caught after an adverse decision are still correctable but require more steps.",
        "fbiLinkLabel": "FBI Identity History Summary Request",
        "fbiLinkDesc": "Request your federal criminal history record directly from the FBI. Free."
      },
  ...
  "legalGuidance": {
    "qaFlow": {
      ...
      "consent": {
        ...
        "cardATime": "Takes about 30–60 seconds.",
        ...
        "cardBBody": "Curated guidance for your state and charge type — drawn from our legal research database. No AI.",
      ...
      "caseDetails": {
        ...
        "searchLabel": "Search charges",
        "searchPlaceholder": "Type to search (e.g. fare evasion, DUI, theft...)",
        "noResults": "No charges found. Try a different search term or category.",
  ...
  "rights": {
    ...
    "detailedRights": {
      ...
      "arrest": {
        ...
        "keyPoints": "What to know during an arrest:",
        "c1": "Your right to remain silent means you are not required to answer police questions beyond providing basic identification in most states. Invoking it requires a clear verbal statement: 'I am invoking my right to remain silent.'",
        "c2": "Your right to an attorney applies from the moment of arrest — you do not need to wait for a Miranda warning. To invoke it, say clearly: 'I want a lawyer.' Police must stop questioning once stated.",
        "c3": "Consenting to a search of your person, vehicle, or home is not required in most situations. Police need a warrant or a recognized legal exception for most searches.",
        "c4": "Physical resistance to an arrest — even an unlawful one — typically carries separate criminal charges. Courts have held that the remedy for an unlawful arrest is legal challenge afterward, not resistance at the time.",
        "c5": "Anything said to police from the moment of arrest can be used as evidence, regardless of intent. Statements meant to explain the situation often complicate it.",
  ...
  "messages": {
    ...
    "captchaRequired": "Please complete the verification below, then tap Retry.",
    "immigrationSummary": "**Immigration Enforcement Information**\n\nIf you are concerned about immigration enforcement, here is what matters legally.\n\n**Right to remain silent:** This right applies to questions about immigration status. People are not required to answer questions about where they were born, how they entered the country, or their immigration status.\n\n**Right to an attorney:** This right exists in immigration proceedings. Speaking with an attorney before answering questions or signing documents is generally advisable.\n\n**Home entry:** Immigration officers typically require a judicial warrant signed by a judge to enter a home. An ICE administrative warrant (Form I-200) does not carry the same authority.\n\n**Documents:** Signing documents without legal review can waive rights. People in this situation typically benefit from speaking with an attorney before signing anything.\n\nFor comprehensive immigration guidance, visit our full [Immigration Guidance](/immigration-guidance) page.\n\n**What else can I help you with?**",
    ...
    "immigrationUrgent": {
      "reminder": "🚨 **Immediate Rights Information:**\n\n• Remaining calm helps preserve safety and options for later legal challenge.\n• The right to remain silent applies. Questions about immigration status do not have to be answered.\n• Asking whether you are free to leave is a recognized way to determine whether you are being detained.\n• Signing documents without understanding them can waive rights.\n• The right to speak with an attorney applies.\n\n**Where is this happening?**",
      "atHome": "🏠 **Your Rights at Home:**\n\n• A judicial warrant signed by a judge is required for entry into a home. An ICE administrative warrant (Form I-200) does not carry the same authority.\n• Stating at the door that you do not consent to entry is a legally recognized assertion of rights.\n• If officers enter without a judicial warrant, that is relevant to any later legal challenge.\n• Information such as officer names and badge numbers is typically useful to an attorney reviewing the incident.\n\n📞 **Emergency Contacts:**\n• National Immigration Forum: 1-800-954-6287\n• ACLU: Text \"IMMIGRANT\" to 88823\n\n**Connect with an immigration attorney immediately:**",
      "atWork": "💼 **Your Rights at Work:**\n\n• The right to remain silent applies in workplace encounters with immigration authorities.\n• A warrant should specify the location and the names of individuals it covers. Reading it carefully is important.\n• Statements made during the encounter can be used in immigration proceedings.\n• Questions about immigration status do not have to be answered.\n• An attorney can be present during questioning.\n\n📋 Your employer cannot retaliate against you for exercising your rights.\n\n**Learn more about workplace raids and employer responsibilities:**",
      "inPublic": "🚶 **Your Rights in Public/at Checkpoints:**\n\n• The right to remain silent about immigration status applies in public encounters.\n• At immigration checkpoints, questions about citizenship may be asked. This right to silence still applies.\n• Remaining calm helps preserve safety and options for later legal challenge.\n• If detained, the right to speak with an attorney applies.\n\n📞 **Emergency Contacts:**\n• National Immigration Forum: 1-800-954-6287\n• DOJ Immigration Review: 1-800-898-7180\n\n**Connect with an immigration attorney:**"
    },
    "immigrationPlanning": {
    ...
    "immigrationDetained": {
      ...
      "portOfEntry": "**At a Port of Entry (Airport/Border):**\n\n🛂 **Key Information:**\n• Customs and Border Protection (CBP) has broader authority at ports of entry than in other settings. Different rules apply than those that govern interior enforcement.\n• The right to speak with an attorney still applies.\n• Signing documents without fully understanding them can waive rights.\n\n📞 **For U.S. Citizens and Green Card Holders:**\nEntry cannot be denied, though delays and additional questioning may occur.\n\n**Connect with an immigration attorney immediately:**",
    ...
    "pathwayMenu": "What would you like help with?",
    "first24HoursInfo": "**The First 24 Hours After Arrest**\n\nThe decisions made in the first 24 hours typically shape the rest of the case. Here is what usually happens and what matters legally at each stage.\n\n**Right to remain silent:** This right is invoked by stating it clearly. For example: \"I am invoking my right to remain silent. I want a lawyer.\" Once invoked, police are generally required by law to stop questioning. Statements made before invoking this right can typically be used in court.\n\n**At booking:** Standard processing includes photographing, fingerprinting, and a phone call. This call is typically the first opportunity to reach an attorney or a trusted family member.\n\n**Right to counsel:** People who cannot afford an attorney are entitled to a court-appointed one. This right is exercised by informing the court at first appearance.\n\n**Jail calls:** Calls from jail facilities are recorded and may be monitored. Statements made on these calls can be subpoenaed and used in court. Family members who receive such calls may also be required to testify about them.\n\n**Bail hearing:** Typically occurs within 24 to 72 hours. A judge determines release conditions and sets bail. An attorney can present arguments at this hearing.\n\n**Arraignment:** This is when formal charges are read and a plea is entered. Attorneys generally advise clients not to speak in court without counsel present, as statements made at arraignment are part of the court record.\n\n---\nThe full guide walks through all 7 steps: arrest, booking, phone call, bail, attorney, arraignment, and probation/parole.",
    "lifeFamilyMenu": "A legal case affects more than just the courtroom. What area do you need help with?",
    "resourcesDirectoryMenu": "Browse our full resource library. Select a category:",
    "dirGetHelpMenu": "Get Help. Select a tool:",
    "dirKnowRightsMenu": "Know Your Rights. Select a topic:",
    ...
    "helpingFamilyInfo": "**Helping Someone Who Was Arrested**\n\nHere is what to focus on in the next few hours.\n\n**Finding them:** Call the county jail or use an online inmate locator. You will need their full legal name and date of birth. Many counties have a search tool on the county sheriff's website.\n\n**Legal representation:** The public defender's office in the county where they were arrested can provide free representation for people who qualify. Reaching out before the bail hearing is important.\n\n**The bail hearing:** Bail hearings typically occur within 24 to 72 hours of arrest. The jail can confirm the scheduled time. This is when release conditions and bail amounts are determined.\n\n**Jail calls:** Calls from jail facilities are recorded and may be monitored by prosecutors. Statements made on those calls, and statements made by the person receiving the call, can be subpoenaed as evidence. Most attorneys advise keeping calls to brief expressions of support and avoiding any discussion of the incident.\n\nOur full Friends & Family guide covers inmate locators, bail, communication, and more:"
  },
  "replies": {
    ...
    "lifeFamilyNav": "Life & Family",
    "resourcesDirectory": "Browse Resources",
    "viewFirst24Hours": "View Full First 24 Hours Guide →",
    "dirGetHelp": "Get Help",
    "dirKnowRights": "Know Your Rights",
    "dirLegalSupport": "Legal Support Services",
    "dirLifeFamily": "Life & Family",
    "dirReference": "Reference",
    "dirAttorneyTools": "Attorney Tools",
    "dirCaseRoadmap": "Case Roadmap",
    "dirAiChat": "AI Chat",
    "dirDocumentSummarizer": "Document Summarizer",
    "dirLetterGenerator": "Letter Generator",
    "dirFirst24HoursGuide": "First 24 Hours Guide",
    "dirConstitutionalRights": "Constitutional Rights",
    "dirCaseTimeline": "Case Timeline",
    "dirFriendsFamily": "Friends & Family",
    "dirWarrants": "Warrants",
    "dirRightToCounsel": "Right to Counsel",
    "dirMockQA": "Practice Q&A",
    "dirPublicDefenders": "Public Defenders & Legal Aid",
    "dirDiversionPrograms": "Diversion Programs",
    "dirRecordExpungement": "Record Expungement",
    "dirImmigrationHelp": "Immigration Help",
    "dirSupportHub": "Life & Family Hub (All Areas)",
    "dirEmployment": "Employment Rights",
    "dirHousing": "Housing",
    "dirFinances": "Finances & Benefits",
    "dirFamilyCare": "Family Care",
    "dirMentalHealth": "Mental Health",
    "dirTransportation": "Transportation",
    "dirReentry": "Re-Entry",
    "dirLegalGlossary": "Legal Glossary",
    "dirCourtLocator": "Court Locator",
  ...
  "chargeSelector": {
    ...
    "authorityUnavailable": "Current authority is unavailable. No charges can be selected until the official source is verified.",
...
"attorney": {
  ...
  "first24Hours": {
    ...
    "accordion": {
      ...
      "counselIntro": "The right to a lawyer is actually two separate rights under two different amendments. They kick in at different moments.",
      ...
      "counselStateTX": "Right to counsel attaches at arraignment. Until then, the Fifth Amendment is your main protection. TX magistration must occur within 48 hours of arrest.",
      "counselStateFL": "First appearance before a magistrate within 24 hours for a first-appearance hearing. Arraignment is typically 21–33 days after filing.",
      "counselStateFed": "Must appear before a magistrate 'without unnecessary delay.' Courts interpret this as within 48 hours. Federal rules are strictly applied.",
      "firstAppearanceStateCA": "First appearance typically within 48 hours (excl. weekends/holidays). Post-Humphrey (2021): courts must consider your ability to pay before setting money bail.",
      "firstAppearanceStateNY": "Arraignment serves as first appearance in NY, typically within 24 hours in NYC and 24–48 hours upstate. Bail reform (2020): most misdemeanors and many non-violent felonies are non-bailable.",
      "firstAppearanceStateTX": "Magistration must occur within 48 hours. A magistrate sets initial bail per statutory factors (Tex. Code Crim. Proc. Art. 17.15).",
      "firstAppearanceStateFL": "First appearance before a county judge within 24 hours. Judge must inform you of charges, set bail, and appoint counsel.",
      "firstAppearanceStateFed": "Initial appearance before a federal magistrate judge 'without unnecessary delay.' Courts interpret this as within 48 hours."
    },
    "phoneCall": {
    ...
    "familyCallout": {
      ...
      "task3": "Learn what to say, and what not to say, on jail calls",
    ...
    "beforeArrest": {
      ...
      "policeWantToTalkC1Title": "Voluntary Interviews",
      "policeWantToTalkC1": "You are generally not required to answer police questions beyond providing identification in most states. Agreeing to a voluntary interview, even one described as routine, creates a record that can be used in future proceedings.",
      "policeWantToTalkC2Title": "Invoking Your Rights",
      "policeWantToTalkC2": "You can invoke your right to remain silent by stating: 'I would like an attorney before speaking with you.' Police must stop questioning once you clearly state this.",
      "policeWantToTalkC3Title": "If You Decide to Speak",
      "policeWantToTalkC3": "If you decide to speak with investigators, consulting with an attorney who knows your situation beforehand typically leads to better outcomes.",
      ...
      "policeWantToTalkDont3": "Don't assume staying silent makes you look guilty. It doesn't. It's your right.",
      "targetLetterTitle": "You received a target letter or think you're under investigation",
      "targetLetterC1Title": "What It Means",
      "targetLetterC1": "A target letter means a grand jury is investigating you as a likely defendant. Legal options exist at this stage that may not be available after charges are filed. Timing matters.",
      "targetLetterC2Title": "Statements",
      "targetLetterC2": "Statements made to prosecutors or investigators become part of the official record and can be used in any future prosecution.",
      "targetLetterC3Title": "Document Destruction",
      "targetLetterC3": "Deleting or destroying materials related to the investigation, even informally, can itself be charged as obstruction, separately from the underlying matter.",
      "targetLetterContext": "A target letter means a grand jury is investigating you as a likely defendant. You have more options now than after charges are filed. The window is closing.",
      ...
      "warrantC1Title": "Options Remain",
      "warrantC1": "If you know a warrant exists, legal options remain. An attorney can sometimes arrange a coordinated surrender that allows for a bail hearing the same day, which is typically a better outcome than an unexpected arrest.",
      "warrantC2Title": "Evasion",
      "warrantC2": "Continuing to evade an active warrant typically results in additional charges and makes bail harder to obtain when arrest eventually occurs.",
      "warrantC3Title": "Research First",
      "warrantC3": "The nature of the charges, the issuing court, and likely bail amount can all be researched by an attorney before surrender, which can significantly affect how the process unfolds.",
      ...
      "detainedC1Title": "Detention vs. Arrest",
      "detainedC1": "Detention is different from arrest. Asking 'Am I free to go?' establishes which is happening. If yes, you may leave calmly. If no, you are being detained and can invoke your right to remain silent.",
      "detainedC2Title": "Your Right to Silence",
      "detainedC2": "You are not required to answer questions about your whereabouts, who you were with, or what you were doing. This applies during detention as well as arrest.",
      "detainedC3Title": "Physical Resistance",
      "detainedC3": "Physically resisting a stop or detention, even one you believe is unlawful, carries its own legal consequences. The appropriate challenge is through the courts.",
      ...
      "probationParoleC1Title": "Two Parallel Proceedings",
      "probationParoleC1": "A new arrest while on probation or parole typically triggers two parallel proceedings: the new charges and a separate violation proceeding. These run simultaneously and may be in different courts.",
      "probationParoleC2Title": "Supervision Hold",
      "probationParoleC2": "A supervision hold can keep you in custody even after bail is set on the new charges. These are two separate holds requiring separate resolution.",
      "probationParoleC3Title": "Violation Standard",
      "probationParoleC3": "An arrest alone can trigger a violation hearing. A conviction on the new charges is not required. The standard of proof at a violation hearing is lower than at a criminal trial.",
      "probationParoleC4Title": "Statements to Your PO",
      "probationParoleC4": "Statements to a probation or parole officer may not carry the same legal protections as statements to police. Attorney guidance should be sought before any communication with your PO.",
      ...
      "probationParoleDont2": "Don't assume a conviction is required to trigger a violation. An arrest alone can start a revocation proceeding. The standard of proof is much lower than at a criminal trial.",
    ...
    "steps": {
      "step1": {
        ...
        "c1Title": "Invoking Your Rights",
        "c1": "To invoke your right to remain silent, say clearly: \"I am invoking my right to remain silent.\" To request an attorney, say: \"I want a lawyer.\" Once you clearly state this, police must stop questioning.",
        "c2Title": "Physical Compliance",
        "c2": "Physically resisting an arrest, even one you believe is unlawful, carries separate criminal charges under most state laws. The way to challenge an unlawful arrest is through the courts afterward, not at the scene.",
        "c3Title": "Search Consent",
        "c3": "Consenting to a search of your person, vehicle, or home is not required in most situations. You can state: \"I do not consent to this search.\"",
        "c4Title": "Statements to Police",
        ...
        "dont2": "Don't consent to any search of your person, vehicle, or home.",
        "dont3": "Don't argue about whether the arrest is legal. That is your attorney's job.",
        "note": "Your Fifth Amendment right to remain silent and your Sixth Amendment right to counsel apply from the moment of arrest. You don't need to wait for Miranda warnings. Note that an arrest warrant does not give officers the right to search your home."
      },
      "step2": {
        "title": "Booking",
        ...
        "do1": "Cooperate with the mechanical booking process (fingerprints, photos, property).",
        "do2": "Note the name of the facility, your booking number, and the charges. You'll need this information.",
        "do3": "Ask how family can find out where you are being held and how to contact you.",
        "do4": "If you take medication or have a medical condition, tell booking staff IN WRITING right away and ask to speak to medical staff. Jails are legally required to provide essential medication. Document every request.",
        "do5": "You have the right to at least one phone call. Timing varies by state. California sets a 3-hour limit; most other states require 'reasonable time.' Ask booking staff when you can make your call.",
        "do6": "If you don't speak English fluently, clearly say \"I need an interpreter.\" You have the right to one at no cost.",
        "do7": "Invoke your right to remain silent for anything beyond your name and date of birth. Booking intake questions (\"where were you tonight?\") are interrogation.",
        "dont1": "Don't discuss your case with anyone: other detainees, intake officers, or jail staff.",
        ...
        "c1Title": "The Booking Process",
        "c1": "Booking involves fingerprints, photographs, property inventory, and the formal entry of charges. Cooperating with the booking process is a legal requirement.",
        "c2Title": "Phone Call",
        "c2": "You typically have the right to at least one phone call after booking, though timing varies by state. All jail calls except to your attorney are recorded.",
        "c3Title": "Medical Needs",
        "c3": "If you take medication or have a medical condition, tell booking staff in writing immediately. Jails are legally required to provide essential medication. Document every request.",
        "c4Title": "The Charging Paperwork",
        "c4": "The booking paperwork names the office that filed charges. Look at the header. Note the prosecuting office name and exact charges as written. This is not the police department.",
        "c5Title": "Questions at Booking",
        "c5": "Questions about the incident or your whereabouts asked at booking relate to the case. Anything said about the case at this stage can be used as evidence.",
      ...
      "step3": {
        ...
        "do6": "Verify with your attorney that their line is registered as an attorney-client call before discussing case details.",
        "dont1": "Don't say anything about what happened. Even \"I didn't do it\" can be used against you.",
        "dont2": "Don't mention alibi information, co-defendants, or anyone else involved. Share that only with your attorney.",
        "dont3": "Don't ask anyone to destroy, move, or hold onto any item related to the incident.",
        "dont4": "Don't call the alleged victim, even to apologize or explain.",
        "dont5": "Don't speak in code. Law enforcement is trained to interpret coded language, and a jury can draw adverse inferences from evasive speech.",
        "c1Title": "Calls Are Recorded",
        "c1": "All jail calls except to your attorney are recorded and monitored. Prosecutors can access and use anything said on a jail call as evidence. Keep this call short and practical.",
      ...
      "step4": {
        ...
        "do1": "If you have an attorney, have them argue for release on your own recognizance (OR) or lower bail.",
        "do2": "Be calm, respectful, and presentable. First impressions matter.",
        "do3": "If speaking, mention your ties to the community: family, job, how long you've lived in the area.",
        "dont1": "Don't say anything about the underlying facts of the case at the bail hearing.",
        "dont2": "Don't waive your right to a bail hearing.",
        "dont3": "Don't assume bail will be unaffordable. There are options if you can't pay.",
        "bailHeader": "If you can't afford bail, here are your options:",
        "bail1": "Request OR release (release on own recognizance): ask your attorney to argue you are not a flight risk. No money required. Judge considers ties to community, employment, and family.",
        "bail2": "Request reduced bail: your attorney can argue bail is excessive relative to your income. Courts are required to consider your ability to pay.",
        "bail3": "Bail fund: nonprofit organizations that pay bail for people who can't afford it. Search \"[your city] bail fund\" or ask your attorney. Money is typically recycled after your case ends.",
        "bail4": "Bail bond company: a bondsman pays your full bail for a non-refundable fee (usually 10–15%). Warning: if you miss court, the bondsman can pursue you and take any collateral you pledged.",
        "bail5": "Property bond: use home equity as collateral instead of cash. Risk: the court can place a lien on the property if you miss a hearing.",
        "c1Title": "How Bail Is Set",
        "c1": "Whether bail is set, and at what amount, depends on the charges, criminal history, ties to the community, and flight risk. These factors are presented to the court at a bail hearing.",
        "c2Title": "Bail Conditions",
        "c2": "If released on bail, every bail condition is a legal requirement. Any violation, including accidental ones, typically results in immediate re-arrest and forfeiture of any money posted.",
        "c3Title": "Types of Bail",
        "c3": "Bail options include paying in full, a bail bond (a bondsman typically charges 10–15%, non-refundable), property bond, or release on your own recognizance if the court grants it.",
        "c4Title": "If You Remain Held",
        "c4": "If you remain held, an attorney can request a bail reduction hearing. This is an important early step and should be raised with your attorney as soon as they are contacted.",
        "bail6": "Remain in custody temporarily. Sometimes the timeline to arraignment is short enough that fighting for release is less critical. Discuss with your attorney."
      },
      "step5": {
        ...
        "c1Title": "Right to Counsel",
        "c1": "The right to an attorney applies at every critical stage of your case. If you cannot afford one, the court appoints a public defender at your first court appearance. Tell the judge you need appointed counsel.",
        "c2Title": "Early Involvement",
        "c2": "The earlier an attorney is involved, the more options remain available. Some steps, like evidence preservation letters for surveillance footage or body camera footage, have time windows that close within hours or days of an arrest.",
        "c3Title": "Attorney-Client Privilege",
      ...
      "step6": {
        ...
        "context": "At arraignment, the charges are formally read and you are asked to enter a plea. This is a critical decision. Your attorney must guide you on this. The judge will also address bail at this hearing.",
        ...
        "whoCharges": {
          ...
          "intro": "Police arrest. A separate office decides what charges to file and presses the case in court. This office is called the prosecutor. It is not the police department, and knowing which office it is affects your defense from day one.",
        ...
        "c1Title": "Entering a Plea",
        "c1": "At arraignment, the charges are formally read and you are asked to enter a plea. Three options are available: guilty, not guilty, and no contest. Each has different legal effects on your case. Your attorney must advise you on which to choose based on the facts of your situation.",
        "c2Title": "If Unrepresented",
        "c2": "If you appear without an attorney, tell the judge. You can ask for more time to get one, or request court-appointed counsel at this hearing.",
        "c3Title": "What Arraignment Is",
        "c3": "Arraignment is a procedural step, not the proceeding where cases are decided. Attempting to explain your situation or address the merits of the case at arraignment typically does not help and can create problems.",
        "c4Title": "Bail at Arraignment",
        "c4": "Bail may be addressed at arraignment. If held, bail arguments can be made here. If already released, bail conditions may be adjusted."
      },
      "step7": {
        ...
        "do1": "Attend every court date without exception. Missing a hearing results in an arrest warrant and forfeiture of any bail.",
        ...
        "supportBridge": "Being arrested affects more than just the legal case. Housing, benefits, employment, and family stability are often disrupted at the same time. Court orders may also require you to complete specific classes or community service. The Life Support section of this site covers all of it.",
        "supportBridgeLink": "Go to Life Support",
        "twoOneBridge": "For local services near you, call or text 211. Free and available 24/7.",
        "c1Title": "Court Dates",
        "c1": "Court dates are mandatory. Missing a hearing results in an arrest warrant and forfeiture of any bail. Set multiple reminders for every scheduled date.",
        "c2Title": "Bail Conditions",
        "c2": "Bail conditions must be followed exactly. Any violation, including accidental ones, results in immediate re-arrest.",
        "c3Title": "Conversations",
        "c3": "Conversations about your case outside of attorney-client privilege are not protected. Jail calls, texts and messages, conversations with family and friends, and social media posts can all be obtained and used as evidence.",
        "c4Title": "Witness Contact",
        "c4": "Contact with alleged victims or witnesses during an active case can raise legal concerns including obstruction of justice. An attorney should advise before any such contact.",
        "c5Title": "Your Recollection",
        "c5": "Your recollection of what happened is potentially important to your defense. Recording your memories while they are fresh may be useful to share with your attorney."
      }
    }
  },
  ...
  "howTo": {
    ...
    "rightToCounsel": "Right to an Attorney",
    "rightToCounselDesc": "When your right to counsel begins, how to invoke it, and the critical gap before arraignment.",
    ...
    "personalHealthDesc": "Managing health needs during your case, including medications, insurance, and medical appointments.",
