  ...
  "legalGuidance": {
    "qaFlow": {
      ...
      "consent": {
        ...
        "bullet3Head": "AI-processed, not attorney-client protected.",
        "bullet3Body": "This guidance is generated by an AI service (Anthropic). No attorney-client relationship is formed. Your inputs — state, charge type, case stage, and any concerns you select — may be processed by Anthropic and retained for up to 30 days for safety and operational purposes.",
