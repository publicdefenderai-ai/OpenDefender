...
"attorney": {
  ...
  "first24Hours": {
    ...
    "accordion": {
      ...
      "counselStateNY": "NY courts interpret the right to counsel broadly. Once you retain or request an attorney, police must contact that attorney before questioning — stronger than federal law.",
      ...
      "firstAppearanceStateNY": "Arraignment serves as first appearance in NY — typically within 24 hours in NYC, 24–48 hours upstate. Bail reform (2020): most misdemeanors and many non-violent felonies are non-bailable.",
    ...
    "beforeArrest": {
      ...
      "warrantC1": "If you know a warrant exists, legal options remain. An attorney can sometimes arrange a coordinated surrender that allows for a bail hearing the same day — typically a better outcome than an unexpected arrest.",
    ...
    "steps": {
      ...
      "step5": {
        ...
        "c1": "The right to an attorney applies at every critical stage of your case. If you cannot afford one, the court appoints a public defender at your first court appearance — you tell the judge you need appointed counsel.",
