export default {
  ...
  "messages": {
    ...
    "first24HoursInfo": "**The First 24 Hours After Arrest**\n\nThe decisions made in the first 24 hours can affect your entire case. Here's what matters:\n\n**Stay silent.** Say clearly: \"I am invoking my right to remain silent. I want a lawyer.\" Then stop talking. This applies even if police say it will help you.\n\n**At booking:** You'll be photographed, fingerprinted, and logged into the system. You have the right to a phone call. Use it to reach a lawyer or a trusted family member.\n\n**Ask for a lawyer at every step.** If you cannot afford one, say: \"I cannot afford an attorney. I am requesting a public defender.\" One must be appointed before questioning.\n\n**Jail calls are recorded.** Do not discuss your case, the facts of what happened, or ask anyone to do anything related to the incident. Friends and family can be required to testify about what you said.\n\n**Bail hearing** usually occurs within 24–72 hours. A judge will decide whether you can be released and set bail. Your attorney (or public defender) can argue for lower bail or release.\n\n**At arraignment:** You'll hear the formal charges and enter a plea. Do not speak without your lawyer present.\n\n---\nThe full guide walks through all 7 steps: arrest, booking, phone call, bail, attorney, arraignment, and probation/parole.",
