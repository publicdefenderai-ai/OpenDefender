...
export function Header() {
  ...
  const menuItems = [
    ...
    { title: t('getStartedMenu.legalRightsSubmenu.quickReference', 'Quick-Reference Cards'), href: "/rights-info#quick-reference-cards", icon: FileText, description: t('quickRef.subtitle', 'Compact, printable guides for your rights at every stage.'), testId: "menu-quick-reference", featured: false },
