 ...
 * Includes a mandatory review confirmation gate before the DOCX is exported.
 */

import { useState } from "react";
import { motion } from "framer-motion";
import { FileText, Download, Printer, AlertTriangle, CheckCircle2 } from "lucide-react";
      ...
      <Dialog open={showReviewDialog} onOpenChange={setShowReviewDialog}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              This document was generated by AI using the information you provided.
            </DialogDescription>
          </DialogHeader>
